...
ffffffffc0200036:	46e50513          	addi	a0,a0,1134 # ffffffffc02a74a0 <buf>
ffffffffc020003a:	000b3617          	auipc	a2,0xb3
ffffffffc020003e:	9c260613          	addi	a2,a2,-1598 # ffffffffc02b29fc <end>
kern_init(void) {
...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	53a060ef          	jal	ra,ffffffffc0206584 <memset>
...
ffffffffc0200056:	55e58593          	addi	a1,a1,1374 # ffffffffc02065b0 <etext+0x2>
ffffffffc020005a:	00006517          	auipc	a0,0x6
ffffffffc020005e:	57650513          	addi	a0,a0,1398 # ffffffffc02065d0 <etext+0x22>
...
ffffffffc020007a:	483050ef          	jal	ra,ffffffffc0205cfc <proc_init>
...
ffffffffc020008e:	607050ef          	jal	ra,ffffffffc0205e94 <cpu_idle>
...
ffffffffc02000ac:	53050513          	addi	a0,a0,1328 # ffffffffc02065d8 <etext+0x2a>
...
ffffffffc02000c2:	3e2b8b93          	addi	s7,s7,994 # ffffffffc02a74a0 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
...
ffffffffc020011e:	38650513          	addi	a0,a0,902 # ffffffffc02a74a0 <buf>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	012060ef          	jal	ra,ffffffffc0206186 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	7dd050ef          	jal	ra,ffffffffc0206186 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc020020e:	3d650513          	addi	a0,a0,982 # ffffffffc02065e0 <etext+0x32>
void print_kerninfo(void) {
...
ffffffffc0200224:	3e050513          	addi	a0,a0,992 # ffffffffc0206600 <etext+0x52>
ffffffffc0200228:	f59ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc020022c:	00006597          	auipc	a1,0x6
ffffffffc0200230:	38258593          	addi	a1,a1,898 # ffffffffc02065ae <etext>
ffffffffc0200234:	00006517          	auipc	a0,0x6
ffffffffc0200238:	3ec50513          	addi	a0,a0,1004 # ffffffffc0206620 <etext+0x72>
ffffffffc020023c:	f45ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  edata  0x%08x (virtual)\n", edata);
ffffffffc0200240:	000a7597          	auipc	a1,0xa7
ffffffffc0200244:	26058593          	addi	a1,a1,608 # ffffffffc02a74a0 <buf>
ffffffffc0200248:	00006517          	auipc	a0,0x6
ffffffffc020024c:	3f850513          	addi	a0,a0,1016 # ffffffffc0206640 <etext+0x92>
ffffffffc0200250:	f31ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  end    0x%08x (virtual)\n", end);
ffffffffc0200254:	000b2597          	auipc	a1,0xb2
ffffffffc0200258:	7a858593          	addi	a1,a1,1960 # ffffffffc02b29fc <end>
ffffffffc020025c:	00006517          	auipc	a0,0x6
ffffffffc0200260:	40450513          	addi	a0,a0,1028 # ffffffffc0206660 <etext+0xb2>
ffffffffc0200264:	f1dff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("Kernel executable memory footprint: %dKB\n",
            (end - kern_init + 1023) / 1024);
ffffffffc0200268:	000b3597          	auipc	a1,0xb3
ffffffffc020026c:	b9358593          	addi	a1,a1,-1133 # ffffffffc02b2dfb <end+0x3ff>
...
ffffffffc020028e:	3f650513          	addi	a0,a0,1014 # ffffffffc0206680 <etext+0xd2>
}
...
ffffffffc020029c:	41860613          	addi	a2,a2,1048 # ffffffffc02066b0 <etext+0x102>
ffffffffc02002a0:	04d00593          	li	a1,77
ffffffffc02002a4:	00006517          	auipc	a0,0x6
ffffffffc02002a8:	42450513          	addi	a0,a0,1060 # ffffffffc02066c8 <etext+0x11a>
void print_stackframe(void) {
...
ffffffffc02002b8:	42c60613          	addi	a2,a2,1068 # ffffffffc02066e0 <etext+0x132>
ffffffffc02002bc:	00006597          	auipc	a1,0x6
ffffffffc02002c0:	44458593          	addi	a1,a1,1092 # ffffffffc0206700 <etext+0x152>
ffffffffc02002c4:	00006517          	auipc	a0,0x6
ffffffffc02002c8:	44450513          	addi	a0,a0,1092 # ffffffffc0206708 <etext+0x15a>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002d6:	44660613          	addi	a2,a2,1094 # ffffffffc0206718 <etext+0x16a>
ffffffffc02002da:	00006597          	auipc	a1,0x6
ffffffffc02002de:	46658593          	addi	a1,a1,1126 # ffffffffc0206740 <etext+0x192>
ffffffffc02002e2:	00006517          	auipc	a0,0x6
ffffffffc02002e6:	42650513          	addi	a0,a0,1062 # ffffffffc0206708 <etext+0x15a>
ffffffffc02002ea:	e97ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ee:	00006617          	auipc	a2,0x6
ffffffffc02002f2:	46260613          	addi	a2,a2,1122 # ffffffffc0206750 <etext+0x1a2>
ffffffffc02002f6:	00006597          	auipc	a1,0x6
ffffffffc02002fa:	47a58593          	addi	a1,a1,1146 # ffffffffc0206770 <etext+0x1c2>
ffffffffc02002fe:	00006517          	auipc	a0,0x6
ffffffffc0200302:	40a50513          	addi	a0,a0,1034 # ffffffffc0206708 <etext+0x15a>
...
ffffffffc020033c:	44850513          	addi	a0,a0,1096 # ffffffffc0206780 <etext+0x1d2>
kmonitor(struct trapframe *tf) {
...
ffffffffc020035e:	44e50513          	addi	a0,a0,1102 # ffffffffc02067a8 <etext+0x1fa>
...
ffffffffc020037c:	45890913          	addi	s2,s2,1112 # ffffffffc02067d0 <etext+0x222>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200380:	00006497          	auipc	s1,0x6
ffffffffc0200384:	45848493          	addi	s1,s1,1112 # ffffffffc02067d8 <etext+0x22a>
        if (argc == MAXARGS - 1) {
ffffffffc0200388:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020038a:	00006b17          	auipc	s6,0x6
ffffffffc020038e:	456b0b13          	addi	s6,s6,1110 # ffffffffc02067e0 <etext+0x232>
        argv[argc ++] = buf;
ffffffffc0200392:	00006a17          	auipc	s4,0x6
ffffffffc0200396:	36ea0a13          	addi	s4,s4,878 # ffffffffc0206700 <etext+0x152>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003c0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003c2:	18e060ef          	jal	ra,ffffffffc0206550 <strcmp>
...
ffffffffc02003d4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003d6:	17a060ef          	jal	ra,ffffffffc0206550 <strcmp>
...
ffffffffc0200414:	15a060ef          	jal	ra,ffffffffc020656e <strchr>
...
ffffffffc0200452:	11c060ef          	jal	ra,ffffffffc020656e <strchr>
...
ffffffffc0200470:	39450513          	addi	a0,a0,916 # ffffffffc0206800 <etext+0x252>
...
ffffffffc020047e:	4ee30313          	addi	t1,t1,1262 # ffffffffc02b2968 <is_panic>
...
ffffffffc0200530:	44f73623          	sd	a5,1100(a4) # ffffffffc02b2978 <timebase>
...
ffffffffc0200558:	4007be23          	sd	zero,1052(a5) # ffffffffc02b2970 <ticks>
    cprintf("++ setup timer interrupts\n");
...
ffffffffc0200566:	4167b783          	ld	a5,1046(a5) # ffffffffc02b2978 <timebase>
...
ffffffffc02005fc:	2a878793          	addi	a5,a5,680 # ffffffffc02a78a0 <ide>
    int iobase = secno * SECTSIZE;
...
ffffffffc020060e:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc0200610:	787050ef          	jal	ra,ffffffffc0206596 <memcpy>
    return 0;
}
...
ffffffffc0200624:	28050513          	addi	a0,a0,640 # ffffffffc02a78a0 <ide>
                   size_t nsecs) {
...
ffffffffc0200632:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc0200634:	763050ef          	jal	ra,ffffffffc0206596 <memcpy>
    return 0;
}
...
ffffffffc020089e:	13648493          	addi	s1,s1,310 # ffffffffc02b29d0 <check_mm_struct>
...
ffffffffc02008e4:	10073703          	ld	a4,256(a4) # ffffffffc02b29e0 <current>
ffffffffc02008e8:	000b2797          	auipc	a5,0xb2
ffffffffc02008ec:	1007b783          	ld	a5,256(a5) # ffffffffc02b29e8 <idleproc>
...
ffffffffc0200920:	0c47b783          	ld	a5,196(a5) # ffffffffc02b29e0 <current>
...
ffffffffc0200a0c:	f6868693          	addi	a3,a3,-152 # ffffffffc02b2970 <ticks>
...
ffffffffc0200a24:	fc07b783          	ld	a5,-64(a5) # ffffffffc02b29e0 <current>
...
ffffffffc0200a84:	6105                	addi	sp,sp,32
            syscall();
ffffffffc0200a86:	5fe0506f          	j	ffffffffc0206084 <syscall>
...
ffffffffc0200b42:	10f43423          	sd	a5,264(s0)
                syscall();
ffffffffc0200b46:	53e050ef          	jal	ra,ffffffffc0206084 <syscall>
                kernel_execve_ret(tf,current->kstack+KSTACKSIZE);
ffffffffc0200b4a:	000b2797          	auipc	a5,0xb2
ffffffffc0200b4e:	e967b783          	ld	a5,-362(a5) # ffffffffc02b29e0 <current>
...
ffffffffc0200c28:	dbc40413          	addi	s0,s0,-580 # ffffffffc02b29e0 <current>
...
ffffffffc0200c9a:	6105                	addi	sp,sp,32
                schedule();
ffffffffc0200c9c:	2fc0506f          	j	ffffffffc0205f98 <schedule>
                do_exit(-E_KILLED);
ffffffffc0200ca0:	555d                	li	a0,-9
ffffffffc0200ca2:	640040ef          	jal	ra,ffffffffc02052e2 <do_exit>
            if (current->need_resched) {
...
ffffffffc0200e26:	a7e78793          	addi	a5,a5,-1410 # ffffffffc02ae8a0 <free_area>
...
ffffffffc0200e38:	a7c56503          	lwu	a0,-1412(a0) # ffffffffc02ae8b0 <free_area+0x10>
...
ffffffffc0200e46:	a5e40413          	addi	s0,s0,-1442 # ffffffffc02ae8a0 <free_area>
...
ffffffffc0200ed2:	ad27b783          	ld	a5,-1326(a5) # ffffffffc02b29a0 <pages>
...
ffffffffc0200eea:	ab26b683          	ld	a3,-1358(a3) # ffffffffc02b2998 <npage>
...
ffffffffc0200f28:	9807a623          	sw	zero,-1652(a5) # ffffffffc02ae8b0 <free_area+0x10>
    assert(alloc_page() == NULL);
...
ffffffffc020100a:	8a07a523          	sw	zero,-1878(a5) # ffffffffc02ae8b0 <free_area+0x10>
    free_pages(p0 + 2, 3);
...
ffffffffc0201606:	29e68693          	addi	a3,a3,670 # ffffffffc02ae8a0 <free_area>
...
ffffffffc0201732:	17258593          	addi	a1,a1,370 # ffffffffc02ae8a0 <free_area>
...
ffffffffc020181e:	08668693          	addi	a3,a3,134 # ffffffffc02ae8a0 <free_area>
...
ffffffffc02018ea:	baa60613          	addi	a2,a2,-1110 # ffffffffc02a7490 <slobfree>
...
ffffffffc0201998:	00c6b683          	ld	a3,12(a3) # ffffffffc02b29a0 <pages>
...
ffffffffc02019b4:	fe873703          	ld	a4,-24(a4) # ffffffffc02b2998 <npage>
    return page2ppn(page) << PGSHIFT;
...
ffffffffc02019c2:	ff26b683          	ld	a3,-14(a3) # ffffffffc02b29b0 <va_pa_offset>
...
ffffffffc0201a10:	a8490913          	addi	s2,s2,-1404 # ffffffffc02a7490 <slobfree>
...
ffffffffc0201b4e:	e3678793          	addi	a5,a5,-458 # ffffffffc02b2980 <bigblocks>
...
ffffffffc0201b8a:	dfa78793          	addi	a5,a5,-518 # ffffffffc02b2980 <bigblocks>
...
ffffffffc0201bd0:	db47b783          	ld	a5,-588(a5) # ffffffffc02b2980 <bigblocks>
    return 0;
...
ffffffffc0201bdc:	da868693          	addi	a3,a3,-600 # ffffffffc02b2980 <bigblocks>
...
ffffffffc0201c04:	db06b683          	ld	a3,-592(a3) # ffffffffc02b29b0 <va_pa_offset>
ffffffffc0201c08:	8c15                	sub	s0,s0,a3
    if (PPN(pa) >= npage) {
ffffffffc0201c0a:	8031                	srli	s0,s0,0xc
ffffffffc0201c0c:	000b1797          	auipc	a5,0xb1
ffffffffc0201c10:	d8c7b783          	ld	a5,-628(a5) # ffffffffc02b2998 <npage>
...
ffffffffc0201c28:	d7c53503          	ld	a0,-644(a0) # ffffffffc02b29a0 <pages>
...
ffffffffc0201c60:	d247b783          	ld	a5,-732(a5) # ffffffffc02b2980 <bigblocks>
        return 1;
...
ffffffffc0201cf8:	cb490913          	addi	s2,s2,-844 # ffffffffc02b29a8 <pmm_manager>
        {
...
ffffffffc0201d02:	ccaa8a93          	addi	s5,s5,-822 # ffffffffc02b29c8 <swap_init_ok>
...
ffffffffc0201d0e:	cc6b0b13          	addi	s6,s6,-826 # ffffffffc02b29d0 <check_mm_struct>
...
ffffffffc0201d7e:	c2e7b783          	ld	a5,-978(a5) # ffffffffc02b29a8 <pmm_manager>
...
ffffffffc0201d9a:	c127b783          	ld	a5,-1006(a5) # ffffffffc02b29a8 <pmm_manager>
...
ffffffffc0201dbe:	bee7b783          	ld	a5,-1042(a5) # ffffffffc02b29a8 <pmm_manager>
...
ffffffffc0201dd4:	bd87b783          	ld	a5,-1064(a5) # ffffffffc02b29a8 <pmm_manager>
...
ffffffffc0201e1a:	b82a0a13          	addi	s4,s4,-1150 # ffffffffc02b2998 <npage>
    if (!(*pdep1 & PTE_V)) {
...
ffffffffc0201e34:	b70b0b13          	addi	s6,s6,-1168 # ffffffffc02b29a0 <pages>
...
ffffffffc0201e44:	b58a0a13          	addi	s4,s4,-1192 # ffffffffc02b2998 <npage>
...
ffffffffc0201e68:	b4c7b783          	ld	a5,-1204(a5) # ffffffffc02b29b0 <va_pa_offset>
ffffffffc0201e6c:	6605                	lui	a2,0x1
ffffffffc0201e6e:	4581                	li	a1,0
ffffffffc0201e70:	953e                	add	a0,a0,a5
ffffffffc0201e72:	712040ef          	jal	ra,ffffffffc0206584 <memset>
    return page - pages + nbase;
...
ffffffffc0201ea0:	b14a8a93          	addi	s5,s5,-1260 # ffffffffc02b29b0 <va_pa_offset>
...
ffffffffc0201ed2:	ad2b0b13          	addi	s6,s6,-1326 # ffffffffc02b29a0 <pages>
...
ffffffffc0201f04:	680040ef          	jal	ra,ffffffffc0206584 <memset>
    return page - pages + nbase;
...
ffffffffc0201fec:	9b073703          	ld	a4,-1616(a4) # ffffffffc02b2998 <npage>
...
ffffffffc0202004:	9a053503          	ld	a0,-1632(a0) # ffffffffc02b29a0 <pages>
...
ffffffffc0202054:	948c8c93          	addi	s9,s9,-1720 # ffffffffc02b2998 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc0202058:	000b1c17          	auipc	s8,0xb1
ffffffffc020205c:	948c0c13          	addi	s8,s8,-1720 # ffffffffc02b29a0 <pages>
ffffffffc0202060:	fff80bb7          	lui	s7,0xfff80
        pmm_manager->free_pages(base, n);
ffffffffc0202064:	000b1d17          	auipc	s10,0xb1
ffffffffc0202068:	944d0d13          	addi	s10,s10,-1724 # ffffffffc02b29a8 <pmm_manager>
...
ffffffffc02021b2:	7ead0d13          	addi	s10,s10,2026 # ffffffffc02b2998 <npage>
    return KADDR(page2pa(page));
ffffffffc02021b6:	00ccdc93          	srli	s9,s9,0xc
    return &pages[PPN(pa) - nbase];
ffffffffc02021ba:	000b0717          	auipc	a4,0xb0
ffffffffc02021be:	7e670713          	addi	a4,a4,2022 # ffffffffc02b29a0 <pages>
        pmm_manager->free_pages(base, n);
ffffffffc02021c2:	000b0d97          	auipc	s11,0xb0
ffffffffc02021c6:	7e6d8d93          	addi	s11,s11,2022 # ffffffffc02b29a8 <pmm_manager>
...
ffffffffc0202222:	79280813          	addi	a6,a6,1938 # ffffffffc02b29b0 <va_pa_offset>
...
ffffffffc02022b6:	6fe80813          	addi	a6,a6,1790 # ffffffffc02b29b0 <va_pa_offset>
...
ffffffffc02022c8:	6dc70713          	addi	a4,a4,1756 # ffffffffc02b29a0 <pages>
                        pd0[PDX0(d0start)] = 0;
...
ffffffffc0202300:	6a470713          	addi	a4,a4,1700 # ffffffffc02b29a0 <pages>
...
ffffffffc020234e:	65670713          	addi	a4,a4,1622 # ffffffffc02b29a0 <pages>
...
ffffffffc0202360:	65480813          	addi	a6,a6,1620 # ffffffffc02b29b0 <va_pa_offset>
                        pd0[PDX0(d0start)] = 0;
...
ffffffffc0202384:	62070713          	addi	a4,a4,1568 # ffffffffc02b29a0 <pages>
                pgdir[PDX1(d1start)] = 0;
...
ffffffffc0202418:	58473703          	ld	a4,1412(a4) # ffffffffc02b2998 <npage>
...
ffffffffc020242c:	57853503          	ld	a0,1400(a0) # ffffffffc02b29a0 <pages>
...
ffffffffc020245a:	5527b783          	ld	a5,1362(a5) # ffffffffc02b29a8 <pmm_manager>
...
ffffffffc0202470:	53c7b783          	ld	a5,1340(a5) # ffffffffc02b29a8 <pmm_manager>
...
ffffffffc02024bc:	4e873703          	ld	a4,1256(a4) # ffffffffc02b29a0 <pages>
...
ffffffffc02024f6:	4a673703          	ld	a4,1190(a4) # ffffffffc02b2998 <npage>
ffffffffc02024fa:	06e7ff63          	bgeu	a5,a4,ffffffffc0202578 <page_insert+0xf2>
    return &pages[PPN(pa) - nbase];
ffffffffc02024fe:	000b0a97          	auipc	s5,0xb0
ffffffffc0202502:	4a2a8a93          	addi	s5,s5,1186 # ffffffffc02b29a0 <pages>
...
ffffffffc0202514:	01240c63          	beq	s0,s2,ffffffffc020252c <page_insert+0xa6>
    page->ref -= 1;
ffffffffc0202518:	00092783          	lw	a5,0(s2) # fffffffffff80000 <end+0x3fccd604>
...
ffffffffc020253c:	4707b783          	ld	a5,1136(a5) # ffffffffc02b29a8 <pmm_manager>
...
ffffffffc020255a:	4527b783          	ld	a5,1106(a5) # ffffffffc02b29a8 <pmm_manager>
...
ffffffffc0202596:	416b8b93          	addi	s7,s7,1046 # ffffffffc02b29a8 <pmm_manager>
void pmm_init(void) {
...
ffffffffc02025bc:	3f898993          	addi	s3,s3,1016 # ffffffffc02b29b0 <va_pa_offset>
    npage = maxpa / PGSIZE;
ffffffffc02025c0:	000b0497          	auipc	s1,0xb0
ffffffffc02025c4:	3d848493          	addi	s1,s1,984 # ffffffffc02b2998 <npage>
    pmm_manager->init();
ffffffffc02025c8:	679c                	ld	a5,8(a5)
    pages = (struct Page *)ROUNDUP((void *)end, PGSIZE);
ffffffffc02025ca:	000b0b17          	auipc	s6,0xb0
ffffffffc02025ce:	3d6b0b13          	addi	s6,s6,982 # ffffffffc02b29a0 <pages>
    pmm_manager->init();
...
ffffffffc020260a:	3f578793          	addi	a5,a5,1013 # ffffffffc02b39fb <end+0xfff>
...
ffffffffc0202674:	32090913          	addi	s2,s2,800 # ffffffffc02b2990 <boot_pgdir>
    pmm_manager->check();
...
ffffffffc02026a6:	2ed7b323          	sd	a3,742(a5) # ffffffffc02b2988 <boot_cr3>
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc02028fc:	0007b023          	sd	zero,0(a5) # fffffffffff80000 <end+0x3fccd604>
  asm volatile("sfence.vma");
...
ffffffffc02029a4:	62051d63          	bnez	a0,ffffffffc0202fde <pmm_init+0xa62>
    assert(page_ref(p) == 1);
ffffffffc02029a8:	000aa703          	lw	a4,0(s5) # fffffffffffff000 <end+0x3fd4c604>
...
ffffffffc02029de:	361030ef          	jal	ra,ffffffffc020653e <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02029e2:	10040593          	addi	a1,s0,256
ffffffffc02029e6:	10000513          	li	a0,256
ffffffffc02029ea:	367030ef          	jal	ra,ffffffffc0206550 <strcmp>
...
ffffffffc0202a1c:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a20:	2e9030ef          	jal	ra,ffffffffc0206508 <strlen>
...
ffffffffc0203160:	83cc8c93          	addi	s9,s9,-1988 # ffffffffc02b2998 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc0203164:	000b0c17          	auipc	s8,0xb0
ffffffffc0203168:	83cc0c13          	addi	s8,s8,-1988 # ffffffffc02b29a0 <pages>
    return page - pages + nbase;
...
ffffffffc0203216:	79e70713          	addi	a4,a4,1950 # ffffffffc02b29b0 <va_pa_offset>
...
ffffffffc0203232:	364030ef          	jal	ra,ffffffffc0206596 <memcpy>
...
ffffffffc020337a:	6527a783          	lw	a5,1618(a5) # ffffffffc02b29c8 <swap_init_ok>
ffffffffc020337e:	c385                	beqz	a5,ffffffffc020339e <pgdir_alloc_page+0x52>
            if (check_mm_struct != NULL) {
ffffffffc0203380:	000af517          	auipc	a0,0xaf
ffffffffc0203384:	65053503          	ld	a0,1616(a0) # ffffffffc02b29d0 <check_mm_struct>
...
ffffffffc02033ba:	5f27b783          	ld	a5,1522(a5) # ffffffffc02b29a8 <pmm_manager>
...
ffffffffc02033d2:	5da7b783          	ld	a5,1498(a5) # ffffffffc02b29a8 <pmm_manager>
...
ffffffffc0203446:	5766b683          	ld	a3,1398(a3) # ffffffffc02b29b8 <max_swap_offset>
...
ffffffffc020345c:	ff878793          	addi	a5,a5,-8 # ffffffffc02a7450 <swap_manager_fifo>
     int r = sm->init();
ffffffffc0203460:	6798                	ld	a4,8(a5)
     sm = &swap_manager_fifo;
ffffffffc0203462:	000afb97          	auipc	s7,0xaf
ffffffffc0203466:	55eb8b93          	addi	s7,s7,1374 # ffffffffc02b29c0 <sm>
...
ffffffffc02034a4:	40040413          	addi	s0,s0,1024 # ffffffffc02ae8a0 <free_area>
ffffffffc02034a8:	638c                	ld	a1,0(a5)
          swap_init_ok = 1;
ffffffffc02034aa:	4785                	li	a5,1
ffffffffc02034ac:	000af717          	auipc	a4,0xaf
ffffffffc02034b0:	50f72e23          	sw	a5,1308(a4) # ffffffffc02b29c8 <swap_init_ok>
          cprintf("SWAP: manager = %s\n", sm->name);
...
ffffffffc0203504:	4d078793          	addi	a5,a5,1232 # ffffffffc02b29d0 <check_mm_struct>
...
ffffffffc0203512:	48270713          	addi	a4,a4,1154 # ffffffffc02b2990 <boot_pgdir>
...
ffffffffc0203566:	37648493          	addi	s1,s1,886 # ffffffffc02ae8d8 <check_rp>
ffffffffc020356a:	c17fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
     
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc020356e:	000ab997          	auipc	s3,0xab
ffffffffc0203572:	38a98993          	addi	s3,s3,906 # ffffffffc02ae8f8 <swap_in_seq_no>
     cprintf("setup Page Table vaddr 0~4MB OVER!\n");
...
ffffffffc020359a:	342a0a13          	addi	s4,s4,834 # ffffffffc02ae8d8 <check_rp>
    elm->prev = elm->next = elm;
...
ffffffffc02035b0:	3007a223          	sw	zero,772(a5) # ffffffffc02ae8b0 <free_area+0x10>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
...
ffffffffc02035e0:	3e07ae23          	sw	zero,1020(a5) # ffffffffc02b29d8 <pgfault_num>
     *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02035ee:	3ee6a683          	lw	a3,1006(a3) # ffffffffc02b29d8 <pgfault_num>
ffffffffc02035f2:	4585                	li	a1,1
ffffffffc02035f4:	000af797          	auipc	a5,0xaf
ffffffffc02035f8:	3e478793          	addi	a5,a5,996 # ffffffffc02b29d8 <pgfault_num>
...
ffffffffc020366e:	28e78793          	addi	a5,a5,654 # ffffffffc02ae8f8 <swap_in_seq_no>
ffffffffc0203672:	000ab717          	auipc	a4,0xab
ffffffffc0203676:	2ae70713          	addi	a4,a4,686 # ffffffffc02ae920 <swap_out_seq_no>
ffffffffc020367a:	000ab617          	auipc	a2,0xab
ffffffffc020367e:	2a660613          	addi	a2,a2,678 # ffffffffc02ae920 <swap_out_seq_no>
...
ffffffffc0203694:	22870713          	addi	a4,a4,552 # ffffffffc02ae8b8 <check_ptep>
ffffffffc0203698:	000ab697          	auipc	a3,0xab
ffffffffc020369c:	24068693          	addi	a3,a3,576 # ffffffffc02ae8d8 <check_rp>
ffffffffc02036a0:	6585                	lui	a1,0x1
    if (PPN(pa) >= npage) {
ffffffffc02036a2:	000afc17          	auipc	s8,0xaf
ffffffffc02036a6:	2f6c0c13          	addi	s8,s8,758 # ffffffffc02b2998 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc02036aa:	000afc97          	auipc	s9,0xaf
ffffffffc02036ae:	2f6c8c93          	addi	s9,s9,758 # ffffffffc02b29a0 <pages>
...
ffffffffc0203752:	24278793          	addi	a5,a5,578 # ffffffffc02b2990 <boot_pgdir>
ffffffffc0203756:	639c                	ld	a5,0(a5)
    if (PPN(pa) >= npage) {
ffffffffc0203758:	000c3703          	ld	a4,0(s8)
     check_mm_struct = NULL;
ffffffffc020375c:	000af697          	auipc	a3,0xaf
ffffffffc0203760:	2606ba23          	sd	zero,628(a3) # ffffffffc02b29d0 <check_mm_struct>
    return pa2page(PDE_ADDR(pde));
...
ffffffffc020378c:	2287b783          	ld	a5,552(a5) # ffffffffc02b29b0 <va_pa_offset>
...
ffffffffc0203b6c:	e587b783          	ld	a5,-424(a5) # ffffffffc02b29c0 <sm>
...
ffffffffc0203b78:	e4c7b783          	ld	a5,-436(a5) # ffffffffc02b29c0 <sm>
...
ffffffffc0203ba4:	e2098993          	addi	s3,s3,-480 # ffffffffc02b29c0 <sm>
...
ffffffffc0203d12:	c3a78793          	addi	a5,a5,-966 # ffffffffc02ae948 <pra_list_head>
 */
static int
...
ffffffffc0203d5e:	c7e92903          	lw	s2,-898(s2) # ffffffffc02b29d8 <pgfault_num>
...
ffffffffc0203d7c:	c6040413          	addi	s0,s0,-928 # ffffffffc02b29d8 <pgfault_num>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc0203ed0:	05700593          	li	a1,87
...
ffffffffc0203ef0:	07900593          	li	a1,121
...
ffffffffc0203f10:	07700593          	li	a1,119
...
ffffffffc0203f30:	07500593          	li	a1,117
...
ffffffffc0203f50:	07200593          	li	a1,114
...
ffffffffc0203f70:	06f00593          	li	a1,111
...
ffffffffc0203f90:	06c00593          	li	a1,108
...
ffffffffc0203fb0:	06900593          	li	a1,105
...
ffffffffc0203fd0:	06600593          	li	a1,102
...
ffffffffc0203ff0:	06300593          	li	a1,99
...
ffffffffc0204010:	06000593          	li	a1,96
...
ffffffffc0204030:	05d00593          	li	a1,93
...
ffffffffc0204050:	05a00593          	li	a1,90
...
ffffffffc0204096:	ea668693          	addi	a3,a3,-346 # ffffffffc0207f38 <default_pmm_manager+0xc38>
ffffffffc020409a:	00003617          	auipc	a2,0x3
ffffffffc020409e:	bce60613          	addi	a2,a2,-1074 # ffffffffc0206c68 <commands+0x450>
ffffffffc02040a2:	04200593          	li	a1,66
ffffffffc02040a6:	00004517          	auipc	a0,0x4
ffffffffc02040aa:	d3250513          	addi	a0,a0,-718 # ffffffffc0207dd8 <default_pmm_manager+0xad8>
ffffffffc02040ae:	bccfc0ef          	jal	ra,ffffffffc020047a <__panic>
         assert(head != NULL);
ffffffffc02040b2:	00004697          	auipc	a3,0x4
ffffffffc02040b6:	e7668693          	addi	a3,a3,-394 # ffffffffc0207f28 <default_pmm_manager+0xc28>
ffffffffc02040ba:	00003617          	auipc	a2,0x3
ffffffffc02040be:	bae60613          	addi	a2,a2,-1106 # ffffffffc0206c68 <commands+0x450>
ffffffffc02040c2:	04100593          	li	a1,65
ffffffffc02040c6:	00004517          	auipc	a0,0x4
ffffffffc02040ca:	d1250513          	addi	a0,a0,-750 # ffffffffc0207dd8 <default_pmm_manager+0xad8>
...
ffffffffc02040ee:	e5e68693          	addi	a3,a3,-418 # ffffffffc0207f48 <default_pmm_manager+0xc48>
ffffffffc02040f2:	00003617          	auipc	a2,0x3
ffffffffc02040f6:	b7660613          	addi	a2,a2,-1162 # ffffffffc0206c68 <commands+0x450>
ffffffffc02040fa:	03200593          	li	a1,50
ffffffffc02040fe:	00004517          	auipc	a0,0x4
ffffffffc0204102:	cda50513          	addi	a0,a0,-806 # ffffffffc0207dd8 <default_pmm_manager+0xad8>
{
...
ffffffffc0204112:	e7268693          	addi	a3,a3,-398 # ffffffffc0207f80 <default_pmm_manager+0xc80>
ffffffffc0204116:	00003617          	auipc	a2,0x3
ffffffffc020411a:	b5260613          	addi	a2,a2,-1198 # ffffffffc0206c68 <commands+0x450>
ffffffffc020411e:	06d00593          	li	a1,109
ffffffffc0204122:	00004517          	auipc	a0,0x4
ffffffffc0204126:	e7e50513          	addi	a0,a0,-386 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0204156:	8767a783          	lw	a5,-1930(a5) # ffffffffc02b29c8 <swap_init_ok>
...
ffffffffc020425a:	d5a68693          	addi	a3,a3,-678 # ffffffffc0207fb0 <default_pmm_manager+0xcb0>
ffffffffc020425e:	00003617          	auipc	a2,0x3
ffffffffc0204262:	a0a60613          	addi	a2,a2,-1526 # ffffffffc0206c68 <commands+0x450>
ffffffffc0204266:	07400593          	li	a1,116
ffffffffc020426a:	00004517          	auipc	a0,0x4
ffffffffc020426e:	d3650513          	addi	a0,a0,-714 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
ffffffffc0204272:	a08fc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0204276:	00004697          	auipc	a3,0x4
ffffffffc020427a:	d7a68693          	addi	a3,a3,-646 # ffffffffc0207ff0 <default_pmm_manager+0xcf0>
ffffffffc020427e:	00003617          	auipc	a2,0x3
ffffffffc0204282:	9ea60613          	addi	a2,a2,-1558 # ffffffffc0206c68 <commands+0x450>
ffffffffc0204286:	06c00593          	li	a1,108
ffffffffc020428a:	00004517          	auipc	a0,0x4
ffffffffc020428e:	d1650513          	addi	a0,a0,-746 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
ffffffffc0204292:	9e8fc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0204296:	00004697          	auipc	a3,0x4
ffffffffc020429a:	d3a68693          	addi	a3,a3,-710 # ffffffffc0207fd0 <default_pmm_manager+0xcd0>
ffffffffc020429e:	00003617          	auipc	a2,0x3
ffffffffc02042a2:	9ca60613          	addi	a2,a2,-1590 # ffffffffc0206c68 <commands+0x450>
ffffffffc02042a6:	06b00593          	li	a1,107
ffffffffc02042aa:	00004517          	auipc	a0,0x4
ffffffffc02042ae:	cf650513          	addi	a0,a0,-778 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
...
ffffffffc02042ec:	d2868693          	addi	a3,a3,-728 # ffffffffc0208010 <default_pmm_manager+0xd10>
ffffffffc02042f0:	00003617          	auipc	a2,0x3
ffffffffc02042f4:	97860613          	addi	a2,a2,-1672 # ffffffffc0206c68 <commands+0x450>
ffffffffc02042f8:	09400593          	li	a1,148
ffffffffc02042fc:	00004517          	auipc	a0,0x4
ffffffffc0204300:	ca450513          	addi	a0,a0,-860 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
...
ffffffffc020439c:	6f068693          	addi	a3,a3,1776 # ffffffffc0207a88 <default_pmm_manager+0x788>
ffffffffc02043a0:	00003617          	auipc	a2,0x3
ffffffffc02043a4:	8c860613          	addi	a2,a2,-1848 # ffffffffc0206c68 <commands+0x450>
ffffffffc02043a8:	0a700593          	li	a1,167
ffffffffc02043ac:	00004517          	auipc	a0,0x4
ffffffffc02043b0:	bf450513          	addi	a0,a0,-1036 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
...
ffffffffc0204436:	bf668693          	addi	a3,a3,-1034 # ffffffffc0208028 <default_pmm_manager+0xd28>
ffffffffc020443a:	00003617          	auipc	a2,0x3
ffffffffc020443e:	82e60613          	addi	a2,a2,-2002 # ffffffffc0206c68 <commands+0x450>
ffffffffc0204442:	0c000593          	li	a1,192
ffffffffc0204446:	00004517          	auipc	a0,0x4
ffffffffc020444a:	b5a50513          	addi	a0,a0,-1190 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
...
ffffffffc02044ac:	ba068693          	addi	a3,a3,-1120 # ffffffffc0208048 <default_pmm_manager+0xd48>
ffffffffc02044b0:	00002617          	auipc	a2,0x2
ffffffffc02044b4:	7b860613          	addi	a2,a2,1976 # ffffffffc0206c68 <commands+0x450>
ffffffffc02044b8:	0d600593          	li	a1,214
ffffffffc02044bc:	00004517          	auipc	a0,0x4
ffffffffc02044c0:	ae450513          	addi	a0,a0,-1308 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
...
ffffffffc020450c:	5b868693          	addi	a3,a3,1464 # ffffffffc0207ac0 <default_pmm_manager+0x7c0>
ffffffffc0204510:	00002617          	auipc	a2,0x2
ffffffffc0204514:	75860613          	addi	a2,a2,1880 # ffffffffc0206c68 <commands+0x450>
ffffffffc0204518:	11300593          	li	a1,275
ffffffffc020451c:	00004517          	auipc	a0,0x4
ffffffffc0204520:	a8450513          	addi	a0,a0,-1404 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
...
ffffffffc020455a:	56a68693          	addi	a3,a3,1386 # ffffffffc0207ac0 <default_pmm_manager+0x7c0>
ffffffffc020455e:	00002617          	auipc	a2,0x2
ffffffffc0204562:	70a60613          	addi	a2,a2,1802 # ffffffffc0206c68 <commands+0x450>
ffffffffc0204566:	11900593          	li	a1,281
ffffffffc020456a:	00004517          	auipc	a0,0x4
ffffffffc020456e:	a3650513          	addi	a0,a0,-1482 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
...
ffffffffc0204582:	fe87b683          	ld	a3,-24(a5) # ffffffffffffefe8 <end+0x3fd4c5ec>
...
ffffffffc020462e:	b3e50513          	addi	a0,a0,-1218 # ffffffffc0208168 <default_pmm_manager+0xe68>
ffffffffc0204632:	b4ffb0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0204636:	00004697          	auipc	a3,0x4
ffffffffc020463a:	b5a68693          	addi	a3,a3,-1190 # ffffffffc0208190 <default_pmm_manager+0xe90>
ffffffffc020463e:	00002617          	auipc	a2,0x2
ffffffffc0204642:	62a60613          	addi	a2,a2,1578 # ffffffffc0206c68 <commands+0x450>
ffffffffc0204646:	13b00593          	li	a1,315
ffffffffc020464a:	00004517          	auipc	a0,0x4
ffffffffc020464e:	95650513          	addi	a0,a0,-1706 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
...
ffffffffc0204666:	b4650513          	addi	a0,a0,-1210 # ffffffffc02081a8 <default_pmm_manager+0xea8>
...
ffffffffc020467c:	34a7bc23          	sd	a0,856(a5) # ffffffffc02b29d0 <check_mm_struct>
...
ffffffffc020468a:	30a4b483          	ld	s1,778(s1) # ffffffffc02b2990 <boot_pgdir>
    assert(pgdir[0] == 0);
...
ffffffffc0204702:	29aa8a93          	addi	s5,s5,666 # ffffffffc02b2998 <npage>
...
ffffffffc0204716:	556a3a03          	ld	s4,1366(s4) # ffffffffc0208c68 <nbase>
...
ffffffffc0204736:	27e9b983          	ld	s3,638(s3) # ffffffffc02b29b0 <va_pa_offset>
...
ffffffffc0204758:	24c98993          	addi	s3,s3,588 # ffffffffc02b29a0 <pages>
...
ffffffffc02047a4:	2207b823          	sd	zero,560(a5) # ffffffffc02b29d0 <check_mm_struct>
...
ffffffffc02047b4:	a8850513          	addi	a0,a0,-1400 # ffffffffc0208238 <default_pmm_manager+0xf38>
...
ffffffffc02047ce:	a8e50513          	addi	a0,a0,-1394 # ffffffffc0208258 <default_pmm_manager+0xf58>
}
...
ffffffffc02047dc:	8a868693          	addi	a3,a3,-1880 # ffffffffc0208080 <default_pmm_manager+0xd80>
ffffffffc02047e0:	00002617          	auipc	a2,0x2
ffffffffc02047e4:	48860613          	addi	a2,a2,1160 # ffffffffc0206c68 <commands+0x450>
ffffffffc02047e8:	12200593          	li	a1,290
ffffffffc02047ec:	00003517          	auipc	a0,0x3
ffffffffc02047f0:	7b450513          	addi	a0,a0,1972 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
ffffffffc02047f4:	c87fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02047f8:	00004697          	auipc	a3,0x4
ffffffffc02047fc:	91068693          	addi	a3,a3,-1776 # ffffffffc0208108 <default_pmm_manager+0xe08>
ffffffffc0204800:	00002617          	auipc	a2,0x2
ffffffffc0204804:	46860613          	addi	a2,a2,1128 # ffffffffc0206c68 <commands+0x450>
ffffffffc0204808:	13200593          	li	a1,306
ffffffffc020480c:	00003517          	auipc	a0,0x3
ffffffffc0204810:	79450513          	addi	a0,a0,1940 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
ffffffffc0204814:	c67fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0204818:	00004697          	auipc	a3,0x4
ffffffffc020481c:	92068693          	addi	a3,a3,-1760 # ffffffffc0208138 <default_pmm_manager+0xe38>
ffffffffc0204820:	00002617          	auipc	a2,0x2
ffffffffc0204824:	44860613          	addi	a2,a2,1096 # ffffffffc0206c68 <commands+0x450>
ffffffffc0204828:	13300593          	li	a1,307
ffffffffc020482c:	00003517          	auipc	a0,0x3
ffffffffc0204830:	77450513          	addi	a0,a0,1908 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
ffffffffc0204834:	c47fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(vma != NULL);
ffffffffc0204838:	00003697          	auipc	a3,0x3
ffffffffc020483c:	28868693          	addi	a3,a3,648 # ffffffffc0207ac0 <default_pmm_manager+0x7c0>
ffffffffc0204840:	00002617          	auipc	a2,0x2
ffffffffc0204844:	42860613          	addi	a2,a2,1064 # ffffffffc0206c68 <commands+0x450>
ffffffffc0204848:	15200593          	li	a1,338
ffffffffc020484c:	00003517          	auipc	a0,0x3
ffffffffc0204850:	75450513          	addi	a0,a0,1876 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
ffffffffc0204854:	c27fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0204858:	00004697          	auipc	a3,0x4
ffffffffc020485c:	81068693          	addi	a3,a3,-2032 # ffffffffc0208068 <default_pmm_manager+0xd68>
ffffffffc0204860:	00002617          	auipc	a2,0x2
ffffffffc0204864:	40860613          	addi	a2,a2,1032 # ffffffffc0206c68 <commands+0x450>
ffffffffc0204868:	12000593          	li	a1,288
ffffffffc020486c:	00003517          	auipc	a0,0x3
ffffffffc0204870:	73450513          	addi	a0,a0,1844 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
ffffffffc0204874:	c07fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma3 == NULL);
ffffffffc0204878:	00004697          	auipc	a3,0x4
ffffffffc020487c:	86068693          	addi	a3,a3,-1952 # ffffffffc02080d8 <default_pmm_manager+0xdd8>
ffffffffc0204880:	00002617          	auipc	a2,0x2
ffffffffc0204884:	3e860613          	addi	a2,a2,1000 # ffffffffc0206c68 <commands+0x450>
ffffffffc0204888:	12c00593          	li	a1,300
ffffffffc020488c:	00003517          	auipc	a0,0x3
ffffffffc0204890:	71450513          	addi	a0,a0,1812 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
ffffffffc0204894:	be7fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma2 != NULL);
ffffffffc0204898:	00004697          	auipc	a3,0x4
ffffffffc020489c:	83068693          	addi	a3,a3,-2000 # ffffffffc02080c8 <default_pmm_manager+0xdc8>
ffffffffc02048a0:	00002617          	auipc	a2,0x2
ffffffffc02048a4:	3c860613          	addi	a2,a2,968 # ffffffffc0206c68 <commands+0x450>
ffffffffc02048a8:	12a00593          	li	a1,298
ffffffffc02048ac:	00003517          	auipc	a0,0x3
ffffffffc02048b0:	6f450513          	addi	a0,a0,1780 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
ffffffffc02048b4:	bc7fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma1 != NULL);
ffffffffc02048b8:	00004697          	auipc	a3,0x4
ffffffffc02048bc:	80068693          	addi	a3,a3,-2048 # ffffffffc02080b8 <default_pmm_manager+0xdb8>
ffffffffc02048c0:	00002617          	auipc	a2,0x2
ffffffffc02048c4:	3a860613          	addi	a2,a2,936 # ffffffffc0206c68 <commands+0x450>
ffffffffc02048c8:	12800593          	li	a1,296
ffffffffc02048cc:	00003517          	auipc	a0,0x3
ffffffffc02048d0:	6d450513          	addi	a0,a0,1748 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
ffffffffc02048d4:	ba7fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma5 == NULL);
ffffffffc02048d8:	00004697          	auipc	a3,0x4
ffffffffc02048dc:	82068693          	addi	a3,a3,-2016 # ffffffffc02080f8 <default_pmm_manager+0xdf8>
ffffffffc02048e0:	00002617          	auipc	a2,0x2
ffffffffc02048e4:	38860613          	addi	a2,a2,904 # ffffffffc0206c68 <commands+0x450>
ffffffffc02048e8:	13000593          	li	a1,304
ffffffffc02048ec:	00003517          	auipc	a0,0x3
ffffffffc02048f0:	6b450513          	addi	a0,a0,1716 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
ffffffffc02048f4:	b87fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma4 == NULL);
ffffffffc02048f8:	00003697          	auipc	a3,0x3
ffffffffc02048fc:	7f068693          	addi	a3,a3,2032 # ffffffffc02080e8 <default_pmm_manager+0xde8>
ffffffffc0204900:	00002617          	auipc	a2,0x2
ffffffffc0204904:	36860613          	addi	a2,a2,872 # ffffffffc0206c68 <commands+0x450>
ffffffffc0204908:	12e00593          	li	a1,302
ffffffffc020490c:	00003517          	auipc	a0,0x3
ffffffffc0204910:	69450513          	addi	a0,a0,1684 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
ffffffffc0204914:	b67fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0204918:	00004697          	auipc	a3,0x4
ffffffffc020491c:	8b068693          	addi	a3,a3,-1872 # ffffffffc02081c8 <default_pmm_manager+0xec8>
ffffffffc0204920:	00002617          	auipc	a2,0x2
ffffffffc0204924:	34860613          	addi	a2,a2,840 # ffffffffc0206c68 <commands+0x450>
ffffffffc0204928:	14b00593          	li	a1,331
ffffffffc020492c:	00003517          	auipc	a0,0x3
ffffffffc0204930:	67450513          	addi	a0,a0,1652 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
ffffffffc0204934:	b47fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(mm != NULL);
ffffffffc0204938:	00003697          	auipc	a3,0x3
ffffffffc020493c:	15068693          	addi	a3,a3,336 # ffffffffc0207a88 <default_pmm_manager+0x788>
ffffffffc0204940:	00002617          	auipc	a2,0x2
ffffffffc0204944:	32860613          	addi	a2,a2,808 # ffffffffc0206c68 <commands+0x450>
ffffffffc0204948:	10c00593          	li	a1,268
ffffffffc020494c:	00003517          	auipc	a0,0x3
ffffffffc0204950:	65450513          	addi	a0,a0,1620 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
ffffffffc0204954:	b27fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0204958:	00004697          	auipc	a3,0x4
ffffffffc020495c:	8b868693          	addi	a3,a3,-1864 # ffffffffc0208210 <default_pmm_manager+0xf10>
ffffffffc0204960:	00002617          	auipc	a2,0x2
ffffffffc0204964:	30860613          	addi	a2,a2,776 # ffffffffc0206c68 <commands+0x450>
ffffffffc0204968:	17000593          	li	a1,368
ffffffffc020496c:	00003517          	auipc	a0,0x3
ffffffffc0204970:	63450513          	addi	a0,a0,1588 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
ffffffffc0204974:	b07fb0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc0204978:	00003617          	auipc	a2,0x3
ffffffffc020497c:	9c060613          	addi	a2,a2,-1600 # ffffffffc0207338 <default_pmm_manager+0x38>
ffffffffc0204980:	06900593          	li	a1,105
ffffffffc0204984:	00003517          	auipc	a0,0x3
ffffffffc0204988:	9dc50513          	addi	a0,a0,-1572 # ffffffffc0207360 <default_pmm_manager+0x60>
ffffffffc020498c:	aeffb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir[0] == 0);
ffffffffc0204990:	00003697          	auipc	a3,0x3
ffffffffc0204994:	12068693          	addi	a3,a3,288 # ffffffffc0207ab0 <default_pmm_manager+0x7b0>
ffffffffc0204998:	00002617          	auipc	a2,0x2
ffffffffc020499c:	2d060613          	addi	a2,a2,720 # ffffffffc0206c68 <commands+0x450>
ffffffffc02049a0:	14f00593          	li	a1,335
ffffffffc02049a4:	00003517          	auipc	a0,0x3
ffffffffc02049a8:	5fc50513          	addi	a0,a0,1532 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
ffffffffc02049ac:	acffb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc02049b0:	00004697          	auipc	a3,0x4
ffffffffc02049b4:	83068693          	addi	a3,a3,-2000 # ffffffffc02081e0 <default_pmm_manager+0xee0>
ffffffffc02049b8:	00002617          	auipc	a2,0x2
ffffffffc02049bc:	2b060613          	addi	a2,a2,688 # ffffffffc0206c68 <commands+0x450>
ffffffffc02049c0:	15700593          	li	a1,343
ffffffffc02049c4:	00003517          	auipc	a0,0x3
ffffffffc02049c8:	5dc50513          	addi	a0,a0,1500 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
ffffffffc02049cc:	aaffb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02049d0:	00003617          	auipc	a2,0x3
ffffffffc02049d4:	a3860613          	addi	a2,a2,-1480 # ffffffffc0207408 <default_pmm_manager+0x108>
ffffffffc02049d8:	06200593          	li	a1,98
ffffffffc02049dc:	00003517          	auipc	a0,0x3
ffffffffc02049e0:	98450513          	addi	a0,a0,-1660 # ffffffffc0207360 <default_pmm_manager+0x60>
ffffffffc02049e4:	a97fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(sum == 0);
ffffffffc02049e8:	00004697          	auipc	a3,0x4
ffffffffc02049ec:	81868693          	addi	a3,a3,-2024 # ffffffffc0208200 <default_pmm_manager+0xf00>
ffffffffc02049f0:	00002617          	auipc	a2,0x2
ffffffffc02049f4:	27860613          	addi	a2,a2,632 # ffffffffc0206c68 <commands+0x450>
ffffffffc02049f8:	16300593          	li	a1,355
ffffffffc02049fc:	00003517          	auipc	a0,0x3
ffffffffc0204a00:	5a450513          	addi	a0,a0,1444 # ffffffffc0207fa0 <default_pmm_manager+0xca0>
...
ffffffffc0204a20:	fbc7a783          	lw	a5,-68(a5) # ffffffffc02b29d8 <pgfault_num>
ffffffffc0204a24:	2785                	addiw	a5,a5,1
ffffffffc0204a26:	000ae717          	auipc	a4,0xae
ffffffffc0204a2a:	faf72923          	sw	a5,-78(a4) # ffffffffc02b29d8 <pgfault_num>
...
ffffffffc0204a56:	f767a783          	lw	a5,-138(a5) # ffffffffc02b29c8 <swap_init_ok>
...
ffffffffc0204aaa:	81a50513          	addi	a0,a0,-2022 # ffffffffc02082c0 <default_pmm_manager+0xfc0>
...
ffffffffc0204abc:	7b850513          	addi	a0,a0,1976 # ffffffffc0208270 <default_pmm_manager+0xf70>
...
ffffffffc0204acc:	82050513          	addi	a0,a0,-2016 # ffffffffc02082e8 <default_pmm_manager+0xfe8>
...
ffffffffc0204adc:	7c850513          	addi	a0,a0,1992 # ffffffffc02082a0 <default_pmm_manager+0xfa0>
...
ffffffffc0204b96:	e2a7b323          	sd	a0,-474(a5) # ffffffffc02b29b8 <max_swap_offset>
}
ffffffffc0204b9a:	0141                	addi	sp,sp,16
ffffffffc0204b9c:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0204b9e:	00003617          	auipc	a2,0x3
ffffffffc0204ba2:	77260613          	addi	a2,a2,1906 # ffffffffc0208310 <default_pmm_manager+0x1010>
ffffffffc0204ba6:	45b5                	li	a1,13
ffffffffc0204ba8:	00003517          	auipc	a0,0x3
ffffffffc0204bac:	78850513          	addi	a0,a0,1928 # ffffffffc0208330 <default_pmm_manager+0x1030>
...
ffffffffc0204bec:	db06b683          	ld	a3,-592(a3) # ffffffffc02b2998 <npage>
...
ffffffffc0204c00:	db47b783          	ld	a5,-588(a5) # ffffffffc02b29b0 <va_pa_offset>
...
ffffffffc0204c16:	73660613          	addi	a2,a2,1846 # ffffffffc0208348 <default_pmm_manager+0x1048>
ffffffffc0204c1a:	45d1                	li	a1,20
ffffffffc0204c1c:	00003517          	auipc	a0,0x3
ffffffffc0204c20:	71450513          	addi	a0,a0,1812 # ffffffffc0208330 <default_pmm_manager+0x1030>
...
ffffffffc0204c32:	70a60613          	addi	a2,a2,1802 # ffffffffc0207338 <default_pmm_manager+0x38>
ffffffffc0204c36:	00002517          	auipc	a0,0x2
ffffffffc0204c3a:	72a50513          	addi	a0,a0,1834 # ffffffffc0207360 <default_pmm_manager+0x60>
...
ffffffffc0204c7a:	d226b683          	ld	a3,-734(a3) # ffffffffc02b2998 <npage>
...
ffffffffc0204c8e:	d267b783          	ld	a5,-730(a5) # ffffffffc02b29b0 <va_pa_offset>
...
ffffffffc0204ca4:	6a860613          	addi	a2,a2,1704 # ffffffffc0208348 <default_pmm_manager+0x1048>
ffffffffc0204ca8:	45e5                	li	a1,25
ffffffffc0204caa:	00003517          	auipc	a0,0x3
ffffffffc0204cae:	68650513          	addi	a0,a0,1670 # ffffffffc0208330 <default_pmm_manager+0x1030>
...
ffffffffc0204cc0:	67c60613          	addi	a2,a2,1660 # ffffffffc0207338 <default_pmm_manager+0x38>
ffffffffc0204cc4:	00002517          	auipc	a0,0x2
ffffffffc0204cc8:	69c50513          	addi	a0,a0,1692 # ffffffffc0207360 <default_pmm_manager+0x60>
...
ffffffffc0204cd2:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204cd4:	60e000ef          	jal	ra,ffffffffc02052e2 <do_exit>
...
ffffffffc0204cf4:	4581                	li	a1,0
     proc->wait_state = 0; // 初始化进程等待状态
ffffffffc0204cf6:	0e052623          	sw	zero,236(a0)
proc->cptr = proc->optr = proc->yptr = NULL; // 设置进程指针
ffffffffc0204cfa:	0e053c23          	sd	zero,248(a0)
ffffffffc0204cfe:	10053023          	sd	zero,256(a0)
ffffffffc0204d02:	0e053823          	sd	zero,240(a0)
        proc->runs = 0;                          
ffffffffc0204d06:	00052423          	sw	zero,8(a0)
        proc->kstack = 0;          
ffffffffc0204d0a:	00053823          	sd	zero,16(a0)
        proc->need_resched = 0;              
ffffffffc0204d0e:	00053c23          	sd	zero,24(a0)
        proc->parent = NULL;                    
ffffffffc0204d12:	02053023          	sd	zero,32(a0)
        proc->mm = NULL;                         
ffffffffc0204d16:	02053423          	sd	zero,40(a0)
        memset(&(proc->context), 0, sizeof(struct context)); 
ffffffffc0204d1a:	03050513          	addi	a0,a0,48
ffffffffc0204d1e:	067010ef          	jal	ra,ffffffffc0206584 <memset>
        proc->tf = NULL;                        
        proc->cr3 = boot_cr3;                     
ffffffffc0204d22:	000ae797          	auipc	a5,0xae
ffffffffc0204d26:	c667b783          	ld	a5,-922(a5) # ffffffffc02b2988 <boot_cr3>
        proc->tf = NULL;                        
ffffffffc0204d2a:	0a043023          	sd	zero,160(s0)
        proc->cr3 = boot_cr3;                     
ffffffffc0204d2e:	f45c                	sd	a5,168(s0)
        proc->flags = 0;                        
ffffffffc0204d30:	0a042823          	sw	zero,176(s0)
        memset(proc->name, 0, PROC_NAME_LEN); 
ffffffffc0204d34:	463d                	li	a2,15
ffffffffc0204d36:	4581                	li	a1,0
ffffffffc0204d38:	0b440513          	addi	a0,s0,180
ffffffffc0204d3c:	049010ef          	jal	ra,ffffffffc0206584 <memset>
    }
    return proc;
}
...
ffffffffc0204d4e:	c967b783          	ld	a5,-874(a5) # ffffffffc02b29e0 <current>
...
ffffffffc0204d5c:	c887b783          	ld	a5,-888(a5) # ffffffffc02b29e0 <current>
ffffffffc0204d60:	43cc                	lw	a1,4(a5)
user_main(void *arg) {
ffffffffc0204d62:	7139                	addi	sp,sp,-64
    KERNEL_EXECVE2(TEST, TESTSTART, TESTSIZE);
ffffffffc0204d64:	00003617          	auipc	a2,0x3
ffffffffc0204d68:	60460613          	addi	a2,a2,1540 # ffffffffc0208368 <default_pmm_manager+0x1068>
ffffffffc0204d6c:	00003517          	auipc	a0,0x3
ffffffffc0204d70:	60c50513          	addi	a0,a0,1548 # ffffffffc0208378 <default_pmm_manager+0x1078>
user_main(void *arg) {
...
ffffffffc0204d88:	5e450513          	addi	a0,a0,1508 # ffffffffc0208368 <default_pmm_manager+0x1068>
ffffffffc0204d8c:	00046797          	auipc	a5,0x46
ffffffffc0204d90:	a1478793          	addi	a5,a5,-1516 # ffffffffc024a7a0 <_binary_obj___user_forktest_out_start>
ffffffffc0204d94:	f03e                	sd	a5,32(sp)
ffffffffc0204d96:	f42a                	sd	a0,40(sp)
    int64_t ret=0, len = strlen(name);
ffffffffc0204d98:	e802                	sd	zero,16(sp)
ffffffffc0204d9a:	76e010ef          	jal	ra,ffffffffc0206508 <strlen>
...
ffffffffc0204db6:	5ee50513          	addi	a0,a0,1518 # ffffffffc02083a0 <default_pmm_manager+0x10a0>
...
ffffffffc0204dc2:	5f260613          	addi	a2,a2,1522 # ffffffffc02083b0 <default_pmm_manager+0x10b0>
ffffffffc0204dc6:	36000593          	li	a1,864
ffffffffc0204dca:	00003517          	auipc	a0,0x3
ffffffffc0204dce:	60650513          	addi	a0,a0,1542 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
...
ffffffffc0204e0e:	b9653503          	ld	a0,-1130(a0) # ffffffffc02b29a0 <pages>
...
ffffffffc0204e20:	5c460613          	addi	a2,a2,1476 # ffffffffc02073e0 <default_pmm_manager+0xe0>
ffffffffc0204e24:	06e00593          	li	a1,110
ffffffffc0204e28:	00002517          	auipc	a0,0x2
ffffffffc0204e2c:	53850513          	addi	a0,a0,1336 # ffffffffc0207360 <default_pmm_manager+0x60>
ffffffffc0204e30:	e4afb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204e34:	00002617          	auipc	a2,0x2
ffffffffc0204e38:	5d460613          	addi	a2,a2,1492 # ffffffffc0207408 <default_pmm_manager+0x108>
ffffffffc0204e3c:	06200593          	li	a1,98
ffffffffc0204e40:	00002517          	auipc	a0,0x2
ffffffffc0204e44:	52050513          	addi	a0,a0,1312 # ffffffffc0207360 <default_pmm_manager+0x60>
...
ffffffffc0204e54:	b9090913          	addi	s2,s2,-1136 # ffffffffc02b29e0 <current>
proc_run(struct proc_struct *proc) {
...
ffffffffc0204e8a:	024010ef          	jal	ra,ffffffffc0205eae <switch_to>
    if (flag) {
...
ffffffffc0204ec0:	b3c90913          	addi	s2,s2,-1220 # ffffffffc02b29f8 <nr_process>
...
ffffffffc0204ee2:	32f75663          	bge	a4,a5,ffffffffc020520e <do_fork+0x356>
...
ffffffffc0204ef0:	84aa                	mv	s1,a0
    if (proc == NULL) {
ffffffffc0204ef2:	2e050f63          	beqz	a0,ffffffffc02051f0 <do_fork+0x338>
    proc->parent = current;
ffffffffc0204ef6:	000aec17          	auipc	s8,0xae
ffffffffc0204efa:	aeac0c13          	addi	s8,s8,-1302 # ffffffffc02b29e0 <current>
ffffffffc0204efe:	000c3783          	ld	a5,0(s8)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204f02:	4509                	li	a0,2
    proc->parent = current;
ffffffffc0204f04:	f09c                	sd	a5,32(s1)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204f06:	ddbfc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
    if (page != NULL) {
ffffffffc0204f0a:	2e050063          	beqz	a0,ffffffffc02051ea <do_fork+0x332>
    return page - pages + nbase;
ffffffffc0204f0e:	000aea97          	auipc	s5,0xae
ffffffffc0204f12:	a92a8a93          	addi	s5,s5,-1390 # ffffffffc02b29a0 <pages>
ffffffffc0204f16:	000ab683          	ld	a3,0(s5)
ffffffffc0204f1a:	00004b17          	auipc	s6,0x4
ffffffffc0204f1e:	d4eb0b13          	addi	s6,s6,-690 # ffffffffc0208c68 <nbase>
ffffffffc0204f22:	000b3783          	ld	a5,0(s6)
ffffffffc0204f26:	40d506b3          	sub	a3,a0,a3
    return KADDR(page2pa(page));
ffffffffc0204f2a:	000aeb97          	auipc	s7,0xae
ffffffffc0204f2e:	a6eb8b93          	addi	s7,s7,-1426 # ffffffffc02b2998 <npage>
    return page - pages + nbase;
ffffffffc0204f32:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0204f34:	5dfd                	li	s11,-1
ffffffffc0204f36:	000bb703          	ld	a4,0(s7)
    return page - pages + nbase;
ffffffffc0204f3a:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0204f3c:	00cddd93          	srli	s11,s11,0xc
ffffffffc0204f40:	01b6f633          	and	a2,a3,s11
    return page2ppn(page) << PGSHIFT;
ffffffffc0204f44:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204f46:	32e67a63          	bgeu	a2,a4,ffffffffc020527a <do_fork+0x3c2>
    struct mm_struct *mm, *oldmm = current->mm;
ffffffffc0204f4a:	000c3603          	ld	a2,0(s8)
ffffffffc0204f4e:	000aec17          	auipc	s8,0xae
ffffffffc0204f52:	a62c0c13          	addi	s8,s8,-1438 # ffffffffc02b29b0 <va_pa_offset>
ffffffffc0204f56:	000c3703          	ld	a4,0(s8)
ffffffffc0204f5a:	02863d03          	ld	s10,40(a2)
ffffffffc0204f5e:	e43e                	sd	a5,8(sp)
ffffffffc0204f60:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc0204f62:	e894                	sd	a3,16(s1)
    if (oldmm == NULL) {
ffffffffc0204f64:	020d0863          	beqz	s10,ffffffffc0204f94 <do_fork+0xdc>
    if (clone_flags & CLONE_VM) {
ffffffffc0204f68:	100a7a13          	andi	s4,s4,256
ffffffffc0204f6c:	1c0a0163          	beqz	s4,ffffffffc020512e <do_fork+0x276>
}

static inline int
mm_count_inc(struct mm_struct *mm) {
    mm->mm_count += 1;
ffffffffc0204f70:	030d2703          	lw	a4,48(s10)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204f74:	018d3783          	ld	a5,24(s10)
ffffffffc0204f78:	c02006b7          	lui	a3,0xc0200
ffffffffc0204f7c:	2705                	addiw	a4,a4,1
ffffffffc0204f7e:	02ed2823          	sw	a4,48(s10)
    proc->mm = mm;
ffffffffc0204f82:	03a4b423          	sd	s10,40(s1)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204f86:	2cd7e163          	bltu	a5,a3,ffffffffc0205248 <do_fork+0x390>
ffffffffc0204f8a:	000c3703          	ld	a4,0(s8)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204f8e:	6894                	ld	a3,16(s1)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204f90:	8f99                	sub	a5,a5,a4
ffffffffc0204f92:	f4dc                	sd	a5,168(s1)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204f94:	6789                	lui	a5,0x2
ffffffffc0204f96:	ee078793          	addi	a5,a5,-288 # 1ee0 <_binary_obj___user_faultread_out_size-0x7ce8>
ffffffffc0204f9a:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc0204f9c:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204f9e:	f0d4                	sd	a3,160(s1)
    *(proc->tf) = *tf;
ffffffffc0204fa0:	87b6                	mv	a5,a3
ffffffffc0204fa2:	12040893          	addi	a7,s0,288
ffffffffc0204fa6:	00063803          	ld	a6,0(a2)
ffffffffc0204faa:	6608                	ld	a0,8(a2)
ffffffffc0204fac:	6a0c                	ld	a1,16(a2)
ffffffffc0204fae:	6e18                	ld	a4,24(a2)
ffffffffc0204fb0:	0107b023          	sd	a6,0(a5)
ffffffffc0204fb4:	e788                	sd	a0,8(a5)
ffffffffc0204fb6:	eb8c                	sd	a1,16(a5)
ffffffffc0204fb8:	ef98                	sd	a4,24(a5)
ffffffffc0204fba:	02060613          	addi	a2,a2,32
ffffffffc0204fbe:	02078793          	addi	a5,a5,32
ffffffffc0204fc2:	ff1612e3          	bne	a2,a7,ffffffffc0204fa6 <do_fork+0xee>
    proc->tf->gpr.a0 = 0;
ffffffffc0204fc6:	0406b823          	sd	zero,80(a3) # ffffffffc0200050 <kern_init+0x1e>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204fca:	12098f63          	beqz	s3,ffffffffc0205108 <do_fork+0x250>
ffffffffc0204fce:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204fd2:	00000797          	auipc	a5,0x0
ffffffffc0204fd6:	d7878793          	addi	a5,a5,-648 # ffffffffc0204d4a <forkret>
ffffffffc0204fda:	f89c                	sd	a5,48(s1)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204fdc:	fc94                	sd	a3,56(s1)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204fde:	100027f3          	csrr	a5,sstatus
ffffffffc0204fe2:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204fe4:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204fe6:	14079063          	bnez	a5,ffffffffc0205126 <do_fork+0x26e>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204fea:	000a2817          	auipc	a6,0xa2
ffffffffc0204fee:	4ae80813          	addi	a6,a6,1198 # ffffffffc02a7498 <last_pid.1>
ffffffffc0204ff2:	00082783          	lw	a5,0(a6)
ffffffffc0204ff6:	6709                	lui	a4,0x2
ffffffffc0204ff8:	0017851b          	addiw	a0,a5,1
ffffffffc0204ffc:	00a82023          	sw	a0,0(a6)
ffffffffc0205000:	08e55d63          	bge	a0,a4,ffffffffc020509a <do_fork+0x1e2>
    if (last_pid >= next_safe) {
ffffffffc0205004:	000a2317          	auipc	t1,0xa2
ffffffffc0205008:	49830313          	addi	t1,t1,1176 # ffffffffc02a749c <next_safe.0>
ffffffffc020500c:	00032783          	lw	a5,0(t1)
ffffffffc0205010:	000ae417          	auipc	s0,0xae
ffffffffc0205014:	94840413          	addi	s0,s0,-1720 # ffffffffc02b2958 <proc_list>
ffffffffc0205018:	08f55963          	bge	a0,a5,ffffffffc02050aa <do_fork+0x1f2>
        proc->pid = get_pid();
ffffffffc020501c:	c0c8                	sw	a0,4(s1)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020501e:	45a9                	li	a1,10
ffffffffc0205020:	2501                	sext.w	a0,a0
ffffffffc0205022:	0e2010ef          	jal	ra,ffffffffc0206104 <hash32>
ffffffffc0205026:	02051793          	slli	a5,a0,0x20
ffffffffc020502a:	01c7d513          	srli	a0,a5,0x1c
ffffffffc020502e:	000aa797          	auipc	a5,0xaa
ffffffffc0205032:	92a78793          	addi	a5,a5,-1750 # ffffffffc02ae958 <hash_list>
ffffffffc0205036:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0205038:	650c                	ld	a1,8(a0)
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc020503a:	7094                	ld	a3,32(s1)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020503c:	0d848793          	addi	a5,s1,216
    prev->next = next->prev = elm;
ffffffffc0205040:	e19c                	sd	a5,0(a1)
    __list_add(elm, listelm, listelm->next);
ffffffffc0205042:	6410                	ld	a2,8(s0)
    prev->next = next->prev = elm;
ffffffffc0205044:	e51c                	sd	a5,8(a0)
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc0205046:	7af8                	ld	a4,240(a3)
    list_add(&proc_list, &(proc->list_link));
ffffffffc0205048:	0c848793          	addi	a5,s1,200
    elm->next = next;
ffffffffc020504c:	f0ec                	sd	a1,224(s1)
    elm->prev = prev;
ffffffffc020504e:	ece8                	sd	a0,216(s1)
    prev->next = next->prev = elm;
ffffffffc0205050:	e21c                	sd	a5,0(a2)
ffffffffc0205052:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc0205054:	e8f0                	sd	a2,208(s1)
    elm->prev = prev;
ffffffffc0205056:	e4e0                	sd	s0,200(s1)
    proc->yptr = NULL;
ffffffffc0205058:	0e04bc23          	sd	zero,248(s1)
    if ((proc->optr = proc->parent->cptr) != NULL) {
ffffffffc020505c:	10e4b023          	sd	a4,256(s1)
ffffffffc0205060:	c311                	beqz	a4,ffffffffc0205064 <do_fork+0x1ac>
        proc->optr->yptr = proc;
ffffffffc0205062:	ff64                	sd	s1,248(a4)
    nr_process ++;
ffffffffc0205064:	00092783          	lw	a5,0(s2)
    proc->parent->cptr = proc;
ffffffffc0205068:	fae4                	sd	s1,240(a3)
    nr_process ++;
ffffffffc020506a:	2785                	addiw	a5,a5,1
ffffffffc020506c:	00f92023          	sw	a5,0(s2)
    if (flag) {
ffffffffc0205070:	18099263          	bnez	s3,ffffffffc02051f4 <do_fork+0x33c>
    wakeup_proc(proc);
ffffffffc0205074:	8526                	mv	a0,s1
ffffffffc0205076:	6a3000ef          	jal	ra,ffffffffc0205f18 <wakeup_proc>
    ret = proc->pid;
ffffffffc020507a:	40c8                	lw	a0,4(s1)
}
ffffffffc020507c:	70e6                	ld	ra,120(sp)
ffffffffc020507e:	7446                	ld	s0,112(sp)
ffffffffc0205080:	74a6                	ld	s1,104(sp)
ffffffffc0205082:	7906                	ld	s2,96(sp)
ffffffffc0205084:	69e6                	ld	s3,88(sp)
ffffffffc0205086:	6a46                	ld	s4,80(sp)
ffffffffc0205088:	6aa6                	ld	s5,72(sp)
ffffffffc020508a:	6b06                	ld	s6,64(sp)
ffffffffc020508c:	7be2                	ld	s7,56(sp)
ffffffffc020508e:	7c42                	ld	s8,48(sp)
ffffffffc0205090:	7ca2                	ld	s9,40(sp)
ffffffffc0205092:	7d02                	ld	s10,32(sp)
ffffffffc0205094:	6de2                	ld	s11,24(sp)
ffffffffc0205096:	6109                	addi	sp,sp,128
ffffffffc0205098:	8082                	ret
        last_pid = 1;
ffffffffc020509a:	4785                	li	a5,1
ffffffffc020509c:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02050a0:	4505                	li	a0,1
ffffffffc02050a2:	000a2317          	auipc	t1,0xa2
ffffffffc02050a6:	3fa30313          	addi	t1,t1,1018 # ffffffffc02a749c <next_safe.0>
    return listelm->next;
ffffffffc02050aa:	000ae417          	auipc	s0,0xae
ffffffffc02050ae:	8ae40413          	addi	s0,s0,-1874 # ffffffffc02b2958 <proc_list>
ffffffffc02050b2:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc02050b6:	6789                	lui	a5,0x2
ffffffffc02050b8:	00f32023          	sw	a5,0(t1)
ffffffffc02050bc:	86aa                	mv	a3,a0
ffffffffc02050be:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc02050c0:	6e89                	lui	t4,0x2
ffffffffc02050c2:	148e0163          	beq	t3,s0,ffffffffc0205204 <do_fork+0x34c>
ffffffffc02050c6:	88ae                	mv	a7,a1
ffffffffc02050c8:	87f2                	mv	a5,t3
ffffffffc02050ca:	6609                	lui	a2,0x2
ffffffffc02050cc:	a811                	j	ffffffffc02050e0 <do_fork+0x228>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc02050ce:	00e6d663          	bge	a3,a4,ffffffffc02050da <do_fork+0x222>
ffffffffc02050d2:	00c75463          	bge	a4,a2,ffffffffc02050da <do_fork+0x222>
ffffffffc02050d6:	863a                	mv	a2,a4
ffffffffc02050d8:	4885                	li	a7,1
ffffffffc02050da:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02050dc:	00878d63          	beq	a5,s0,ffffffffc02050f6 <do_fork+0x23e>
            if (proc->pid == last_pid) {
ffffffffc02050e0:	f3c7a703          	lw	a4,-196(a5) # 1f3c <_binary_obj___user_faultread_out_size-0x7c8c>
ffffffffc02050e4:	fed715e3          	bne	a4,a3,ffffffffc02050ce <do_fork+0x216>
                if (++ last_pid >= next_safe) {
ffffffffc02050e8:	2685                	addiw	a3,a3,1
ffffffffc02050ea:	10c6d863          	bge	a3,a2,ffffffffc02051fa <do_fork+0x342>
ffffffffc02050ee:	679c                	ld	a5,8(a5)
ffffffffc02050f0:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc02050f2:	fe8797e3          	bne	a5,s0,ffffffffc02050e0 <do_fork+0x228>
ffffffffc02050f6:	c581                	beqz	a1,ffffffffc02050fe <do_fork+0x246>
ffffffffc02050f8:	00d82023          	sw	a3,0(a6)
ffffffffc02050fc:	8536                	mv	a0,a3
ffffffffc02050fe:	f0088fe3          	beqz	a7,ffffffffc020501c <do_fork+0x164>
ffffffffc0205102:	00c32023          	sw	a2,0(t1)
ffffffffc0205106:	bf19                	j	ffffffffc020501c <do_fork+0x164>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0205108:	89b6                	mv	s3,a3
ffffffffc020510a:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020510e:	00000797          	auipc	a5,0x0
ffffffffc0205112:	c3c78793          	addi	a5,a5,-964 # ffffffffc0204d4a <forkret>
ffffffffc0205116:	f89c                	sd	a5,48(s1)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0205118:	fc94                	sd	a3,56(s1)
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc0205120:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205122:	ec0784e3          	beqz	a5,ffffffffc0204fea <do_fork+0x132>
        intr_disable();
ffffffffc0205126:	d20fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc020512a:	4985                	li	s3,1
ffffffffc020512c:	bd7d                	j	ffffffffc0204fea <do_fork+0x132>
    if ((mm = mm_create()) == NULL) {
ffffffffc020512e:	802ff0ef          	jal	ra,ffffffffc0204130 <mm_create>
ffffffffc0205132:	8caa                	mv	s9,a0
ffffffffc0205134:	c159                	beqz	a0,ffffffffc02051ba <do_fork+0x302>
    if ((page = alloc_page()) == NULL) {
ffffffffc0205136:	4505                	li	a0,1
ffffffffc0205138:	ba9fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc020513c:	cd25                	beqz	a0,ffffffffc02051b4 <do_fork+0x2fc>
    return page - pages + nbase;
ffffffffc020513e:	000ab683          	ld	a3,0(s5)
ffffffffc0205142:	67a2                	ld	a5,8(sp)
    return KADDR(page2pa(page));
ffffffffc0205144:	000bb703          	ld	a4,0(s7)
    return page - pages + nbase;
ffffffffc0205148:	40d506b3          	sub	a3,a0,a3
ffffffffc020514c:	8699                	srai	a3,a3,0x6
ffffffffc020514e:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205150:	01b6fdb3          	and	s11,a3,s11
    return page2ppn(page) << PGSHIFT;
ffffffffc0205154:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205156:	12edf263          	bgeu	s11,a4,ffffffffc020527a <do_fork+0x3c2>
ffffffffc020515a:	000c3a03          	ld	s4,0(s8)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc020515e:	6605                	lui	a2,0x1
ffffffffc0205160:	000ae597          	auipc	a1,0xae
ffffffffc0205164:	8305b583          	ld	a1,-2000(a1) # ffffffffc02b2990 <boot_pgdir>
ffffffffc0205168:	9a36                	add	s4,s4,a3
ffffffffc020516a:	8552                	mv	a0,s4
ffffffffc020516c:	42a010ef          	jal	ra,ffffffffc0206596 <memcpy>
}
...
lock_mm(struct mm_struct *mm) {
    if (mm != NULL) {
        lock(&(mm->mm_lock));
ffffffffc0205170:	038d0d93          	addi	s11,s10,56
    mm->pgdir = pgdir;
ffffffffc0205174:	014cbc23          	sd	s4,24(s9)
...
ffffffffc0205178:	4785                	li	a5,1
ffffffffc020517a:	40fdb7af          	amoor.d	a5,a5,(s11)
...
ffffffffc0205180:	4a05                	li	s4,1
ffffffffc0205182:	c799                	beqz	a5,ffffffffc0205190 <do_fork+0x2d8>
        schedule();
ffffffffc0205184:	615000ef          	jal	ra,ffffffffc0205f98 <schedule>
ffffffffc0205188:	414db7af          	amoor.d	a5,s4,(s11)
    while (!try_lock(lock)) {
ffffffffc020518c:	8b85                	andi	a5,a5,1
ffffffffc020518e:	fbfd                	bnez	a5,ffffffffc0205184 <do_fork+0x2cc>
        ret = dup_mmap(mm, oldmm);
ffffffffc0205190:	85ea                	mv	a1,s10
ffffffffc0205192:	8566                	mv	a0,s9
ffffffffc0205194:	a24ff0ef          	jal	ra,ffffffffc02043b8 <dup_mmap>
...
ffffffffc0205198:	57f9                	li	a5,-2
ffffffffc020519a:	60fdb7af          	amoand.d	a5,a5,(s11)
...
ffffffffc02051a0:	cfa5                	beqz	a5,ffffffffc0205218 <do_fork+0x360>
good_mm:
ffffffffc02051a2:	8d66                	mv	s10,s9
    if (ret != 0) {
ffffffffc02051a4:	dc0506e3          	beqz	a0,ffffffffc0204f70 <do_fork+0xb8>
    exit_mmap(mm);
ffffffffc02051a8:	8566                	mv	a0,s9
ffffffffc02051aa:	aa8ff0ef          	jal	ra,ffffffffc0204452 <exit_mmap>
    put_pgdir(mm);
ffffffffc02051ae:	8566                	mv	a0,s9
ffffffffc02051b0:	c27ff0ef          	jal	ra,ffffffffc0204dd6 <put_pgdir>
    mm_destroy(mm);
ffffffffc02051b4:	8566                	mv	a0,s9
ffffffffc02051b6:	900ff0ef          	jal	ra,ffffffffc02042b6 <mm_destroy>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc02051ba:	6894                	ld	a3,16(s1)
    return pa2page(PADDR(kva));
ffffffffc02051bc:	c02007b7          	lui	a5,0xc0200
ffffffffc02051c0:	0af6e163          	bltu	a3,a5,ffffffffc0205262 <do_fork+0x3aa>
ffffffffc02051c4:	000c3783          	ld	a5,0(s8)
    if (PPN(pa) >= npage) {
ffffffffc02051c8:	000bb703          	ld	a4,0(s7)
    return pa2page(PADDR(kva));
ffffffffc02051cc:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc02051d0:	83b1                	srli	a5,a5,0xc
ffffffffc02051d2:	04e7ff63          	bgeu	a5,a4,ffffffffc0205230 <do_fork+0x378>
    return &pages[PPN(pa) - nbase];
ffffffffc02051d6:	000b3703          	ld	a4,0(s6)
ffffffffc02051da:	000ab503          	ld	a0,0(s5)
ffffffffc02051de:	4589                	li	a1,2
ffffffffc02051e0:	8f99                	sub	a5,a5,a4
ffffffffc02051e2:	079a                	slli	a5,a5,0x6
ffffffffc02051e4:	953e                	add	a0,a0,a5
ffffffffc02051e6:	b8dfc0ef          	jal	ra,ffffffffc0201d72 <free_pages>
    kfree(proc);
ffffffffc02051ea:	8526                	mv	a0,s1
ffffffffc02051ec:	9c7fc0ef          	jal	ra,ffffffffc0201bb2 <kfree>
    ret = -E_NO_MEM;
ffffffffc02051f0:	5571                	li	a0,-4
    return ret;
ffffffffc02051f2:	b569                	j	ffffffffc020507c <do_fork+0x1c4>
        intr_enable();
ffffffffc02051f4:	c4cfb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc02051f8:	bdb5                	j	ffffffffc0205074 <do_fork+0x1bc>
                    if (last_pid >= MAX_PID) {
ffffffffc02051fa:	01d6c363          	blt	a3,t4,ffffffffc0205200 <do_fork+0x348>
                        last_pid = 1;
ffffffffc02051fe:	4685                	li	a3,1
                    goto repeat;
ffffffffc0205200:	4585                	li	a1,1
ffffffffc0205202:	b5c1                	j	ffffffffc02050c2 <do_fork+0x20a>
ffffffffc0205204:	c599                	beqz	a1,ffffffffc0205212 <do_fork+0x35a>
ffffffffc0205206:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc020520a:	8536                	mv	a0,a3
ffffffffc020520c:	bd01                	j	ffffffffc020501c <do_fork+0x164>
    int ret = -E_NO_FREE_PROC;
ffffffffc020520e:	556d                	li	a0,-5
ffffffffc0205210:	b5b5                	j	ffffffffc020507c <do_fork+0x1c4>
    return last_pid;
ffffffffc0205212:	00082503          	lw	a0,0(a6)
ffffffffc0205216:	b519                	j	ffffffffc020501c <do_fork+0x164>
        panic("Unlock failed.\n");
ffffffffc0205218:	00003617          	auipc	a2,0x3
ffffffffc020521c:	1d060613          	addi	a2,a2,464 # ffffffffc02083e8 <default_pmm_manager+0x10e8>
ffffffffc0205220:	03100593          	li	a1,49
ffffffffc0205224:	00003517          	auipc	a0,0x3
ffffffffc0205228:	1d450513          	addi	a0,a0,468 # ffffffffc02083f8 <default_pmm_manager+0x10f8>
ffffffffc020522c:	a4efb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0205230:	00002617          	auipc	a2,0x2
ffffffffc0205234:	1d860613          	addi	a2,a2,472 # ffffffffc0207408 <default_pmm_manager+0x108>
ffffffffc0205238:	06200593          	li	a1,98
ffffffffc020523c:	00002517          	auipc	a0,0x2
ffffffffc0205240:	12450513          	addi	a0,a0,292 # ffffffffc0207360 <default_pmm_manager+0x60>
ffffffffc0205244:	a36fb0ef          	jal	ra,ffffffffc020047a <__panic>
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0205248:	86be                	mv	a3,a5
ffffffffc020524a:	00002617          	auipc	a2,0x2
ffffffffc020524e:	19660613          	addi	a2,a2,406 # ffffffffc02073e0 <default_pmm_manager+0xe0>
ffffffffc0205252:	16d00593          	li	a1,365
ffffffffc0205256:	00003517          	auipc	a0,0x3
ffffffffc020525a:	17a50513          	addi	a0,a0,378 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc020525e:	a1cfb0ef          	jal	ra,ffffffffc020047a <__panic>
    return pa2page(PADDR(kva));
ffffffffc0205262:	00002617          	auipc	a2,0x2
ffffffffc0205266:	17e60613          	addi	a2,a2,382 # ffffffffc02073e0 <default_pmm_manager+0xe0>
ffffffffc020526a:	06e00593          	li	a1,110
ffffffffc020526e:	00002517          	auipc	a0,0x2
ffffffffc0205272:	0f250513          	addi	a0,a0,242 # ffffffffc0207360 <default_pmm_manager+0x60>
ffffffffc0205276:	a04fb0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc020527a:	00002617          	auipc	a2,0x2
ffffffffc020527e:	0be60613          	addi	a2,a2,190 # ffffffffc0207338 <default_pmm_manager+0x38>
ffffffffc0205282:	06900593          	li	a1,105
ffffffffc0205286:	00002517          	auipc	a0,0x2
ffffffffc020528a:	0da50513          	addi	a0,a0,218 # ffffffffc0207360 <default_pmm_manager+0x60>
ffffffffc020528e:	9ecfb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205292 <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0205292:	7129                	addi	sp,sp,-320
ffffffffc0205294:	fa22                	sd	s0,304(sp)
ffffffffc0205296:	f626                	sd	s1,296(sp)
ffffffffc0205298:	f24a                	sd	s2,288(sp)
ffffffffc020529a:	84ae                	mv	s1,a1
ffffffffc020529c:	892a                	mv	s2,a0
ffffffffc020529e:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02052a0:	4581                	li	a1,0
ffffffffc02052a2:	12000613          	li	a2,288
ffffffffc02052a6:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc02052a8:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02052aa:	2da010ef          	jal	ra,ffffffffc0206584 <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02052ae:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc02052b0:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc02052b2:	100027f3          	csrr	a5,sstatus
ffffffffc02052b6:	edd7f793          	andi	a5,a5,-291
ffffffffc02052ba:	1207e793          	ori	a5,a5,288
ffffffffc02052be:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02052c0:	860a                	mv	a2,sp
ffffffffc02052c2:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02052c6:	00000797          	auipc	a5,0x0
ffffffffc02052ca:	a0a78793          	addi	a5,a5,-1526 # ffffffffc0204cd0 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02052ce:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02052d0:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02052d2:	be7ff0ef          	jal	ra,ffffffffc0204eb8 <do_fork>
}
ffffffffc02052d6:	70f2                	ld	ra,312(sp)
ffffffffc02052d8:	7452                	ld	s0,304(sp)
ffffffffc02052da:	74b2                	ld	s1,296(sp)
ffffffffc02052dc:	7912                	ld	s2,288(sp)
ffffffffc02052de:	6131                	addi	sp,sp,320
ffffffffc02052e0:	8082                	ret

ffffffffc02052e2 <do_exit>:
do_exit(int error_code) {
ffffffffc02052e2:	7179                	addi	sp,sp,-48
ffffffffc02052e4:	f022                	sd	s0,32(sp)
    if (current == idleproc) {
ffffffffc02052e6:	000ad417          	auipc	s0,0xad
ffffffffc02052ea:	6fa40413          	addi	s0,s0,1786 # ffffffffc02b29e0 <current>
ffffffffc02052ee:	601c                	ld	a5,0(s0)
do_exit(int error_code) {
ffffffffc02052f0:	f406                	sd	ra,40(sp)
ffffffffc02052f2:	ec26                	sd	s1,24(sp)
ffffffffc02052f4:	e84a                	sd	s2,16(sp)
ffffffffc02052f6:	e44e                	sd	s3,8(sp)
ffffffffc02052f8:	e052                	sd	s4,0(sp)
    if (current == idleproc) {
ffffffffc02052fa:	000ad717          	auipc	a4,0xad
ffffffffc02052fe:	6ee73703          	ld	a4,1774(a4) # ffffffffc02b29e8 <idleproc>
ffffffffc0205302:	0ce78c63          	beq	a5,a4,ffffffffc02053da <do_exit+0xf8>
    if (current == initproc) {
ffffffffc0205306:	000ad497          	auipc	s1,0xad
ffffffffc020530a:	6ea48493          	addi	s1,s1,1770 # ffffffffc02b29f0 <initproc>
ffffffffc020530e:	6098                	ld	a4,0(s1)
ffffffffc0205310:	0ee78b63          	beq	a5,a4,ffffffffc0205406 <do_exit+0x124>
    struct mm_struct *mm = current->mm;
ffffffffc0205314:	0287b983          	ld	s3,40(a5)
ffffffffc0205318:	892a                	mv	s2,a0
    if (mm != NULL) {
ffffffffc020531a:	02098663          	beqz	s3,ffffffffc0205346 <do_exit+0x64>
ffffffffc020531e:	000ad797          	auipc	a5,0xad
ffffffffc0205322:	66a7b783          	ld	a5,1642(a5) # ffffffffc02b2988 <boot_cr3>
ffffffffc0205326:	577d                	li	a4,-1
ffffffffc0205328:	177e                	slli	a4,a4,0x3f
ffffffffc020532a:	83b1                	srli	a5,a5,0xc
ffffffffc020532c:	8fd9                	or	a5,a5,a4
ffffffffc020532e:	18079073          	csrw	satp,a5
    mm->mm_count -= 1;
ffffffffc0205332:	0309a783          	lw	a5,48(s3)
ffffffffc0205336:	fff7871b          	addiw	a4,a5,-1
ffffffffc020533a:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0) {
ffffffffc020533e:	cb55                	beqz	a4,ffffffffc02053f2 <do_exit+0x110>
        current->mm = NULL;
ffffffffc0205340:	601c                	ld	a5,0(s0)
ffffffffc0205342:	0207b423          	sd	zero,40(a5)
    current->state = PROC_ZOMBIE;
ffffffffc0205346:	601c                	ld	a5,0(s0)
ffffffffc0205348:	470d                	li	a4,3
ffffffffc020534a:	c398                	sw	a4,0(a5)
    current->exit_code = error_code;
ffffffffc020534c:	0f27a423          	sw	s2,232(a5)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205350:	100027f3          	csrr	a5,sstatus
ffffffffc0205354:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205356:	4a01                	li	s4,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205358:	e3f9                	bnez	a5,ffffffffc020541e <do_exit+0x13c>
        proc = current->parent;
ffffffffc020535a:	6018                	ld	a4,0(s0)
        if (proc->wait_state == WT_CHILD) {
ffffffffc020535c:	800007b7          	lui	a5,0x80000
ffffffffc0205360:	0785                	addi	a5,a5,1
        proc = current->parent;
ffffffffc0205362:	7308                	ld	a0,32(a4)
        if (proc->wait_state == WT_CHILD) {
ffffffffc0205364:	0ec52703          	lw	a4,236(a0)
ffffffffc0205368:	0af70f63          	beq	a4,a5,ffffffffc0205426 <do_exit+0x144>
        while (current->cptr != NULL) {
ffffffffc020536c:	6018                	ld	a4,0(s0)
ffffffffc020536e:	7b7c                	ld	a5,240(a4)
ffffffffc0205370:	c3a1                	beqz	a5,ffffffffc02053b0 <do_exit+0xce>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc0205372:	800009b7          	lui	s3,0x80000
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205376:	490d                	li	s2,3
                if (initproc->wait_state == WT_CHILD) {
ffffffffc0205378:	0985                	addi	s3,s3,1
ffffffffc020537a:	a021                	j	ffffffffc0205382 <do_exit+0xa0>
        while (current->cptr != NULL) {
ffffffffc020537c:	6018                	ld	a4,0(s0)
ffffffffc020537e:	7b7c                	ld	a5,240(a4)
ffffffffc0205380:	cb85                	beqz	a5,ffffffffc02053b0 <do_exit+0xce>
            current->cptr = proc->optr;
ffffffffc0205382:	1007b683          	ld	a3,256(a5) # ffffffff80000100 <_binary_obj___user_exit_out_size+0xffffffff7fff4fc0>
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc0205386:	6088                	ld	a0,0(s1)
            current->cptr = proc->optr;
ffffffffc0205388:	fb74                	sd	a3,240(a4)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc020538a:	7978                	ld	a4,240(a0)
            proc->yptr = NULL;
ffffffffc020538c:	0e07bc23          	sd	zero,248(a5)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc0205390:	10e7b023          	sd	a4,256(a5)
ffffffffc0205394:	c311                	beqz	a4,ffffffffc0205398 <do_exit+0xb6>
                initproc->cptr->yptr = proc;
ffffffffc0205396:	ff7c                	sd	a5,248(a4)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205398:	4398                	lw	a4,0(a5)
            proc->parent = initproc;
ffffffffc020539a:	f388                	sd	a0,32(a5)
            initproc->cptr = proc;
ffffffffc020539c:	f97c                	sd	a5,240(a0)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc020539e:	fd271fe3          	bne	a4,s2,ffffffffc020537c <do_exit+0x9a>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc02053a2:	0ec52783          	lw	a5,236(a0)
ffffffffc02053a6:	fd379be3          	bne	a5,s3,ffffffffc020537c <do_exit+0x9a>
                    wakeup_proc(initproc);
ffffffffc02053aa:	36f000ef          	jal	ra,ffffffffc0205f18 <wakeup_proc>
ffffffffc02053ae:	b7f9                	j	ffffffffc020537c <do_exit+0x9a>
    if (flag) {
ffffffffc02053b0:	020a1263          	bnez	s4,ffffffffc02053d4 <do_exit+0xf2>
    schedule();
ffffffffc02053b4:	3e5000ef          	jal	ra,ffffffffc0205f98 <schedule>
    panic("do_exit will not return!! %d.\n", current->pid);
ffffffffc02053b8:	601c                	ld	a5,0(s0)
ffffffffc02053ba:	00003617          	auipc	a2,0x3
ffffffffc02053be:	07660613          	addi	a2,a2,118 # ffffffffc0208430 <default_pmm_manager+0x1130>
ffffffffc02053c2:	21700593          	li	a1,535
ffffffffc02053c6:	43d4                	lw	a3,4(a5)
ffffffffc02053c8:	00003517          	auipc	a0,0x3
ffffffffc02053cc:	00850513          	addi	a0,a0,8 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc02053d0:	8aafb0ef          	jal	ra,ffffffffc020047a <__panic>
        intr_enable();
ffffffffc02053d4:	a6cfb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc02053d8:	bff1                	j	ffffffffc02053b4 <do_exit+0xd2>
        panic("idleproc exit.\n");
ffffffffc02053da:	00003617          	auipc	a2,0x3
ffffffffc02053de:	03660613          	addi	a2,a2,54 # ffffffffc0208410 <default_pmm_manager+0x1110>
ffffffffc02053e2:	1eb00593          	li	a1,491
ffffffffc02053e6:	00003517          	auipc	a0,0x3
ffffffffc02053ea:	fea50513          	addi	a0,a0,-22 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc02053ee:	88cfb0ef          	jal	ra,ffffffffc020047a <__panic>
            exit_mmap(mm);
ffffffffc02053f2:	854e                	mv	a0,s3
ffffffffc02053f4:	85eff0ef          	jal	ra,ffffffffc0204452 <exit_mmap>
            put_pgdir(mm);
ffffffffc02053f8:	854e                	mv	a0,s3
ffffffffc02053fa:	9ddff0ef          	jal	ra,ffffffffc0204dd6 <put_pgdir>
            mm_destroy(mm);
ffffffffc02053fe:	854e                	mv	a0,s3
ffffffffc0205400:	eb7fe0ef          	jal	ra,ffffffffc02042b6 <mm_destroy>
ffffffffc0205404:	bf35                	j	ffffffffc0205340 <do_exit+0x5e>
        panic("initproc exit.\n");
ffffffffc0205406:	00003617          	auipc	a2,0x3
ffffffffc020540a:	01a60613          	addi	a2,a2,26 # ffffffffc0208420 <default_pmm_manager+0x1120>
ffffffffc020540e:	1ee00593          	li	a1,494
ffffffffc0205412:	00003517          	auipc	a0,0x3
ffffffffc0205416:	fbe50513          	addi	a0,a0,-66 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc020541a:	860fb0ef          	jal	ra,ffffffffc020047a <__panic>
        intr_disable();
ffffffffc020541e:	a28fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0205422:	4a05                	li	s4,1
ffffffffc0205424:	bf1d                	j	ffffffffc020535a <do_exit+0x78>
            wakeup_proc(proc);
ffffffffc0205426:	2f3000ef          	jal	ra,ffffffffc0205f18 <wakeup_proc>
ffffffffc020542a:	b789                	j	ffffffffc020536c <do_exit+0x8a>

ffffffffc020542c <do_wait.part.0>:
do_wait(int pid, int *code_store) {
ffffffffc020542c:	715d                	addi	sp,sp,-80
ffffffffc020542e:	f84a                	sd	s2,48(sp)
ffffffffc0205430:	f44e                	sd	s3,40(sp)
        current->wait_state = WT_CHILD;
ffffffffc0205432:	80000937          	lui	s2,0x80000
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205436:	6989                	lui	s3,0x2
do_wait(int pid, int *code_store) {
ffffffffc0205438:	fc26                	sd	s1,56(sp)
ffffffffc020543a:	f052                	sd	s4,32(sp)
ffffffffc020543c:	ec56                	sd	s5,24(sp)
ffffffffc020543e:	e85a                	sd	s6,16(sp)
ffffffffc0205440:	e45e                	sd	s7,8(sp)
ffffffffc0205442:	e486                	sd	ra,72(sp)
ffffffffc0205444:	e0a2                	sd	s0,64(sp)
ffffffffc0205446:	84aa                	mv	s1,a0
ffffffffc0205448:	8a2e                	mv	s4,a1
        proc = current->cptr;
ffffffffc020544a:	000adb97          	auipc	s7,0xad
ffffffffc020544e:	596b8b93          	addi	s7,s7,1430 # ffffffffc02b29e0 <current>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205452:	00050b1b          	sext.w	s6,a0
ffffffffc0205456:	fff50a9b          	addiw	s5,a0,-1
ffffffffc020545a:	19f9                	addi	s3,s3,-2
        current->wait_state = WT_CHILD;
ffffffffc020545c:	0905                	addi	s2,s2,1
    if (pid != 0) {
ffffffffc020545e:	ccbd                	beqz	s1,ffffffffc02054dc <do_wait.part.0+0xb0>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205460:	0359e863          	bltu	s3,s5,ffffffffc0205490 <do_wait.part.0+0x64>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205464:	45a9                	li	a1,10
ffffffffc0205466:	855a                	mv	a0,s6
ffffffffc0205468:	49d000ef          	jal	ra,ffffffffc0206104 <hash32>
ffffffffc020546c:	02051793          	slli	a5,a0,0x20
ffffffffc0205470:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0205474:	000a9797          	auipc	a5,0xa9
ffffffffc0205478:	4e478793          	addi	a5,a5,1252 # ffffffffc02ae958 <hash_list>
ffffffffc020547c:	953e                	add	a0,a0,a5
ffffffffc020547e:	842a                	mv	s0,a0
        while ((le = list_next(le)) != list) {
ffffffffc0205480:	a029                	j	ffffffffc020548a <do_wait.part.0+0x5e>
            if (proc->pid == pid) {
ffffffffc0205482:	f2c42783          	lw	a5,-212(s0)
ffffffffc0205486:	02978163          	beq	a5,s1,ffffffffc02054a8 <do_wait.part.0+0x7c>
ffffffffc020548a:	6400                	ld	s0,8(s0)
        while ((le = list_next(le)) != list) {
ffffffffc020548c:	fe851be3          	bne	a0,s0,ffffffffc0205482 <do_wait.part.0+0x56>
    return -E_BAD_PROC;
ffffffffc0205490:	5579                	li	a0,-2
}
ffffffffc0205492:	60a6                	ld	ra,72(sp)
ffffffffc0205494:	6406                	ld	s0,64(sp)
ffffffffc0205496:	74e2                	ld	s1,56(sp)
ffffffffc0205498:	7942                	ld	s2,48(sp)
ffffffffc020549a:	79a2                	ld	s3,40(sp)
ffffffffc020549c:	7a02                	ld	s4,32(sp)
ffffffffc020549e:	6ae2                	ld	s5,24(sp)
ffffffffc02054a0:	6b42                	ld	s6,16(sp)
ffffffffc02054a2:	6ba2                	ld	s7,8(sp)
ffffffffc02054a4:	6161                	addi	sp,sp,80
ffffffffc02054a6:	8082                	ret
        if (proc != NULL && proc->parent == current) {
ffffffffc02054a8:	000bb683          	ld	a3,0(s7)
ffffffffc02054ac:	f4843783          	ld	a5,-184(s0)
ffffffffc02054b0:	fed790e3          	bne	a5,a3,ffffffffc0205490 <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02054b4:	f2842703          	lw	a4,-216(s0)
ffffffffc02054b8:	478d                	li	a5,3
ffffffffc02054ba:	0ef70b63          	beq	a4,a5,ffffffffc02055b0 <do_wait.part.0+0x184>
        current->state = PROC_SLEEPING;
ffffffffc02054be:	4785                	li	a5,1
ffffffffc02054c0:	c29c                	sw	a5,0(a3)
        current->wait_state = WT_CHILD;
ffffffffc02054c2:	0f26a623          	sw	s2,236(a3)
        schedule();
ffffffffc02054c6:	2d3000ef          	jal	ra,ffffffffc0205f98 <schedule>
        if (current->flags & PF_EXITING) {
ffffffffc02054ca:	000bb783          	ld	a5,0(s7)
ffffffffc02054ce:	0b07a783          	lw	a5,176(a5)
ffffffffc02054d2:	8b85                	andi	a5,a5,1
ffffffffc02054d4:	d7c9                	beqz	a5,ffffffffc020545e <do_wait.part.0+0x32>
            do_exit(-E_KILLED);
ffffffffc02054d6:	555d                	li	a0,-9
ffffffffc02054d8:	e0bff0ef          	jal	ra,ffffffffc02052e2 <do_exit>
        proc = current->cptr;
ffffffffc02054dc:	000bb683          	ld	a3,0(s7)
ffffffffc02054e0:	7ae0                	ld	s0,240(a3)
        for (; proc != NULL; proc = proc->optr) {
ffffffffc02054e2:	d45d                	beqz	s0,ffffffffc0205490 <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02054e4:	470d                	li	a4,3
ffffffffc02054e6:	a021                	j	ffffffffc02054ee <do_wait.part.0+0xc2>
        for (; proc != NULL; proc = proc->optr) {
ffffffffc02054e8:	10043403          	ld	s0,256(s0)
ffffffffc02054ec:	d869                	beqz	s0,ffffffffc02054be <do_wait.part.0+0x92>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02054ee:	401c                	lw	a5,0(s0)
ffffffffc02054f0:	fee79ce3          	bne	a5,a4,ffffffffc02054e8 <do_wait.part.0+0xbc>
    if (proc == idleproc || proc == initproc) {
ffffffffc02054f4:	000ad797          	auipc	a5,0xad
ffffffffc02054f8:	4f47b783          	ld	a5,1268(a5) # ffffffffc02b29e8 <idleproc>
ffffffffc02054fc:	0c878963          	beq	a5,s0,ffffffffc02055ce <do_wait.part.0+0x1a2>
ffffffffc0205500:	000ad797          	auipc	a5,0xad
ffffffffc0205504:	4f07b783          	ld	a5,1264(a5) # ffffffffc02b29f0 <initproc>
ffffffffc0205508:	0cf40363          	beq	s0,a5,ffffffffc02055ce <do_wait.part.0+0x1a2>
    if (code_store != NULL) {
ffffffffc020550c:	000a0663          	beqz	s4,ffffffffc0205518 <do_wait.part.0+0xec>
        *code_store = proc->exit_code;
ffffffffc0205510:	0e842783          	lw	a5,232(s0)
ffffffffc0205514:	00fa2023          	sw	a5,0(s4) # 1000 <_binary_obj___user_faultread_out_size-0x8bc8>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205518:	100027f3          	csrr	a5,sstatus
ffffffffc020551c:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020551e:	4581                	li	a1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205520:	e7c1                	bnez	a5,ffffffffc02055a8 <do_wait.part.0+0x17c>
    __list_del(listelm->prev, listelm->next);
ffffffffc0205522:	6c70                	ld	a2,216(s0)
ffffffffc0205524:	7074                	ld	a3,224(s0)
    if (proc->optr != NULL) {
ffffffffc0205526:	10043703          	ld	a4,256(s0)
        proc->optr->yptr = proc->yptr;
ffffffffc020552a:	7c7c                	ld	a5,248(s0)
    prev->next = next;
ffffffffc020552c:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc020552e:	e290                	sd	a2,0(a3)
    __list_del(listelm->prev, listelm->next);
ffffffffc0205530:	6470                	ld	a2,200(s0)
ffffffffc0205532:	6874                	ld	a3,208(s0)
    prev->next = next;
ffffffffc0205534:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc0205536:	e290                	sd	a2,0(a3)
    if (proc->optr != NULL) {
ffffffffc0205538:	c319                	beqz	a4,ffffffffc020553e <do_wait.part.0+0x112>
        proc->optr->yptr = proc->yptr;
ffffffffc020553a:	ff7c                	sd	a5,248(a4)
    if (proc->yptr != NULL) {
ffffffffc020553c:	7c7c                	ld	a5,248(s0)
ffffffffc020553e:	c3b5                	beqz	a5,ffffffffc02055a2 <do_wait.part.0+0x176>
        proc->yptr->optr = proc->optr;
ffffffffc0205540:	10e7b023          	sd	a4,256(a5)
    nr_process --;
ffffffffc0205544:	000ad717          	auipc	a4,0xad
ffffffffc0205548:	4b470713          	addi	a4,a4,1204 # ffffffffc02b29f8 <nr_process>
ffffffffc020554c:	431c                	lw	a5,0(a4)
ffffffffc020554e:	37fd                	addiw	a5,a5,-1
ffffffffc0205550:	c31c                	sw	a5,0(a4)
    if (flag) {
ffffffffc0205552:	e5a9                	bnez	a1,ffffffffc020559c <do_wait.part.0+0x170>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc0205554:	6814                	ld	a3,16(s0)
    return pa2page(PADDR(kva));
ffffffffc0205556:	c02007b7          	lui	a5,0xc0200
ffffffffc020555a:	04f6ee63          	bltu	a3,a5,ffffffffc02055b6 <do_wait.part.0+0x18a>
ffffffffc020555e:	000ad797          	auipc	a5,0xad
ffffffffc0205562:	4527b783          	ld	a5,1106(a5) # ffffffffc02b29b0 <va_pa_offset>
ffffffffc0205566:	8e9d                	sub	a3,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc0205568:	82b1                	srli	a3,a3,0xc
ffffffffc020556a:	000ad797          	auipc	a5,0xad
ffffffffc020556e:	42e7b783          	ld	a5,1070(a5) # ffffffffc02b2998 <npage>
ffffffffc0205572:	06f6fa63          	bgeu	a3,a5,ffffffffc02055e6 <do_wait.part.0+0x1ba>
    return &pages[PPN(pa) - nbase];
ffffffffc0205576:	00003517          	auipc	a0,0x3
ffffffffc020557a:	6f253503          	ld	a0,1778(a0) # ffffffffc0208c68 <nbase>
ffffffffc020557e:	8e89                	sub	a3,a3,a0
ffffffffc0205580:	069a                	slli	a3,a3,0x6
ffffffffc0205582:	000ad517          	auipc	a0,0xad
ffffffffc0205586:	41e53503          	ld	a0,1054(a0) # ffffffffc02b29a0 <pages>
ffffffffc020558a:	9536                	add	a0,a0,a3
ffffffffc020558c:	4589                	li	a1,2
ffffffffc020558e:	fe4fc0ef          	jal	ra,ffffffffc0201d72 <free_pages>
    kfree(proc);
ffffffffc0205592:	8522                	mv	a0,s0
ffffffffc0205594:	e1efc0ef          	jal	ra,ffffffffc0201bb2 <kfree>
    return 0;
ffffffffc0205598:	4501                	li	a0,0
ffffffffc020559a:	bde5                	j	ffffffffc0205492 <do_wait.part.0+0x66>
        intr_enable();
ffffffffc020559c:	8a4fb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc02055a0:	bf55                	j	ffffffffc0205554 <do_wait.part.0+0x128>
       proc->parent->cptr = proc->optr;
ffffffffc02055a2:	701c                	ld	a5,32(s0)
ffffffffc02055a4:	fbf8                	sd	a4,240(a5)
ffffffffc02055a6:	bf79                	j	ffffffffc0205544 <do_wait.part.0+0x118>
        intr_disable();
ffffffffc02055a8:	89efb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc02055ac:	4585                	li	a1,1
ffffffffc02055ae:	bf95                	j	ffffffffc0205522 <do_wait.part.0+0xf6>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02055b0:	f2840413          	addi	s0,s0,-216
ffffffffc02055b4:	b781                	j	ffffffffc02054f4 <do_wait.part.0+0xc8>
    return pa2page(PADDR(kva));
ffffffffc02055b6:	00002617          	auipc	a2,0x2
ffffffffc02055ba:	e2a60613          	addi	a2,a2,-470 # ffffffffc02073e0 <default_pmm_manager+0xe0>
ffffffffc02055be:	06e00593          	li	a1,110
ffffffffc02055c2:	00002517          	auipc	a0,0x2
ffffffffc02055c6:	d9e50513          	addi	a0,a0,-610 # ffffffffc0207360 <default_pmm_manager+0x60>
ffffffffc02055ca:	eb1fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("wait idleproc or initproc.\n");
ffffffffc02055ce:	00003617          	auipc	a2,0x3
ffffffffc02055d2:	e8260613          	addi	a2,a2,-382 # ffffffffc0208450 <default_pmm_manager+0x1150>
ffffffffc02055d6:	30e00593          	li	a1,782
ffffffffc02055da:	00003517          	auipc	a0,0x3
ffffffffc02055de:	df650513          	addi	a0,a0,-522 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc02055e2:	e99fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02055e6:	00002617          	auipc	a2,0x2
ffffffffc02055ea:	e2260613          	addi	a2,a2,-478 # ffffffffc0207408 <default_pmm_manager+0x108>
ffffffffc02055ee:	06200593          	li	a1,98
ffffffffc02055f2:	00002517          	auipc	a0,0x2
ffffffffc02055f6:	d6e50513          	addi	a0,a0,-658 # ffffffffc0207360 <default_pmm_manager+0x60>
ffffffffc02055fa:	e81fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc02055fe <init_main>:
}

// init_main - the second kernel thread used to create user_main kernel threads
static int
init_main(void *arg) {
ffffffffc02055fe:	1141                	addi	sp,sp,-16
ffffffffc0205600:	e406                	sd	ra,8(sp)
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc0205602:	fb0fc0ef          	jal	ra,ffffffffc0201db2 <nr_free_pages>
    size_t kernel_allocated_store = kallocated();
ffffffffc0205606:	cf8fc0ef          	jal	ra,ffffffffc0201afe <kallocated>

    int pid = kernel_thread(user_main, NULL, 0);
ffffffffc020560a:	4601                	li	a2,0
ffffffffc020560c:	4581                	li	a1,0
ffffffffc020560e:	fffff517          	auipc	a0,0xfffff
ffffffffc0205612:	74a50513          	addi	a0,a0,1866 # ffffffffc0204d58 <user_main>
ffffffffc0205616:	c7dff0ef          	jal	ra,ffffffffc0205292 <kernel_thread>
    if (pid <= 0) {
ffffffffc020561a:	00a04563          	bgtz	a0,ffffffffc0205624 <init_main+0x26>
ffffffffc020561e:	a071                	j	ffffffffc02056aa <init_main+0xac>
        panic("create user_main failed.\n");
    }

    while (do_wait(0, NULL) == 0) {
        schedule();
ffffffffc0205620:	179000ef          	jal	ra,ffffffffc0205f98 <schedule>
    if (code_store != NULL) {
ffffffffc0205624:	4581                	li	a1,0
ffffffffc0205626:	4501                	li	a0,0
ffffffffc0205628:	e05ff0ef          	jal	ra,ffffffffc020542c <do_wait.part.0>
    while (do_wait(0, NULL) == 0) {
ffffffffc020562c:	d975                	beqz	a0,ffffffffc0205620 <init_main+0x22>
    }

    cprintf("all user-mode processes have quit.\n");
ffffffffc020562e:	00003517          	auipc	a0,0x3
ffffffffc0205632:	e6250513          	addi	a0,a0,-414 # ffffffffc0208490 <default_pmm_manager+0x1190>
ffffffffc0205636:	b4bfa0ef          	jal	ra,ffffffffc0200180 <cprintf>
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc020563a:	000ad797          	auipc	a5,0xad
ffffffffc020563e:	3b67b783          	ld	a5,950(a5) # ffffffffc02b29f0 <initproc>
ffffffffc0205642:	7bf8                	ld	a4,240(a5)
ffffffffc0205644:	e339                	bnez	a4,ffffffffc020568a <init_main+0x8c>
ffffffffc0205646:	7ff8                	ld	a4,248(a5)
ffffffffc0205648:	e329                	bnez	a4,ffffffffc020568a <init_main+0x8c>
ffffffffc020564a:	1007b703          	ld	a4,256(a5)
ffffffffc020564e:	ef15                	bnez	a4,ffffffffc020568a <init_main+0x8c>
    assert(nr_process == 2);
ffffffffc0205650:	000ad697          	auipc	a3,0xad
ffffffffc0205654:	3a86a683          	lw	a3,936(a3) # ffffffffc02b29f8 <nr_process>
ffffffffc0205658:	4709                	li	a4,2
ffffffffc020565a:	0ae69463          	bne	a3,a4,ffffffffc0205702 <init_main+0x104>
    return listelm->next;
ffffffffc020565e:	000ad697          	auipc	a3,0xad
ffffffffc0205662:	2fa68693          	addi	a3,a3,762 # ffffffffc02b2958 <proc_list>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc0205666:	6698                	ld	a4,8(a3)
ffffffffc0205668:	0c878793          	addi	a5,a5,200
ffffffffc020566c:	06f71b63          	bne	a4,a5,ffffffffc02056e2 <init_main+0xe4>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc0205670:	629c                	ld	a5,0(a3)
ffffffffc0205672:	04f71863          	bne	a4,a5,ffffffffc02056c2 <init_main+0xc4>

    cprintf("init check memory pass.\n");
ffffffffc0205676:	00003517          	auipc	a0,0x3
ffffffffc020567a:	f0250513          	addi	a0,a0,-254 # ffffffffc0208578 <default_pmm_manager+0x1278>
ffffffffc020567e:	b03fa0ef          	jal	ra,ffffffffc0200180 <cprintf>
    return 0;
}
ffffffffc0205682:	60a2                	ld	ra,8(sp)
ffffffffc0205684:	4501                	li	a0,0
ffffffffc0205686:	0141                	addi	sp,sp,16
ffffffffc0205688:	8082                	ret
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc020568a:	00003697          	auipc	a3,0x3
ffffffffc020568e:	e2e68693          	addi	a3,a3,-466 # ffffffffc02084b8 <default_pmm_manager+0x11b8>
ffffffffc0205692:	00001617          	auipc	a2,0x1
ffffffffc0205696:	5d660613          	addi	a2,a2,1494 # ffffffffc0206c68 <commands+0x450>
ffffffffc020569a:	37300593          	li	a1,883
ffffffffc020569e:	00003517          	auipc	a0,0x3
ffffffffc02056a2:	d3250513          	addi	a0,a0,-718 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc02056a6:	dd5fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("create user_main failed.\n");
ffffffffc02056aa:	00003617          	auipc	a2,0x3
ffffffffc02056ae:	dc660613          	addi	a2,a2,-570 # ffffffffc0208470 <default_pmm_manager+0x1170>
ffffffffc02056b2:	36b00593          	li	a1,875
ffffffffc02056b6:	00003517          	auipc	a0,0x3
ffffffffc02056ba:	d1a50513          	addi	a0,a0,-742 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc02056be:	dbdfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc02056c2:	00003697          	auipc	a3,0x3
ffffffffc02056c6:	e8668693          	addi	a3,a3,-378 # ffffffffc0208548 <default_pmm_manager+0x1248>
ffffffffc02056ca:	00001617          	auipc	a2,0x1
ffffffffc02056ce:	59e60613          	addi	a2,a2,1438 # ffffffffc0206c68 <commands+0x450>
ffffffffc02056d2:	37600593          	li	a1,886
ffffffffc02056d6:	00003517          	auipc	a0,0x3
ffffffffc02056da:	cfa50513          	addi	a0,a0,-774 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc02056de:	d9dfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc02056e2:	00003697          	auipc	a3,0x3
ffffffffc02056e6:	e3668693          	addi	a3,a3,-458 # ffffffffc0208518 <default_pmm_manager+0x1218>
ffffffffc02056ea:	00001617          	auipc	a2,0x1
ffffffffc02056ee:	57e60613          	addi	a2,a2,1406 # ffffffffc0206c68 <commands+0x450>
ffffffffc02056f2:	37500593          	li	a1,885
ffffffffc02056f6:	00003517          	auipc	a0,0x3
ffffffffc02056fa:	cda50513          	addi	a0,a0,-806 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc02056fe:	d7dfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_process == 2);
ffffffffc0205702:	00003697          	auipc	a3,0x3
ffffffffc0205706:	e0668693          	addi	a3,a3,-506 # ffffffffc0208508 <default_pmm_manager+0x1208>
ffffffffc020570a:	00001617          	auipc	a2,0x1
ffffffffc020570e:	55e60613          	addi	a2,a2,1374 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205712:	37400593          	li	a1,884
ffffffffc0205716:	00003517          	auipc	a0,0x3
ffffffffc020571a:	cba50513          	addi	a0,a0,-838 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc020571e:	d5dfa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205722 <do_execve>:
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205722:	7171                	addi	sp,sp,-176
ffffffffc0205724:	e4ee                	sd	s11,72(sp)
    struct mm_struct *mm = current->mm;
ffffffffc0205726:	000add97          	auipc	s11,0xad
ffffffffc020572a:	2bad8d93          	addi	s11,s11,698 # ffffffffc02b29e0 <current>
ffffffffc020572e:	000db783          	ld	a5,0(s11)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205732:	e54e                	sd	s3,136(sp)
ffffffffc0205734:	ed26                	sd	s1,152(sp)
    struct mm_struct *mm = current->mm;
ffffffffc0205736:	0287b983          	ld	s3,40(a5)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc020573a:	e94a                	sd	s2,144(sp)
ffffffffc020573c:	f4de                	sd	s7,104(sp)
ffffffffc020573e:	892a                	mv	s2,a0
ffffffffc0205740:	8bb2                	mv	s7,a2
ffffffffc0205742:	84ae                	mv	s1,a1
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc0205744:	862e                	mv	a2,a1
ffffffffc0205746:	4681                	li	a3,0
ffffffffc0205748:	85aa                	mv	a1,a0
ffffffffc020574a:	854e                	mv	a0,s3
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc020574c:	f506                	sd	ra,168(sp)
ffffffffc020574e:	f122                	sd	s0,160(sp)
ffffffffc0205750:	e152                	sd	s4,128(sp)
ffffffffc0205752:	fcd6                	sd	s5,120(sp)
ffffffffc0205754:	f8da                	sd	s6,112(sp)
ffffffffc0205756:	f0e2                	sd	s8,96(sp)
ffffffffc0205758:	ece6                	sd	s9,88(sp)
ffffffffc020575a:	e8ea                	sd	s10,80(sp)
ffffffffc020575c:	f05e                	sd	s7,32(sp)
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc020575e:	b8aff0ef          	jal	ra,ffffffffc0204ae8 <user_mem_check>
ffffffffc0205762:	40050863          	beqz	a0,ffffffffc0205b72 <do_execve+0x450>
    memset(local_name, 0, sizeof(local_name));
ffffffffc0205766:	4641                	li	a2,16
ffffffffc0205768:	4581                	li	a1,0
ffffffffc020576a:	1808                	addi	a0,sp,48
ffffffffc020576c:	619000ef          	jal	ra,ffffffffc0206584 <memset>
    memcpy(local_name, name, len);
ffffffffc0205770:	47bd                	li	a5,15
ffffffffc0205772:	8626                	mv	a2,s1
ffffffffc0205774:	1e97e063          	bltu	a5,s1,ffffffffc0205954 <do_execve+0x232>
ffffffffc0205778:	85ca                	mv	a1,s2
ffffffffc020577a:	1808                	addi	a0,sp,48
ffffffffc020577c:	61b000ef          	jal	ra,ffffffffc0206596 <memcpy>
    if (mm != NULL) {
ffffffffc0205780:	1e098163          	beqz	s3,ffffffffc0205962 <do_execve+0x240>
        cputs("mm != NULL");
ffffffffc0205784:	00002517          	auipc	a0,0x2
ffffffffc0205788:	30450513          	addi	a0,a0,772 # ffffffffc0207a88 <default_pmm_manager+0x788>
ffffffffc020578c:	a2dfa0ef          	jal	ra,ffffffffc02001b8 <cputs>
ffffffffc0205790:	000ad797          	auipc	a5,0xad
ffffffffc0205794:	1f87b783          	ld	a5,504(a5) # ffffffffc02b2988 <boot_cr3>
ffffffffc0205798:	577d                	li	a4,-1
ffffffffc020579a:	177e                	slli	a4,a4,0x3f
ffffffffc020579c:	83b1                	srli	a5,a5,0xc
ffffffffc020579e:	8fd9                	or	a5,a5,a4
ffffffffc02057a0:	18079073          	csrw	satp,a5
ffffffffc02057a4:	0309a783          	lw	a5,48(s3) # 2030 <_binary_obj___user_faultread_out_size-0x7b98>
ffffffffc02057a8:	fff7871b          	addiw	a4,a5,-1
ffffffffc02057ac:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0) {
ffffffffc02057b0:	2c070263          	beqz	a4,ffffffffc0205a74 <do_execve+0x352>
        current->mm = NULL;
ffffffffc02057b4:	000db783          	ld	a5,0(s11)
ffffffffc02057b8:	0207b423          	sd	zero,40(a5)
    if ((mm = mm_create()) == NULL) {
ffffffffc02057bc:	975fe0ef          	jal	ra,ffffffffc0204130 <mm_create>
ffffffffc02057c0:	84aa                	mv	s1,a0
ffffffffc02057c2:	1c050b63          	beqz	a0,ffffffffc0205998 <do_execve+0x276>
    if ((page = alloc_page()) == NULL) {
ffffffffc02057c6:	4505                	li	a0,1
ffffffffc02057c8:	d18fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc02057cc:	3a050763          	beqz	a0,ffffffffc0205b7a <do_execve+0x458>
    return page - pages + nbase;
ffffffffc02057d0:	000adc97          	auipc	s9,0xad
ffffffffc02057d4:	1d0c8c93          	addi	s9,s9,464 # ffffffffc02b29a0 <pages>
ffffffffc02057d8:	000cb683          	ld	a3,0(s9)
    return KADDR(page2pa(page));
ffffffffc02057dc:	000adc17          	auipc	s8,0xad
ffffffffc02057e0:	1bcc0c13          	addi	s8,s8,444 # ffffffffc02b2998 <npage>
    return page - pages + nbase;
ffffffffc02057e4:	00003717          	auipc	a4,0x3
ffffffffc02057e8:	48473703          	ld	a4,1156(a4) # ffffffffc0208c68 <nbase>
ffffffffc02057ec:	40d506b3          	sub	a3,a0,a3
ffffffffc02057f0:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc02057f2:	5afd                	li	s5,-1
ffffffffc02057f4:	000c3783          	ld	a5,0(s8)
    return page - pages + nbase;
ffffffffc02057f8:	96ba                	add	a3,a3,a4
ffffffffc02057fa:	e83a                	sd	a4,16(sp)
    return KADDR(page2pa(page));
ffffffffc02057fc:	00cad713          	srli	a4,s5,0xc
ffffffffc0205800:	ec3a                	sd	a4,24(sp)
ffffffffc0205802:	8f75                	and	a4,a4,a3
    return page2ppn(page) << PGSHIFT;
ffffffffc0205804:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205806:	36f77e63          	bgeu	a4,a5,ffffffffc0205b82 <do_execve+0x460>
ffffffffc020580a:	000adb17          	auipc	s6,0xad
ffffffffc020580e:	1a6b0b13          	addi	s6,s6,422 # ffffffffc02b29b0 <va_pa_offset>
ffffffffc0205812:	000b3903          	ld	s2,0(s6)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc0205816:	6605                	lui	a2,0x1
ffffffffc0205818:	000ad597          	auipc	a1,0xad
ffffffffc020581c:	1785b583          	ld	a1,376(a1) # ffffffffc02b2990 <boot_pgdir>
ffffffffc0205820:	9936                	add	s2,s2,a3
ffffffffc0205822:	854a                	mv	a0,s2
ffffffffc0205824:	573000ef          	jal	ra,ffffffffc0206596 <memcpy>
    if (elf->e_magic != ELF_MAGIC) {
ffffffffc0205828:	7782                	ld	a5,32(sp)
ffffffffc020582a:	4398                	lw	a4,0(a5)
ffffffffc020582c:	464c47b7          	lui	a5,0x464c4
    mm->pgdir = pgdir;
ffffffffc0205830:	0124bc23          	sd	s2,24(s1)
    if (elf->e_magic != ELF_MAGIC) {
ffffffffc0205834:	57f78793          	addi	a5,a5,1407 # 464c457f <_binary_obj___user_exit_out_size+0x464b943f>
ffffffffc0205838:	14f71663          	bne	a4,a5,ffffffffc0205984 <do_execve+0x262>
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc020583c:	7682                	ld	a3,32(sp)
ffffffffc020583e:	0386d703          	lhu	a4,56(a3)
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc0205842:	0206b983          	ld	s3,32(a3)
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0205846:	00371793          	slli	a5,a4,0x3
ffffffffc020584a:	8f99                	sub	a5,a5,a4
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc020584c:	99b6                	add	s3,s3,a3
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc020584e:	078e                	slli	a5,a5,0x3
ffffffffc0205850:	97ce                	add	a5,a5,s3
ffffffffc0205852:	f43e                	sd	a5,40(sp)
    for (; ph < ph_end; ph ++) {
ffffffffc0205854:	00f9fc63          	bgeu	s3,a5,ffffffffc020586c <do_execve+0x14a>
        if (ph->p_type != ELF_PT_LOAD) {
ffffffffc0205858:	0009a783          	lw	a5,0(s3)
ffffffffc020585c:	4705                	li	a4,1
ffffffffc020585e:	12e78f63          	beq	a5,a4,ffffffffc020599c <do_execve+0x27a>
    for (; ph < ph_end; ph ++) {
ffffffffc0205862:	77a2                	ld	a5,40(sp)
ffffffffc0205864:	03898993          	addi	s3,s3,56
ffffffffc0205868:	fef9e8e3          	bltu	s3,a5,ffffffffc0205858 <do_execve+0x136>
    if ((ret = mm_map(mm, USTACKTOP - USTACKSIZE, USTACKSIZE, vm_flags, NULL)) != 0) {
ffffffffc020586c:	4701                	li	a4,0
ffffffffc020586e:	46ad                	li	a3,11
ffffffffc0205870:	00100637          	lui	a2,0x100
ffffffffc0205874:	7ff005b7          	lui	a1,0x7ff00
ffffffffc0205878:	8526                	mv	a0,s1
ffffffffc020587a:	a8ffe0ef          	jal	ra,ffffffffc0204308 <mm_map>
ffffffffc020587e:	892a                	mv	s2,a0
ffffffffc0205880:	1e051063          	bnez	a0,ffffffffc0205a60 <do_execve+0x33e>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205884:	6c88                	ld	a0,24(s1)
ffffffffc0205886:	467d                	li	a2,31
ffffffffc0205888:	7ffff5b7          	lui	a1,0x7ffff
ffffffffc020588c:	ac1fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205890:	38050163          	beqz	a0,ffffffffc0205c12 <do_execve+0x4f0>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205894:	6c88                	ld	a0,24(s1)
ffffffffc0205896:	467d                	li	a2,31
ffffffffc0205898:	7fffe5b7          	lui	a1,0x7fffe
ffffffffc020589c:	ab1fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc02058a0:	34050963          	beqz	a0,ffffffffc0205bf2 <do_execve+0x4d0>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc02058a4:	6c88                	ld	a0,24(s1)
ffffffffc02058a6:	467d                	li	a2,31
ffffffffc02058a8:	7fffd5b7          	lui	a1,0x7fffd
ffffffffc02058ac:	aa1fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc02058b0:	32050163          	beqz	a0,ffffffffc0205bd2 <do_execve+0x4b0>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc02058b4:	6c88                	ld	a0,24(s1)
ffffffffc02058b6:	467d                	li	a2,31
ffffffffc02058b8:	7fffc5b7          	lui	a1,0x7fffc
ffffffffc02058bc:	a91fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc02058c0:	2e050963          	beqz	a0,ffffffffc0205bb2 <do_execve+0x490>
    mm->mm_count += 1;
ffffffffc02058c4:	589c                	lw	a5,48(s1)
    current->mm = mm;
ffffffffc02058c6:	000db603          	ld	a2,0(s11)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc02058ca:	6c94                	ld	a3,24(s1)
ffffffffc02058cc:	2785                	addiw	a5,a5,1
ffffffffc02058ce:	d89c                	sw	a5,48(s1)
    current->mm = mm;
ffffffffc02058d0:	f604                	sd	s1,40(a2)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc02058d2:	c02007b7          	lui	a5,0xc0200
ffffffffc02058d6:	2cf6e263          	bltu	a3,a5,ffffffffc0205b9a <do_execve+0x478>
ffffffffc02058da:	000b3783          	ld	a5,0(s6)
ffffffffc02058de:	577d                	li	a4,-1
ffffffffc02058e0:	177e                	slli	a4,a4,0x3f
ffffffffc02058e2:	8e9d                	sub	a3,a3,a5
ffffffffc02058e4:	00c6d793          	srli	a5,a3,0xc
ffffffffc02058e8:	f654                	sd	a3,168(a2)
ffffffffc02058ea:	8fd9                	or	a5,a5,a4
ffffffffc02058ec:	18079073          	csrw	satp,a5
    struct trapframe *tf = current->tf;
ffffffffc02058f0:	7244                	ld	s1,160(a2)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc02058f2:	4581                	li	a1,0
ffffffffc02058f4:	12000613          	li	a2,288
ffffffffc02058f8:	8526                	mv	a0,s1
ffffffffc02058fa:	48b000ef          	jal	ra,ffffffffc0206584 <memset>
tf->epc = elf->e_entry; //设置用户程序的入口地址
ffffffffc02058fe:	7782                	ld	a5,32(sp)
ffffffffc0205900:	6f98                	ld	a4,24(a5)
tf->gpr.sp = USTACKTOP; // 用户栈的顶
ffffffffc0205902:	4785                	li	a5,1
ffffffffc0205904:	07fe                	slli	a5,a5,0x1f
ffffffffc0205906:	e89c                	sd	a5,16(s1)
tf->epc = elf->e_entry; //设置用户程序的入口地址
ffffffffc0205908:	10e4b423          	sd	a4,264(s1)
tf->status = (read_csr(sstatus) & ~SSTATUS_SPP & ~SSTATUS_SPIE); 
ffffffffc020590c:	100027f3          	csrr	a5,sstatus
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205910:	000db403          	ld	s0,0(s11)
tf->status = (read_csr(sstatus) & ~SSTATUS_SPP & ~SSTATUS_SPIE); 
ffffffffc0205914:	edf7f793          	andi	a5,a5,-289
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205918:	4641                	li	a2,16
ffffffffc020591a:	0b440413          	addi	s0,s0,180
ffffffffc020591e:	4581                	li	a1,0
tf->status = (read_csr(sstatus) & ~SSTATUS_SPP & ~SSTATUS_SPIE); 
ffffffffc0205920:	10f4b023          	sd	a5,256(s1)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205924:	8522                	mv	a0,s0
ffffffffc0205926:	45f000ef          	jal	ra,ffffffffc0206584 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020592a:	463d                	li	a2,15
ffffffffc020592c:	180c                	addi	a1,sp,48
ffffffffc020592e:	8522                	mv	a0,s0
ffffffffc0205930:	467000ef          	jal	ra,ffffffffc0206596 <memcpy>
}
ffffffffc0205934:	70aa                	ld	ra,168(sp)
ffffffffc0205936:	740a                	ld	s0,160(sp)
ffffffffc0205938:	64ea                	ld	s1,152(sp)
ffffffffc020593a:	69aa                	ld	s3,136(sp)
ffffffffc020593c:	6a0a                	ld	s4,128(sp)
ffffffffc020593e:	7ae6                	ld	s5,120(sp)
ffffffffc0205940:	7b46                	ld	s6,112(sp)
ffffffffc0205942:	7ba6                	ld	s7,104(sp)
ffffffffc0205944:	7c06                	ld	s8,96(sp)
ffffffffc0205946:	6ce6                	ld	s9,88(sp)
ffffffffc0205948:	6d46                	ld	s10,80(sp)
ffffffffc020594a:	6da6                	ld	s11,72(sp)
ffffffffc020594c:	854a                	mv	a0,s2
ffffffffc020594e:	694a                	ld	s2,144(sp)
ffffffffc0205950:	614d                	addi	sp,sp,176
ffffffffc0205952:	8082                	ret
    memcpy(local_name, name, len);
ffffffffc0205954:	463d                	li	a2,15
ffffffffc0205956:	85ca                	mv	a1,s2
ffffffffc0205958:	1808                	addi	a0,sp,48
ffffffffc020595a:	43d000ef          	jal	ra,ffffffffc0206596 <memcpy>
    if (mm != NULL) {
ffffffffc020595e:	e20993e3          	bnez	s3,ffffffffc0205784 <do_execve+0x62>
    if (current->mm != NULL) {
ffffffffc0205962:	000db783          	ld	a5,0(s11)
ffffffffc0205966:	779c                	ld	a5,40(a5)
ffffffffc0205968:	e4078ae3          	beqz	a5,ffffffffc02057bc <do_execve+0x9a>
        panic("load_icode: current->mm must be empty.\n");
ffffffffc020596c:	00003617          	auipc	a2,0x3
ffffffffc0205970:	c2c60613          	addi	a2,a2,-980 # ffffffffc0208598 <default_pmm_manager+0x1298>
ffffffffc0205974:	22100593          	li	a1,545
ffffffffc0205978:	00003517          	auipc	a0,0x3
ffffffffc020597c:	a5850513          	addi	a0,a0,-1448 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205980:	afbfa0ef          	jal	ra,ffffffffc020047a <__panic>
    put_pgdir(mm);
ffffffffc0205984:	8526                	mv	a0,s1
ffffffffc0205986:	c50ff0ef          	jal	ra,ffffffffc0204dd6 <put_pgdir>
    mm_destroy(mm);
ffffffffc020598a:	8526                	mv	a0,s1
ffffffffc020598c:	92bfe0ef          	jal	ra,ffffffffc02042b6 <mm_destroy>
        ret = -E_INVAL_ELF;
ffffffffc0205990:	5961                	li	s2,-8
    do_exit(ret);
ffffffffc0205992:	854a                	mv	a0,s2
ffffffffc0205994:	94fff0ef          	jal	ra,ffffffffc02052e2 <do_exit>
    int ret = -E_NO_MEM;
ffffffffc0205998:	5971                	li	s2,-4
ffffffffc020599a:	bfe5                	j	ffffffffc0205992 <do_execve+0x270>
        if (ph->p_filesz > ph->p_memsz) {
ffffffffc020599c:	0289b603          	ld	a2,40(s3)
ffffffffc02059a0:	0209b783          	ld	a5,32(s3)
ffffffffc02059a4:	1cf66d63          	bltu	a2,a5,ffffffffc0205b7e <do_execve+0x45c>
        if (ph->p_flags & ELF_PF_X) vm_flags |= VM_EXEC;
ffffffffc02059a8:	0049a783          	lw	a5,4(s3)
ffffffffc02059ac:	0017f693          	andi	a3,a5,1
ffffffffc02059b0:	c291                	beqz	a3,ffffffffc02059b4 <do_execve+0x292>
ffffffffc02059b2:	4691                	li	a3,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc02059b4:	0027f713          	andi	a4,a5,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc02059b8:	8b91                	andi	a5,a5,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc02059ba:	e779                	bnez	a4,ffffffffc0205a88 <do_execve+0x366>
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc02059bc:	4d45                	li	s10,17
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc02059be:	c781                	beqz	a5,ffffffffc02059c6 <do_execve+0x2a4>
ffffffffc02059c0:	0016e693          	ori	a3,a3,1
        if (vm_flags & VM_READ) perm |= PTE_R;
ffffffffc02059c4:	4d4d                	li	s10,19
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc02059c6:	0026f793          	andi	a5,a3,2
ffffffffc02059ca:	e3f1                	bnez	a5,ffffffffc0205a8e <do_execve+0x36c>
        if (vm_flags & VM_EXEC) perm |= PTE_X;
ffffffffc02059cc:	0046f793          	andi	a5,a3,4
ffffffffc02059d0:	c399                	beqz	a5,ffffffffc02059d6 <do_execve+0x2b4>
ffffffffc02059d2:	008d6d13          	ori	s10,s10,8
        if ((ret = mm_map(mm, ph->p_va, ph->p_memsz, vm_flags, NULL)) != 0) {
ffffffffc02059d6:	0109b583          	ld	a1,16(s3)
ffffffffc02059da:	4701                	li	a4,0
ffffffffc02059dc:	8526                	mv	a0,s1
ffffffffc02059de:	92bfe0ef          	jal	ra,ffffffffc0204308 <mm_map>
ffffffffc02059e2:	892a                	mv	s2,a0
ffffffffc02059e4:	ed35                	bnez	a0,ffffffffc0205a60 <do_execve+0x33e>
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc02059e6:	0109bb83          	ld	s7,16(s3)
ffffffffc02059ea:	77fd                	lui	a5,0xfffff
        end = ph->p_va + ph->p_filesz;
ffffffffc02059ec:	0209ba03          	ld	s4,32(s3)
        unsigned char *from = binary + ph->p_offset;
ffffffffc02059f0:	0089b903          	ld	s2,8(s3)
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc02059f4:	00fbfab3          	and	s5,s7,a5
        unsigned char *from = binary + ph->p_offset;
ffffffffc02059f8:	7782                	ld	a5,32(sp)
        end = ph->p_va + ph->p_filesz;
ffffffffc02059fa:	9a5e                	add	s4,s4,s7
        unsigned char *from = binary + ph->p_offset;
ffffffffc02059fc:	993e                	add	s2,s2,a5
        while (start < end) {
ffffffffc02059fe:	054be963          	bltu	s7,s4,ffffffffc0205a50 <do_execve+0x32e>
ffffffffc0205a02:	aa95                	j	ffffffffc0205b76 <do_execve+0x454>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205a04:	6785                	lui	a5,0x1
ffffffffc0205a06:	415b8533          	sub	a0,s7,s5
ffffffffc0205a0a:	9abe                	add	s5,s5,a5
ffffffffc0205a0c:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc0205a10:	015a7463          	bgeu	s4,s5,ffffffffc0205a18 <do_execve+0x2f6>
                size -= la - end;
ffffffffc0205a14:	417a0633          	sub	a2,s4,s7
    return page - pages + nbase;
ffffffffc0205a18:	000cb683          	ld	a3,0(s9)
ffffffffc0205a1c:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205a1e:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
...
ffffffffc0205a2c:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205a30:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205a32:	14b87863          	bgeu	a6,a1,ffffffffc0205b82 <do_execve+0x460>
ffffffffc0205a36:	000b3803          	ld	a6,0(s6)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a3a:	85ca                	mv	a1,s2
            start += size, from += size;
ffffffffc0205a3c:	9bb2                	add	s7,s7,a2
ffffffffc0205a3e:	96c2                	add	a3,a3,a6
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a40:	9536                	add	a0,a0,a3
            start += size, from += size;
ffffffffc0205a42:	e432                	sd	a2,8(sp)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a44:	353000ef          	jal	ra,ffffffffc0206596 <memcpy>
            start += size, from += size;
ffffffffc0205a48:	6622                	ld	a2,8(sp)
ffffffffc0205a4a:	9932                	add	s2,s2,a2
        while (start < end) {
ffffffffc0205a4c:	054bf363          	bgeu	s7,s4,ffffffffc0205a92 <do_execve+0x370>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205a50:	6c88                	ld	a0,24(s1)
ffffffffc0205a52:	866a                	mv	a2,s10
ffffffffc0205a54:	85d6                	mv	a1,s5
ffffffffc0205a56:	8f7fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205a5a:	842a                	mv	s0,a0
ffffffffc0205a5c:	f545                	bnez	a0,ffffffffc0205a04 <do_execve+0x2e2>
        ret = -E_NO_MEM;
ffffffffc0205a5e:	5971                	li	s2,-4
    exit_mmap(mm);
ffffffffc0205a60:	8526                	mv	a0,s1
ffffffffc0205a62:	9f1fe0ef          	jal	ra,ffffffffc0204452 <exit_mmap>
    put_pgdir(mm);
ffffffffc0205a66:	8526                	mv	a0,s1
ffffffffc0205a68:	b6eff0ef          	jal	ra,ffffffffc0204dd6 <put_pgdir>
    mm_destroy(mm);
ffffffffc0205a6c:	8526                	mv	a0,s1
ffffffffc0205a6e:	849fe0ef          	jal	ra,ffffffffc02042b6 <mm_destroy>
    return ret;
ffffffffc0205a72:	b705                	j	ffffffffc0205992 <do_execve+0x270>
            exit_mmap(mm);
ffffffffc0205a74:	854e                	mv	a0,s3
ffffffffc0205a76:	9ddfe0ef          	jal	ra,ffffffffc0204452 <exit_mmap>
            put_pgdir(mm);
ffffffffc0205a7a:	854e                	mv	a0,s3
ffffffffc0205a7c:	b5aff0ef          	jal	ra,ffffffffc0204dd6 <put_pgdir>
            mm_destroy(mm);
ffffffffc0205a80:	854e                	mv	a0,s3
ffffffffc0205a82:	835fe0ef          	jal	ra,ffffffffc02042b6 <mm_destroy>
ffffffffc0205a86:	b33d                	j	ffffffffc02057b4 <do_execve+0x92>
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205a88:	0026e693          	ori	a3,a3,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205a8c:	fb95                	bnez	a5,ffffffffc02059c0 <do_execve+0x29e>
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205a8e:	4d5d                	li	s10,23
ffffffffc0205a90:	bf35                	j	ffffffffc02059cc <do_execve+0x2aa>
        end = ph->p_va + ph->p_memsz;
ffffffffc0205a92:	0109b683          	ld	a3,16(s3)
ffffffffc0205a96:	0289b903          	ld	s2,40(s3)
ffffffffc0205a9a:	9936                	add	s2,s2,a3
        if (start < la) {
ffffffffc0205a9c:	075bfd63          	bgeu	s7,s5,ffffffffc0205b16 <do_execve+0x3f4>
            if (start == end) {
ffffffffc0205aa0:	dd7901e3          	beq	s2,s7,ffffffffc0205862 <do_execve+0x140>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205aa4:	6785                	lui	a5,0x1
ffffffffc0205aa6:	00fb8533          	add	a0,s7,a5
ffffffffc0205aaa:	41550533          	sub	a0,a0,s5
                size -= la - end;
ffffffffc0205aae:	41790a33          	sub	s4,s2,s7
            if (end < la) {
ffffffffc0205ab2:	0b597d63          	bgeu	s2,s5,ffffffffc0205b6c <do_execve+0x44a>
    return page - pages + nbase;
ffffffffc0205ab6:	000cb683          	ld	a3,0(s9)
ffffffffc0205aba:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205abc:	000c3603          	ld	a2,0(s8)
    return page - pages + nbase;
ffffffffc0205ac0:	40d406b3          	sub	a3,s0,a3
ffffffffc0205ac4:	8699                	srai	a3,a3,0x6
ffffffffc0205ac6:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205ac8:	67e2                	ld	a5,24(sp)
ffffffffc0205aca:	00f6f5b3          	and	a1,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205ace:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205ad0:	0ac5f963          	bgeu	a1,a2,ffffffffc0205b82 <do_execve+0x460>
ffffffffc0205ad4:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205ad8:	8652                	mv	a2,s4
ffffffffc0205ada:	4581                	li	a1,0
ffffffffc0205adc:	96c2                	add	a3,a3,a6
ffffffffc0205ade:	9536                	add	a0,a0,a3
ffffffffc0205ae0:	2a5000ef          	jal	ra,ffffffffc0206584 <memset>
            start += size;
ffffffffc0205ae4:	017a0733          	add	a4,s4,s7
            assert((end < la && start == end) || (end >= la && start == la));
ffffffffc0205ae8:	03597463          	bgeu	s2,s5,ffffffffc0205b10 <do_execve+0x3ee>
ffffffffc0205aec:	d6e90be3          	beq	s2,a4,ffffffffc0205862 <do_execve+0x140>
ffffffffc0205af0:	00003697          	auipc	a3,0x3
ffffffffc0205af4:	ad068693          	addi	a3,a3,-1328 # ffffffffc02085c0 <default_pmm_manager+0x12c0>
ffffffffc0205af8:	00001617          	auipc	a2,0x1
ffffffffc0205afc:	17060613          	addi	a2,a2,368 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205b00:	27600593          	li	a1,630
ffffffffc0205b04:	00003517          	auipc	a0,0x3
ffffffffc0205b08:	8cc50513          	addi	a0,a0,-1844 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205b0c:	96ffa0ef          	jal	ra,ffffffffc020047a <__panic>
ffffffffc0205b10:	ff5710e3          	bne	a4,s5,ffffffffc0205af0 <do_execve+0x3ce>
ffffffffc0205b14:	8bd6                	mv	s7,s5
        while (start < end) {
ffffffffc0205b16:	d52bf6e3          	bgeu	s7,s2,ffffffffc0205862 <do_execve+0x140>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205b1a:	6c88                	ld	a0,24(s1)
ffffffffc0205b1c:	866a                	mv	a2,s10
ffffffffc0205b1e:	85d6                	mv	a1,s5
ffffffffc0205b20:	82dfd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205b24:	842a                	mv	s0,a0
ffffffffc0205b26:	dd05                	beqz	a0,ffffffffc0205a5e <do_execve+0x33c>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205b28:	6785                	lui	a5,0x1
ffffffffc0205b2a:	415b8533          	sub	a0,s7,s5
ffffffffc0205b2e:	9abe                	add	s5,s5,a5
ffffffffc0205b30:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc0205b34:	01597463          	bgeu	s2,s5,ffffffffc0205b3c <do_execve+0x41a>
                size -= la - end;
ffffffffc0205b38:	41790633          	sub	a2,s2,s7
    return page - pages + nbase;
ffffffffc0205b3c:	000cb683          	ld	a3,0(s9)
ffffffffc0205b40:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205b42:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc0205b46:	40d406b3          	sub	a3,s0,a3
ffffffffc0205b4a:	8699                	srai	a3,a3,0x6
ffffffffc0205b4c:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205b4e:	67e2                	ld	a5,24(sp)
ffffffffc0205b50:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205b54:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205b56:	02b87663          	bgeu	a6,a1,ffffffffc0205b82 <do_execve+0x460>
ffffffffc0205b5a:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205b5e:	4581                	li	a1,0
            start += size;
ffffffffc0205b60:	9bb2                	add	s7,s7,a2
ffffffffc0205b62:	96c2                	add	a3,a3,a6
            memset(page2kva(page) + off, 0, size);
ffffffffc0205b64:	9536                	add	a0,a0,a3
ffffffffc0205b66:	21f000ef          	jal	ra,ffffffffc0206584 <memset>
ffffffffc0205b6a:	b775                	j	ffffffffc0205b16 <do_execve+0x3f4>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205b6c:	417a8a33          	sub	s4,s5,s7
ffffffffc0205b70:	b799                	j	ffffffffc0205ab6 <do_execve+0x394>
        return -E_INVAL;
ffffffffc0205b72:	5975                	li	s2,-3
ffffffffc0205b74:	b3c1                	j	ffffffffc0205934 <do_execve+0x212>
        while (start < end) {
ffffffffc0205b76:	86de                	mv	a3,s7
ffffffffc0205b78:	bf39                	j	ffffffffc0205a96 <do_execve+0x374>
    int ret = -E_NO_MEM;
ffffffffc0205b7a:	5971                	li	s2,-4
ffffffffc0205b7c:	bdc5                	j	ffffffffc0205a6c <do_execve+0x34a>
            ret = -E_INVAL_ELF;
ffffffffc0205b7e:	5961                	li	s2,-8
ffffffffc0205b80:	b5c5                	j	ffffffffc0205a60 <do_execve+0x33e>
ffffffffc0205b82:	00001617          	auipc	a2,0x1
ffffffffc0205b86:	7b660613          	addi	a2,a2,1974 # ffffffffc0207338 <default_pmm_manager+0x38>
ffffffffc0205b8a:	06900593          	li	a1,105
ffffffffc0205b8e:	00001517          	auipc	a0,0x1
ffffffffc0205b92:	7d250513          	addi	a0,a0,2002 # ffffffffc0207360 <default_pmm_manager+0x60>
ffffffffc0205b96:	8e5fa0ef          	jal	ra,ffffffffc020047a <__panic>
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205b9a:	00002617          	auipc	a2,0x2
ffffffffc0205b9e:	84660613          	addi	a2,a2,-1978 # ffffffffc02073e0 <default_pmm_manager+0xe0>
ffffffffc0205ba2:	29100593          	li	a1,657
ffffffffc0205ba6:	00003517          	auipc	a0,0x3
ffffffffc0205baa:	82a50513          	addi	a0,a0,-2006 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205bae:	8cdfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc0205bb2:	00003697          	auipc	a3,0x3
ffffffffc0205bb6:	b2668693          	addi	a3,a3,-1242 # ffffffffc02086d8 <default_pmm_manager+0x13d8>
ffffffffc0205bba:	00001617          	auipc	a2,0x1
ffffffffc0205bbe:	0ae60613          	addi	a2,a2,174 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205bc2:	28c00593          	li	a1,652
ffffffffc0205bc6:	00003517          	auipc	a0,0x3
ffffffffc0205bca:	80a50513          	addi	a0,a0,-2038 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205bce:	8adfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205bd2:	00003697          	auipc	a3,0x3
ffffffffc0205bd6:	abe68693          	addi	a3,a3,-1346 # ffffffffc0208690 <default_pmm_manager+0x1390>
ffffffffc0205bda:	00001617          	auipc	a2,0x1
ffffffffc0205bde:	08e60613          	addi	a2,a2,142 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205be2:	28b00593          	li	a1,651
ffffffffc0205be6:	00002517          	auipc	a0,0x2
ffffffffc0205bea:	7ea50513          	addi	a0,a0,2026 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205bee:	88dfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205bf2:	00003697          	auipc	a3,0x3
ffffffffc0205bf6:	a5668693          	addi	a3,a3,-1450 # ffffffffc0208648 <default_pmm_manager+0x1348>
ffffffffc0205bfa:	00001617          	auipc	a2,0x1
ffffffffc0205bfe:	06e60613          	addi	a2,a2,110 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205c02:	28a00593          	li	a1,650
ffffffffc0205c06:	00002517          	auipc	a0,0x2
ffffffffc0205c0a:	7ca50513          	addi	a0,a0,1994 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205c0e:	86dfa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205c12:	00003697          	auipc	a3,0x3
ffffffffc0205c16:	9ee68693          	addi	a3,a3,-1554 # ffffffffc0208600 <default_pmm_manager+0x1300>
ffffffffc0205c1a:	00001617          	auipc	a2,0x1
ffffffffc0205c1e:	04e60613          	addi	a2,a2,78 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205c22:	28900593          	li	a1,649
ffffffffc0205c26:	00002517          	auipc	a0,0x2
ffffffffc0205c2a:	7aa50513          	addi	a0,a0,1962 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205c2e:	84dfa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205c32 <do_yield>:
    current->need_resched = 1;
ffffffffc0205c32:	000ad797          	auipc	a5,0xad
ffffffffc0205c36:	dae7b783          	ld	a5,-594(a5) # ffffffffc02b29e0 <current>
ffffffffc0205c3a:	4705                	li	a4,1
ffffffffc0205c3c:	ef98                	sd	a4,24(a5)
}
ffffffffc0205c3e:	4501                	li	a0,0
ffffffffc0205c40:	8082                	ret

ffffffffc0205c42 <do_wait>:
do_wait(int pid, int *code_store) {
ffffffffc0205c42:	1101                	addi	sp,sp,-32
ffffffffc0205c44:	e822                	sd	s0,16(sp)
ffffffffc0205c46:	e426                	sd	s1,8(sp)
ffffffffc0205c48:	ec06                	sd	ra,24(sp)
ffffffffc0205c4a:	842e                	mv	s0,a1
ffffffffc0205c4c:	84aa                	mv	s1,a0
    if (code_store != NULL) {
ffffffffc0205c4e:	c999                	beqz	a1,ffffffffc0205c64 <do_wait+0x22>
    struct mm_struct *mm = current->mm;
ffffffffc0205c50:	000ad797          	auipc	a5,0xad
ffffffffc0205c54:	d907b783          	ld	a5,-624(a5) # ffffffffc02b29e0 <current>
        if (!user_mem_check(mm, (uintptr_t)code_store, sizeof(int), 1)) {
ffffffffc0205c58:	7788                	ld	a0,40(a5)
ffffffffc0205c5a:	4685                	li	a3,1
ffffffffc0205c5c:	4611                	li	a2,4
ffffffffc0205c5e:	e8bfe0ef          	jal	ra,ffffffffc0204ae8 <user_mem_check>
ffffffffc0205c62:	c909                	beqz	a0,ffffffffc0205c74 <do_wait+0x32>
ffffffffc0205c64:	85a2                	mv	a1,s0
}
ffffffffc0205c66:	6442                	ld	s0,16(sp)
ffffffffc0205c68:	60e2                	ld	ra,24(sp)
ffffffffc0205c6a:	8526                	mv	a0,s1
ffffffffc0205c6c:	64a2                	ld	s1,8(sp)
ffffffffc0205c6e:	6105                	addi	sp,sp,32
ffffffffc0205c70:	fbcff06f          	j	ffffffffc020542c <do_wait.part.0>
ffffffffc0205c74:	60e2                	ld	ra,24(sp)
ffffffffc0205c76:	6442                	ld	s0,16(sp)
ffffffffc0205c78:	64a2                	ld	s1,8(sp)
ffffffffc0205c7a:	5575                	li	a0,-3
ffffffffc0205c7c:	6105                	addi	sp,sp,32
ffffffffc0205c7e:	8082                	ret

ffffffffc0205c80 <do_kill>:
do_kill(int pid) {
ffffffffc0205c80:	1141                	addi	sp,sp,-16
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205c82:	6789                	lui	a5,0x2
do_kill(int pid) {
ffffffffc0205c84:	e406                	sd	ra,8(sp)
ffffffffc0205c86:	e022                	sd	s0,0(sp)
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205c88:	fff5071b          	addiw	a4,a0,-1
ffffffffc0205c8c:	17f9                	addi	a5,a5,-2
ffffffffc0205c8e:	02e7e963          	bltu	a5,a4,ffffffffc0205cc0 <do_kill+0x40>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205c92:	842a                	mv	s0,a0
ffffffffc0205c94:	45a9                	li	a1,10
ffffffffc0205c96:	2501                	sext.w	a0,a0
ffffffffc0205c98:	46c000ef          	jal	ra,ffffffffc0206104 <hash32>
ffffffffc0205c9c:	02051793          	slli	a5,a0,0x20
ffffffffc0205ca0:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0205ca4:	000a9797          	auipc	a5,0xa9
ffffffffc0205ca8:	cb478793          	addi	a5,a5,-844 # ffffffffc02ae958 <hash_list>
ffffffffc0205cac:	953e                	add	a0,a0,a5
ffffffffc0205cae:	87aa                	mv	a5,a0
        while ((le = list_next(le)) != list) {
ffffffffc0205cb0:	a029                	j	ffffffffc0205cba <do_kill+0x3a>
            if (proc->pid == pid) {
ffffffffc0205cb2:	f2c7a703          	lw	a4,-212(a5)
ffffffffc0205cb6:	00870b63          	beq	a4,s0,ffffffffc0205ccc <do_kill+0x4c>
ffffffffc0205cba:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205cbc:	fef51be3          	bne	a0,a5,ffffffffc0205cb2 <do_kill+0x32>
    return -E_INVAL;
ffffffffc0205cc0:	5475                	li	s0,-3
}
...
ffffffffc0205ccc:	fd87a703          	lw	a4,-40(a5)
ffffffffc0205cd0:	00177693          	andi	a3,a4,1
ffffffffc0205cd4:	e295                	bnez	a3,ffffffffc0205cf8 <do_kill+0x78>
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205cd6:	4bd4                	lw	a3,20(a5)
            proc->flags |= PF_EXITING;
ffffffffc0205cd8:	00176713          	ori	a4,a4,1
ffffffffc0205cdc:	fce7ac23          	sw	a4,-40(a5)
            return 0;
ffffffffc0205ce0:	4401                	li	s0,0
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205ce2:	fe06d0e3          	bgez	a3,ffffffffc0205cc2 <do_kill+0x42>
                wakeup_proc(proc);
ffffffffc0205ce6:	f2878513          	addi	a0,a5,-216
ffffffffc0205cea:	22e000ef          	jal	ra,ffffffffc0205f18 <wakeup_proc>
}
ffffffffc0205cee:	60a2                	ld	ra,8(sp)
ffffffffc0205cf0:	8522                	mv	a0,s0
ffffffffc0205cf2:	6402                	ld	s0,0(sp)
ffffffffc0205cf4:	0141                	addi	sp,sp,16
ffffffffc0205cf6:	8082                	ret
        return -E_KILLED;
ffffffffc0205cf8:	545d                	li	s0,-9
ffffffffc0205cfa:	b7e1                	j	ffffffffc0205cc2 <do_kill+0x42>

ffffffffc0205cfc <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc0205cfc:	1101                	addi	sp,sp,-32
ffffffffc0205cfe:	e426                	sd	s1,8(sp)
    elm->prev = elm->next = elm;
ffffffffc0205d00:	000ad797          	auipc	a5,0xad
ffffffffc0205d04:	c5878793          	addi	a5,a5,-936 # ffffffffc02b2958 <proc_list>
ffffffffc0205d08:	ec06                	sd	ra,24(sp)
ffffffffc0205d0a:	e822                	sd	s0,16(sp)
ffffffffc0205d0c:	e04a                	sd	s2,0(sp)
ffffffffc0205d0e:	000a9497          	auipc	s1,0xa9
ffffffffc0205d12:	c4a48493          	addi	s1,s1,-950 # ffffffffc02ae958 <hash_list>
ffffffffc0205d16:	e79c                	sd	a5,8(a5)
ffffffffc0205d18:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc0205d1a:	000ad717          	auipc	a4,0xad
ffffffffc0205d1e:	c3e70713          	addi	a4,a4,-962 # ffffffffc02b2958 <proc_list>
ffffffffc0205d22:	87a6                	mv	a5,s1
ffffffffc0205d24:	e79c                	sd	a5,8(a5)
ffffffffc0205d26:	e39c                	sd	a5,0(a5)
ffffffffc0205d28:	07c1                	addi	a5,a5,16
ffffffffc0205d2a:	fef71de3          	bne	a4,a5,ffffffffc0205d24 <proc_init+0x28>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0205d2e:	fabfe0ef          	jal	ra,ffffffffc0204cd8 <alloc_proc>
ffffffffc0205d32:	000ad917          	auipc	s2,0xad
ffffffffc0205d36:	cb690913          	addi	s2,s2,-842 # ffffffffc02b29e8 <idleproc>
ffffffffc0205d3a:	00a93023          	sd	a0,0(s2)
ffffffffc0205d3e:	0e050f63          	beqz	a0,ffffffffc0205e3c <proc_init+0x140>
        panic("cannot alloc idleproc.\n");
    }

    idleproc->pid = 0;
    idleproc->state = PROC_RUNNABLE;
ffffffffc0205d42:	4789                	li	a5,2
ffffffffc0205d44:	e11c                	sd	a5,0(a0)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205d46:	00003797          	auipc	a5,0x3
ffffffffc0205d4a:	2ba78793          	addi	a5,a5,698 # ffffffffc0209000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205d4e:	0b450413          	addi	s0,a0,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205d52:	e91c                	sd	a5,16(a0)
    idleproc->need_resched = 1;
ffffffffc0205d54:	4785                	li	a5,1
ffffffffc0205d56:	ed1c                	sd	a5,24(a0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205d58:	4641                	li	a2,16
ffffffffc0205d5a:	4581                	li	a1,0
ffffffffc0205d5c:	8522                	mv	a0,s0
ffffffffc0205d5e:	027000ef          	jal	ra,ffffffffc0206584 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205d62:	463d                	li	a2,15
ffffffffc0205d64:	00003597          	auipc	a1,0x3
ffffffffc0205d68:	9d458593          	addi	a1,a1,-1580 # ffffffffc0208738 <default_pmm_manager+0x1438>
ffffffffc0205d6c:	8522                	mv	a0,s0
ffffffffc0205d6e:	029000ef          	jal	ra,ffffffffc0206596 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc0205d72:	000ad717          	auipc	a4,0xad
ffffffffc0205d76:	c8670713          	addi	a4,a4,-890 # ffffffffc02b29f8 <nr_process>
ffffffffc0205d7a:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc0205d7c:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205d80:	4601                	li	a2,0
    nr_process ++;
ffffffffc0205d82:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205d84:	4581                	li	a1,0
ffffffffc0205d86:	00000517          	auipc	a0,0x0
ffffffffc0205d8a:	87850513          	addi	a0,a0,-1928 # ffffffffc02055fe <init_main>
    nr_process ++;
ffffffffc0205d8e:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0205d90:	000ad797          	auipc	a5,0xad
ffffffffc0205d94:	c4d7b823          	sd	a3,-944(a5) # ffffffffc02b29e0 <current>
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205d98:	cfaff0ef          	jal	ra,ffffffffc0205292 <kernel_thread>
ffffffffc0205d9c:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc0205d9e:	08a05363          	blez	a0,ffffffffc0205e24 <proc_init+0x128>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205da2:	6789                	lui	a5,0x2
ffffffffc0205da4:	fff5071b          	addiw	a4,a0,-1
ffffffffc0205da8:	17f9                	addi	a5,a5,-2
ffffffffc0205daa:	2501                	sext.w	a0,a0
ffffffffc0205dac:	02e7e363          	bltu	a5,a4,ffffffffc0205dd2 <proc_init+0xd6>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205db0:	45a9                	li	a1,10
ffffffffc0205db2:	352000ef          	jal	ra,ffffffffc0206104 <hash32>
ffffffffc0205db6:	02051793          	slli	a5,a0,0x20
ffffffffc0205dba:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0205dbe:	96a6                	add	a3,a3,s1
ffffffffc0205dc0:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc0205dc2:	a029                	j	ffffffffc0205dcc <proc_init+0xd0>
            if (proc->pid == pid) {
ffffffffc0205dc4:	f2c7a703          	lw	a4,-212(a5) # 1f2c <_binary_obj___user_faultread_out_size-0x7c9c>
ffffffffc0205dc8:	04870b63          	beq	a4,s0,ffffffffc0205e1e <proc_init+0x122>
    return listelm->next;
ffffffffc0205dcc:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205dce:	fef69be3          	bne	a3,a5,ffffffffc0205dc4 <proc_init+0xc8>
    return NULL;
ffffffffc0205dd2:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205dd4:	0b478493          	addi	s1,a5,180
ffffffffc0205dd8:	4641                	li	a2,16
ffffffffc0205dda:	4581                	li	a1,0
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0205ddc:	000ad417          	auipc	s0,0xad
ffffffffc0205de0:	c1440413          	addi	s0,s0,-1004 # ffffffffc02b29f0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205de4:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0205de6:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205de8:	79c000ef          	jal	ra,ffffffffc0206584 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205dec:	463d                	li	a2,15
ffffffffc0205dee:	00003597          	auipc	a1,0x3
ffffffffc0205df2:	97258593          	addi	a1,a1,-1678 # ffffffffc0208760 <default_pmm_manager+0x1460>
ffffffffc0205df6:	8526                	mv	a0,s1
ffffffffc0205df8:	79e000ef          	jal	ra,ffffffffc0206596 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205dfc:	00093783          	ld	a5,0(s2)
ffffffffc0205e00:	cbb5                	beqz	a5,ffffffffc0205e74 <proc_init+0x178>
ffffffffc0205e02:	43dc                	lw	a5,4(a5)
ffffffffc0205e04:	eba5                	bnez	a5,ffffffffc0205e74 <proc_init+0x178>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205e06:	601c                	ld	a5,0(s0)
ffffffffc0205e08:	c7b1                	beqz	a5,ffffffffc0205e54 <proc_init+0x158>
ffffffffc0205e0a:	43d8                	lw	a4,4(a5)
ffffffffc0205e0c:	4785                	li	a5,1
ffffffffc0205e0e:	04f71363          	bne	a4,a5,ffffffffc0205e54 <proc_init+0x158>
}
ffffffffc0205e12:	60e2                	ld	ra,24(sp)
ffffffffc0205e14:	6442                	ld	s0,16(sp)
ffffffffc0205e16:	64a2                	ld	s1,8(sp)
ffffffffc0205e18:	6902                	ld	s2,0(sp)
ffffffffc0205e1a:	6105                	addi	sp,sp,32
ffffffffc0205e1c:	8082                	ret
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0205e1e:	f2878793          	addi	a5,a5,-216
ffffffffc0205e22:	bf4d                	j	ffffffffc0205dd4 <proc_init+0xd8>
        panic("create init_main failed.\n");
ffffffffc0205e24:	00003617          	auipc	a2,0x3
ffffffffc0205e28:	91c60613          	addi	a2,a2,-1764 # ffffffffc0208740 <default_pmm_manager+0x1440>
ffffffffc0205e2c:	39600593          	li	a1,918
ffffffffc0205e30:	00002517          	auipc	a0,0x2
ffffffffc0205e34:	5a050513          	addi	a0,a0,1440 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205e38:	e42fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("cannot alloc idleproc.\n");
ffffffffc0205e3c:	00003617          	auipc	a2,0x3
ffffffffc0205e40:	8e460613          	addi	a2,a2,-1820 # ffffffffc0208720 <default_pmm_manager+0x1420>
ffffffffc0205e44:	38800593          	li	a1,904
ffffffffc0205e48:	00002517          	auipc	a0,0x2
ffffffffc0205e4c:	58850513          	addi	a0,a0,1416 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205e50:	e2afa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205e54:	00003697          	auipc	a3,0x3
ffffffffc0205e58:	93c68693          	addi	a3,a3,-1732 # ffffffffc0208790 <default_pmm_manager+0x1490>
ffffffffc0205e5c:	00001617          	auipc	a2,0x1
ffffffffc0205e60:	e0c60613          	addi	a2,a2,-500 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205e64:	39d00593          	li	a1,925
ffffffffc0205e68:	00002517          	auipc	a0,0x2
ffffffffc0205e6c:	56850513          	addi	a0,a0,1384 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205e70:	e0afa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205e74:	00003697          	auipc	a3,0x3
ffffffffc0205e78:	8f468693          	addi	a3,a3,-1804 # ffffffffc0208768 <default_pmm_manager+0x1468>
ffffffffc0205e7c:	00001617          	auipc	a2,0x1
ffffffffc0205e80:	dec60613          	addi	a2,a2,-532 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205e84:	39c00593          	li	a1,924
ffffffffc0205e88:	00002517          	auipc	a0,0x2
ffffffffc0205e8c:	54850513          	addi	a0,a0,1352 # ffffffffc02083d0 <default_pmm_manager+0x10d0>
ffffffffc0205e90:	deafa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205e94 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0205e94:	1141                	addi	sp,sp,-16
ffffffffc0205e96:	e022                	sd	s0,0(sp)
ffffffffc0205e98:	e406                	sd	ra,8(sp)
ffffffffc0205e9a:	000ad417          	auipc	s0,0xad
ffffffffc0205e9e:	b4640413          	addi	s0,s0,-1210 # ffffffffc02b29e0 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0205ea2:	6018                	ld	a4,0(s0)
ffffffffc0205ea4:	6f1c                	ld	a5,24(a4)
ffffffffc0205ea6:	dffd                	beqz	a5,ffffffffc0205ea4 <cpu_idle+0x10>
            schedule();
ffffffffc0205ea8:	0f0000ef          	jal	ra,ffffffffc0205f98 <schedule>
ffffffffc0205eac:	bfdd                	j	ffffffffc0205ea2 <cpu_idle+0xe>

ffffffffc0205eae <switch_to>:
.text
...
ffffffffc0205eae:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0205eb2:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0205eb6:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0205eb8:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0205eba:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0205ebe:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0205ec2:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0205ec6:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0205eca:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0205ece:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0205ed2:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0205ed6:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0205eda:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0205ede:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0205ee2:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0205ee6:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0205eea:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0205eec:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0205eee:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0205ef2:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0205ef6:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0205efa:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0205efe:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0205f02:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0205f06:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0205f0a:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0205f0e:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0205f12:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc0205f16:	8082                	ret

ffffffffc0205f18 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc0205f18:	4118                	lw	a4,0(a0)
wakeup_proc(struct proc_struct *proc) {
ffffffffc0205f1a:	1101                	addi	sp,sp,-32
ffffffffc0205f1c:	ec06                	sd	ra,24(sp)
ffffffffc0205f1e:	e822                	sd	s0,16(sp)
ffffffffc0205f20:	e426                	sd	s1,8(sp)
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205f22:	478d                	li	a5,3
ffffffffc0205f24:	04f70b63          	beq	a4,a5,ffffffffc0205f7a <wakeup_proc+0x62>
ffffffffc0205f28:	842a                	mv	s0,a0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205f2a:	100027f3          	csrr	a5,sstatus
ffffffffc0205f2e:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205f30:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205f32:	ef9d                	bnez	a5,ffffffffc0205f70 <wakeup_proc+0x58>
    bool intr_flag;
    local_intr_save(intr_flag);
    {
        if (proc->state != PROC_RUNNABLE) {
ffffffffc0205f34:	4789                	li	a5,2
ffffffffc0205f36:	02f70163          	beq	a4,a5,ffffffffc0205f58 <wakeup_proc+0x40>
            proc->state = PROC_RUNNABLE;
ffffffffc0205f3a:	c01c                	sw	a5,0(s0)
            proc->wait_state = 0;
ffffffffc0205f3c:	0e042623          	sw	zero,236(s0)
    if (flag) {
ffffffffc0205f40:	e491                	bnez	s1,ffffffffc0205f4c <wakeup_proc+0x34>
        else {
...
ffffffffc0205f48:	6105                	addi	sp,sp,32
ffffffffc0205f4a:	8082                	ret
ffffffffc0205f4c:	6442                	ld	s0,16(sp)
ffffffffc0205f4e:	60e2                	ld	ra,24(sp)
ffffffffc0205f50:	64a2                	ld	s1,8(sp)
ffffffffc0205f52:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc0205f54:	eecfa06f          	j	ffffffffc0200640 <intr_enable>
            warn("wakeup runnable process.\n");
ffffffffc0205f58:	00003617          	auipc	a2,0x3
ffffffffc0205f5c:	89860613          	addi	a2,a2,-1896 # ffffffffc02087f0 <default_pmm_manager+0x14f0>
ffffffffc0205f60:	45c9                	li	a1,18
ffffffffc0205f62:	00003517          	auipc	a0,0x3
ffffffffc0205f66:	87650513          	addi	a0,a0,-1930 # ffffffffc02087d8 <default_pmm_manager+0x14d8>
ffffffffc0205f6a:	d78fa0ef          	jal	ra,ffffffffc02004e2 <__warn>
ffffffffc0205f6e:	bfc9                	j	ffffffffc0205f40 <wakeup_proc+0x28>
        intr_disable();
ffffffffc0205f70:	ed6fa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        if (proc->state != PROC_RUNNABLE) {
ffffffffc0205f74:	4018                	lw	a4,0(s0)
        return 1;
ffffffffc0205f76:	4485                	li	s1,1
ffffffffc0205f78:	bf75                	j	ffffffffc0205f34 <wakeup_proc+0x1c>
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205f7a:	00003697          	auipc	a3,0x3
ffffffffc0205f7e:	83e68693          	addi	a3,a3,-1986 # ffffffffc02087b8 <default_pmm_manager+0x14b8>
ffffffffc0205f82:	00001617          	auipc	a2,0x1
ffffffffc0205f86:	ce660613          	addi	a2,a2,-794 # ffffffffc0206c68 <commands+0x450>
ffffffffc0205f8a:	45a5                	li	a1,9
ffffffffc0205f8c:	00003517          	auipc	a0,0x3
ffffffffc0205f90:	84c50513          	addi	a0,a0,-1972 # ffffffffc02087d8 <default_pmm_manager+0x14d8>
...
ffffffffc0205fa6:	efbd                	bnez	a5,ffffffffc0206024 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0205fa8:	000ad897          	auipc	a7,0xad
ffffffffc0205fac:	a388b883          	ld	a7,-1480(a7) # ffffffffc02b29e0 <current>
ffffffffc0205fb0:	0008bc23          	sd	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0205fb4:	000ad517          	auipc	a0,0xad
ffffffffc0205fb8:	a3453503          	ld	a0,-1484(a0) # ffffffffc02b29e8 <idleproc>
ffffffffc0205fbc:	04a88e63          	beq	a7,a0,ffffffffc0206018 <schedule+0x80>
ffffffffc0205fc0:	0c888693          	addi	a3,a7,200
ffffffffc0205fc4:	000ad617          	auipc	a2,0xad
ffffffffc0205fc8:	99460613          	addi	a2,a2,-1644 # ffffffffc02b2958 <proc_list>
        le = last;
ffffffffc0205fcc:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc0205fd0:	4809                	li	a6,2
ffffffffc0205fd2:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0205fd4:	00c78863          	beq	a5,a2,ffffffffc0205fe4 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0205fd8:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0205fdc:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0205fe0:	03070163          	beq	a4,a6,ffffffffc0206002 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc0205fe4:	fef697e3          	bne	a3,a5,ffffffffc0205fd2 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0205fe8:	ed89                	bnez	a1,ffffffffc0206002 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0205fea:	451c                	lw	a5,8(a0)
ffffffffc0205fec:	2785                	addiw	a5,a5,1
ffffffffc0205fee:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0205ff0:	00a88463          	beq	a7,a0,ffffffffc0205ff8 <schedule+0x60>
            proc_run(next);
ffffffffc0205ff4:	e59fe0ef          	jal	ra,ffffffffc0204e4c <proc_run>
    if (flag) {
ffffffffc0205ff8:	e819                	bnez	s0,ffffffffc020600e <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc0205ffa:	60a2                	ld	ra,8(sp)
ffffffffc0205ffc:	6402                	ld	s0,0(sp)
ffffffffc0205ffe:	0141                	addi	sp,sp,16
ffffffffc0206000:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0206002:	4198                	lw	a4,0(a1)
ffffffffc0206004:	4789                	li	a5,2
ffffffffc0206006:	fef712e3          	bne	a4,a5,ffffffffc0205fea <schedule+0x52>
ffffffffc020600a:	852e                	mv	a0,a1
ffffffffc020600c:	bff9                	j	ffffffffc0205fea <schedule+0x52>
}
ffffffffc020600e:	6402                	ld	s0,0(sp)
ffffffffc0206010:	60a2                	ld	ra,8(sp)
ffffffffc0206012:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0206014:	e2cfa06f          	j	ffffffffc0200640 <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0206018:	000ad617          	auipc	a2,0xad
ffffffffc020601c:	94060613          	addi	a2,a2,-1728 # ffffffffc02b2958 <proc_list>
ffffffffc0206020:	86b2                	mv	a3,a2
ffffffffc0206022:	b76d                	j	ffffffffc0205fcc <schedule+0x34>
        intr_disable();
ffffffffc0206024:	e22fa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0206028:	4405                	li	s0,1
ffffffffc020602a:	bfbd                	j	ffffffffc0205fa8 <schedule+0x10>

ffffffffc020602c <sys_getpid>:
    return do_kill(pid);
}
...
sys_getpid(uint64_t arg[]) {
    return current->pid;
ffffffffc020602c:	000ad797          	auipc	a5,0xad
ffffffffc0206030:	9b47b783          	ld	a5,-1612(a5) # ffffffffc02b29e0 <current>
}
ffffffffc0206034:	43c8                	lw	a0,4(a5)
ffffffffc0206036:	8082                	ret

ffffffffc0206038 <sys_pgdir>:
...
ffffffffc0206038:	4501                	li	a0,0
ffffffffc020603a:	8082                	ret

ffffffffc020603c <sys_putc>:
    cputchar(c);
ffffffffc020603c:	4108                	lw	a0,0(a0)
sys_putc(uint64_t arg[]) {
ffffffffc020603e:	1141                	addi	sp,sp,-16
ffffffffc0206040:	e406                	sd	ra,8(sp)
    cputchar(c);
ffffffffc0206042:	974fa0ef          	jal	ra,ffffffffc02001b6 <cputchar>
}
ffffffffc0206046:	60a2                	ld	ra,8(sp)
ffffffffc0206048:	4501                	li	a0,0
ffffffffc020604a:	0141                	addi	sp,sp,16
ffffffffc020604c:	8082                	ret

ffffffffc020604e <sys_kill>:
    return do_kill(pid);
ffffffffc020604e:	4108                	lw	a0,0(a0)
ffffffffc0206050:	c31ff06f          	j	ffffffffc0205c80 <do_kill>

ffffffffc0206054 <sys_yield>:
    return do_yield();
ffffffffc0206054:	bdfff06f          	j	ffffffffc0205c32 <do_yield>

ffffffffc0206058 <sys_exec>:
    return do_execve(name, len, binary, size);
ffffffffc0206058:	6d14                	ld	a3,24(a0)
ffffffffc020605a:	6910                	ld	a2,16(a0)
ffffffffc020605c:	650c                	ld	a1,8(a0)
ffffffffc020605e:	6108                	ld	a0,0(a0)
ffffffffc0206060:	ec2ff06f          	j	ffffffffc0205722 <do_execve>

ffffffffc0206064 <sys_wait>:
    return do_wait(pid, store);
ffffffffc0206064:	650c                	ld	a1,8(a0)
ffffffffc0206066:	4108                	lw	a0,0(a0)
ffffffffc0206068:	bdbff06f          	j	ffffffffc0205c42 <do_wait>

ffffffffc020606c <sys_fork>:
    struct trapframe *tf = current->tf;
ffffffffc020606c:	000ad797          	auipc	a5,0xad
ffffffffc0206070:	9747b783          	ld	a5,-1676(a5) # ffffffffc02b29e0 <current>
ffffffffc0206074:	73d0                	ld	a2,160(a5)
    return do_fork(0, stack, tf);
ffffffffc0206076:	4501                	li	a0,0
ffffffffc0206078:	6a0c                	ld	a1,16(a2)
ffffffffc020607a:	e3ffe06f          	j	ffffffffc0204eb8 <do_fork>

ffffffffc020607e <sys_exit>:
    return do_exit(error_code);
ffffffffc020607e:	4108                	lw	a0,0(a0)
ffffffffc0206080:	a62ff06f          	j	ffffffffc02052e2 <do_exit>

ffffffffc0206084 <syscall>:
};
...
void
syscall(void) {
ffffffffc0206084:	715d                	addi	sp,sp,-80
ffffffffc0206086:	fc26                	sd	s1,56(sp)
    struct trapframe *tf = current->tf;
ffffffffc0206088:	000ad497          	auipc	s1,0xad
ffffffffc020608c:	95848493          	addi	s1,s1,-1704 # ffffffffc02b29e0 <current>
ffffffffc0206090:	6098                	ld	a4,0(s1)
syscall(void) {
ffffffffc0206092:	e0a2                	sd	s0,64(sp)
ffffffffc0206094:	f84a                	sd	s2,48(sp)
    struct trapframe *tf = current->tf;
ffffffffc0206096:	7340                	ld	s0,160(a4)
syscall(void) {
ffffffffc0206098:	e486                	sd	ra,72(sp)
    uint64_t arg[5];
    int num = tf->gpr.a0;
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc020609a:	47fd                	li	a5,31
    int num = tf->gpr.a0;
ffffffffc020609c:	05042903          	lw	s2,80(s0)
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc02060a0:	0327ee63          	bltu	a5,s2,ffffffffc02060dc <syscall+0x58>
        if (syscalls[num] != NULL) {
ffffffffc02060a4:	00391713          	slli	a4,s2,0x3
ffffffffc02060a8:	00002797          	auipc	a5,0x2
ffffffffc02060ac:	7b078793          	addi	a5,a5,1968 # ffffffffc0208858 <syscalls>
ffffffffc02060b0:	97ba                	add	a5,a5,a4
ffffffffc02060b2:	639c                	ld	a5,0(a5)
ffffffffc02060b4:	c785                	beqz	a5,ffffffffc02060dc <syscall+0x58>
            arg[0] = tf->gpr.a1;
ffffffffc02060b6:	6c28                	ld	a0,88(s0)
            arg[1] = tf->gpr.a2;
ffffffffc02060b8:	702c                	ld	a1,96(s0)
            arg[2] = tf->gpr.a3;
ffffffffc02060ba:	7430                	ld	a2,104(s0)
            arg[3] = tf->gpr.a4;
ffffffffc02060bc:	7834                	ld	a3,112(s0)
            arg[4] = tf->gpr.a5;
ffffffffc02060be:	7c38                	ld	a4,120(s0)
            arg[0] = tf->gpr.a1;
ffffffffc02060c0:	e42a                	sd	a0,8(sp)
            arg[1] = tf->gpr.a2;
ffffffffc02060c2:	e82e                	sd	a1,16(sp)
            arg[2] = tf->gpr.a3;
ffffffffc02060c4:	ec32                	sd	a2,24(sp)
            arg[3] = tf->gpr.a4;
ffffffffc02060c6:	f036                	sd	a3,32(sp)
            arg[4] = tf->gpr.a5;
ffffffffc02060c8:	f43a                	sd	a4,40(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02060ca:	0028                	addi	a0,sp,8
ffffffffc02060cc:	9782                	jalr	a5
        }
    }
    print_trapframe(tf);
...
ffffffffc02060ce:	60a6                	ld	ra,72(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02060d0:	e828                	sd	a0,80(s0)
}
ffffffffc02060d2:	6406                	ld	s0,64(sp)
ffffffffc02060d4:	74e2                	ld	s1,56(sp)
ffffffffc02060d6:	7942                	ld	s2,48(sp)
ffffffffc02060d8:	6161                	addi	sp,sp,80
ffffffffc02060da:	8082                	ret
    print_trapframe(tf);
ffffffffc02060dc:	8522                	mv	a0,s0
ffffffffc02060de:	f56fa0ef          	jal	ra,ffffffffc0200834 <print_trapframe>
    panic("undefined syscall %d, pid = %d, name = %s.\n",
ffffffffc02060e2:	609c                	ld	a5,0(s1)
ffffffffc02060e4:	86ca                	mv	a3,s2
ffffffffc02060e6:	00002617          	auipc	a2,0x2
ffffffffc02060ea:	72a60613          	addi	a2,a2,1834 # ffffffffc0208810 <default_pmm_manager+0x1510>
ffffffffc02060ee:	43d8                	lw	a4,4(a5)
ffffffffc02060f0:	06200593          	li	a1,98
ffffffffc02060f4:	0b478793          	addi	a5,a5,180
ffffffffc02060f8:	00002517          	auipc	a0,0x2
ffffffffc02060fc:	74850513          	addi	a0,a0,1864 # ffffffffc0208840 <default_pmm_manager+0x1540>
ffffffffc0206100:	b7afa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0206104 <hash32>:
 *
...
ffffffffc0206104:	9e3707b7          	lui	a5,0x9e370
ffffffffc0206108:	2785                	addiw	a5,a5,1
ffffffffc020610a:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc020610e:	02000793          	li	a5,32
ffffffffc0206112:	9f8d                	subw	a5,a5,a1
}
ffffffffc0206114:	00f5553b          	srlw	a0,a0,a5
ffffffffc0206118:	8082                	ret

ffffffffc020611a <printnum>:
 * */
static void
...
ffffffffc020611a:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc020611e:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0206120:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0206124:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0206126:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc020612a:	f022                	sd	s0,32(sp)
ffffffffc020612c:	ec26                	sd	s1,24(sp)
ffffffffc020612e:	e84a                	sd	s2,16(sp)
ffffffffc0206130:	f406                	sd	ra,40(sp)
ffffffffc0206132:	e44e                	sd	s3,8(sp)
ffffffffc0206134:	84aa                	mv	s1,a0
ffffffffc0206136:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0206138:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc020613c:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc020613e:	03067e63          	bgeu	a2,a6,ffffffffc020617a <printnum+0x60>
ffffffffc0206142:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0206144:	00805763          	blez	s0,ffffffffc0206152 <printnum+0x38>
ffffffffc0206148:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc020614a:	85ca                	mv	a1,s2
ffffffffc020614c:	854e                	mv	a0,s3
ffffffffc020614e:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0206150:	fc65                	bnez	s0,ffffffffc0206148 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0206152:	1a02                	slli	s4,s4,0x20
ffffffffc0206154:	00003797          	auipc	a5,0x3
ffffffffc0206158:	80478793          	addi	a5,a5,-2044 # ffffffffc0208958 <syscalls+0x100>
ffffffffc020615c:	020a5a13          	srli	s4,s4,0x20
ffffffffc0206160:	9a3e                	add	s4,s4,a5
...
ffffffffc0206162:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0206164:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0206168:	70a2                	ld	ra,40(sp)
ffffffffc020616a:	69a2                	ld	s3,8(sp)
ffffffffc020616c:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020616e:	85ca                	mv	a1,s2
ffffffffc0206170:	87a6                	mv	a5,s1
}
ffffffffc0206172:	6942                	ld	s2,16(sp)
ffffffffc0206174:	64e2                	ld	s1,24(sp)
ffffffffc0206176:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0206178:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc020617a:	03065633          	divu	a2,a2,a6
ffffffffc020617e:	8722                	mv	a4,s0
ffffffffc0206180:	f9bff0ef          	jal	ra,ffffffffc020611a <printnum>
ffffffffc0206184:	b7f9                	j	ffffffffc0206152 <printnum+0x38>

ffffffffc0206186 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0206186:	7119                	addi	sp,sp,-128
ffffffffc0206188:	f4a6                	sd	s1,104(sp)
ffffffffc020618a:	f0ca                	sd	s2,96(sp)
ffffffffc020618c:	ecce                	sd	s3,88(sp)
ffffffffc020618e:	e8d2                	sd	s4,80(sp)
ffffffffc0206190:	e4d6                	sd	s5,72(sp)
ffffffffc0206192:	e0da                	sd	s6,64(sp)
ffffffffc0206194:	fc5e                	sd	s7,56(sp)
ffffffffc0206196:	f06a                	sd	s10,32(sp)
ffffffffc0206198:	fc86                	sd	ra,120(sp)
ffffffffc020619a:	f8a2                	sd	s0,112(sp)
ffffffffc020619c:	f862                	sd	s8,48(sp)
ffffffffc020619e:	f466                	sd	s9,40(sp)
ffffffffc02061a0:	ec6e                	sd	s11,24(sp)
ffffffffc02061a2:	892a                	mv	s2,a0
ffffffffc02061a4:	84ae                	mv	s1,a1
ffffffffc02061a6:	8d32                	mv	s10,a2
ffffffffc02061a8:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc02061aa:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc02061ae:	5b7d                	li	s6,-1
ffffffffc02061b0:	00002a97          	auipc	s5,0x2
ffffffffc02061b4:	7d4a8a93          	addi	s5,s5,2004 # ffffffffc0208984 <syscalls+0x12c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc02061b8:	00003b97          	auipc	s7,0x3
ffffffffc02061bc:	9e8b8b93          	addi	s7,s7,-1560 # ffffffffc0208ba0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02061c0:	000d4503          	lbu	a0,0(s10)
ffffffffc02061c4:	001d0413          	addi	s0,s10,1
ffffffffc02061c8:	01350a63          	beq	a0,s3,ffffffffc02061dc <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc02061cc:	c121                	beqz	a0,ffffffffc020620c <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc02061ce:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02061d0:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc02061d2:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02061d4:	fff44503          	lbu	a0,-1(s0)
ffffffffc02061d8:	ff351ae3          	bne	a0,s3,ffffffffc02061cc <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02061dc:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc02061e0:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc02061e4:	4c81                	li	s9,0
ffffffffc02061e6:	4881                	li	a7,0
        width = precision = -1;
ffffffffc02061e8:	5c7d                	li	s8,-1
ffffffffc02061ea:	5dfd                	li	s11,-1
ffffffffc02061ec:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc02061f0:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02061f2:	fdd6059b          	addiw	a1,a2,-35
ffffffffc02061f6:	0ff5f593          	zext.b	a1,a1
ffffffffc02061fa:	00140d13          	addi	s10,s0,1
ffffffffc02061fe:	04b56263          	bltu	a0,a1,ffffffffc0206242 <vprintfmt+0xbc>
ffffffffc0206202:	058a                	slli	a1,a1,0x2
ffffffffc0206204:	95d6                	add	a1,a1,s5
ffffffffc0206206:	4194                	lw	a3,0(a1)
ffffffffc0206208:	96d6                	add	a3,a3,s5
ffffffffc020620a:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc020620c:	70e6                	ld	ra,120(sp)
ffffffffc020620e:	7446                	ld	s0,112(sp)
ffffffffc0206210:	74a6                	ld	s1,104(sp)
ffffffffc0206212:	7906                	ld	s2,96(sp)
ffffffffc0206214:	69e6                	ld	s3,88(sp)
ffffffffc0206216:	6a46                	ld	s4,80(sp)
ffffffffc0206218:	6aa6                	ld	s5,72(sp)
ffffffffc020621a:	6b06                	ld	s6,64(sp)
ffffffffc020621c:	7be2                	ld	s7,56(sp)
ffffffffc020621e:	7c42                	ld	s8,48(sp)
ffffffffc0206220:	7ca2                	ld	s9,40(sp)
ffffffffc0206222:	7d02                	ld	s10,32(sp)
ffffffffc0206224:	6de2                	ld	s11,24(sp)
ffffffffc0206226:	6109                	addi	sp,sp,128
ffffffffc0206228:	8082                	ret
            padc = '0';
ffffffffc020622a:	87b2                	mv	a5,a2
            goto reswitch;
...
ffffffffc020623e:	fcb572e3          	bgeu	a0,a1,ffffffffc0206202 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0206242:	85a6                	mv	a1,s1
ffffffffc0206244:	02500513          	li	a0,37
ffffffffc0206248:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc020624a:	fff44783          	lbu	a5,-1(s0)
ffffffffc020624e:	8d22                	mv	s10,s0
ffffffffc0206250:	f73788e3          	beq	a5,s3,ffffffffc02061c0 <vprintfmt+0x3a>
ffffffffc0206254:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0206258:	1d7d                	addi	s10,s10,-1
ffffffffc020625a:	ff379de3          	bne	a5,s3,ffffffffc0206254 <vprintfmt+0xce>
ffffffffc020625e:	b78d                	j	ffffffffc02061c0 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0206260:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0206264:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206268:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc020626a:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc020626e:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0206272:	02d86463          	bltu	a6,a3,ffffffffc020629a <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0206276:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc020627a:	002c169b          	slliw	a3,s8,0x2
ffffffffc020627e:	0186873b          	addw	a4,a3,s8
ffffffffc0206282:	0017171b          	slliw	a4,a4,0x1
ffffffffc0206286:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0206288:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc020628c:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc020628e:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0206292:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0206296:	fed870e3          	bgeu	a6,a3,ffffffffc0206276 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc020629a:	f40ddce3          	bgez	s11,ffffffffc02061f2 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc020629e:	8de2                	mv	s11,s8
ffffffffc02062a0:	5c7d                	li	s8,-1
ffffffffc02062a2:	bf81                	j	ffffffffc02061f2 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc02062a4:	fffdc693          	not	a3,s11
ffffffffc02062a8:	96fd                	srai	a3,a3,0x3f
ffffffffc02062aa:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062ae:	00144603          	lbu	a2,1(s0)
ffffffffc02062b2:	2d81                	sext.w	s11,s11
ffffffffc02062b4:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02062b6:	bf35                	j	ffffffffc02061f2 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc02062b8:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062bc:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc02062c0:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062c2:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc02062c4:	bfd9                	j	ffffffffc020629a <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc02062c6:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02062c8:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02062cc:	01174463          	blt	a4,a7,ffffffffc02062d4 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc02062d0:	1a088e63          	beqz	a7,ffffffffc020648c <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc02062d4:	000a3603          	ld	a2,0(s4)
ffffffffc02062d8:	46c1                	li	a3,16
ffffffffc02062da:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc02062dc:	2781                	sext.w	a5,a5
ffffffffc02062de:	876e                	mv	a4,s11
ffffffffc02062e0:	85a6                	mv	a1,s1
ffffffffc02062e2:	854a                	mv	a0,s2
ffffffffc02062e4:	e37ff0ef          	jal	ra,ffffffffc020611a <printnum>
            break;
ffffffffc02062e8:	bde1                	j	ffffffffc02061c0 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc02062ea:	000a2503          	lw	a0,0(s4)
ffffffffc02062ee:	85a6                	mv	a1,s1
ffffffffc02062f0:	0a21                	addi	s4,s4,8
ffffffffc02062f2:	9902                	jalr	s2
            break;
ffffffffc02062f4:	b5f1                	j	ffffffffc02061c0 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02062f6:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02062f8:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02062fc:	01174463          	blt	a4,a7,ffffffffc0206304 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0206300:	18088163          	beqz	a7,ffffffffc0206482 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0206304:	000a3603          	ld	a2,0(s4)
ffffffffc0206308:	46a9                	li	a3,10
ffffffffc020630a:	8a2e                	mv	s4,a1
ffffffffc020630c:	bfc1                	j	ffffffffc02062dc <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020630e:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0206312:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206314:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0206316:	bdf1                	j	ffffffffc02061f2 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0206318:	85a6                	mv	a1,s1
ffffffffc020631a:	02500513          	li	a0,37
ffffffffc020631e:	9902                	jalr	s2
            break;
ffffffffc0206320:	b545                	j	ffffffffc02061c0 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206322:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0206326:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206328:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020632a:	b5e1                	j	ffffffffc02061f2 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc020632c:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020632e:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0206332:	01174463          	blt	a4,a7,ffffffffc020633a <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0206336:	14088163          	beqz	a7,ffffffffc0206478 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc020633a:	000a3603          	ld	a2,0(s4)
ffffffffc020633e:	46a1                	li	a3,8
ffffffffc0206340:	8a2e                	mv	s4,a1
ffffffffc0206342:	bf69                	j	ffffffffc02062dc <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0206344:	03000513          	li	a0,48
ffffffffc0206348:	85a6                	mv	a1,s1
ffffffffc020634a:	e03e                	sd	a5,0(sp)
ffffffffc020634c:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc020634e:	85a6                	mv	a1,s1
ffffffffc0206350:	07800513          	li	a0,120
ffffffffc0206354:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0206356:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0206358:	6782                	ld	a5,0(sp)
ffffffffc020635a:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc020635c:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0206360:	bfb5                	j	ffffffffc02062dc <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0206362:	000a3403          	ld	s0,0(s4)
ffffffffc0206366:	008a0713          	addi	a4,s4,8
ffffffffc020636a:	e03a                	sd	a4,0(sp)
ffffffffc020636c:	14040263          	beqz	s0,ffffffffc02064b0 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0206370:	0fb05763          	blez	s11,ffffffffc020645e <vprintfmt+0x2d8>
ffffffffc0206374:	02d00693          	li	a3,45
ffffffffc0206378:	0cd79163          	bne	a5,a3,ffffffffc020643a <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020637c:	00044783          	lbu	a5,0(s0)
ffffffffc0206380:	0007851b          	sext.w	a0,a5
ffffffffc0206384:	cf85                	beqz	a5,ffffffffc02063bc <vprintfmt+0x236>
ffffffffc0206386:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020638a:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020638e:	000c4563          	bltz	s8,ffffffffc0206398 <vprintfmt+0x212>
ffffffffc0206392:	3c7d                	addiw	s8,s8,-1
ffffffffc0206394:	036c0263          	beq	s8,s6,ffffffffc02063b8 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0206398:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020639a:	0e0c8e63          	beqz	s9,ffffffffc0206496 <vprintfmt+0x310>
ffffffffc020639e:	3781                	addiw	a5,a5,-32
ffffffffc02063a0:	0ef47b63          	bgeu	s0,a5,ffffffffc0206496 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc02063a4:	03f00513          	li	a0,63
ffffffffc02063a8:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02063aa:	000a4783          	lbu	a5,0(s4)
ffffffffc02063ae:	3dfd                	addiw	s11,s11,-1
ffffffffc02063b0:	0a05                	addi	s4,s4,1
ffffffffc02063b2:	0007851b          	sext.w	a0,a5
ffffffffc02063b6:	ffe1                	bnez	a5,ffffffffc020638e <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc02063b8:	01b05963          	blez	s11,ffffffffc02063ca <vprintfmt+0x244>
ffffffffc02063bc:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc02063be:	85a6                	mv	a1,s1
ffffffffc02063c0:	02000513          	li	a0,32
ffffffffc02063c4:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02063c6:	fe0d9be3          	bnez	s11,ffffffffc02063bc <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02063ca:	6a02                	ld	s4,0(sp)
ffffffffc02063cc:	bbd5                	j	ffffffffc02061c0 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02063ce:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02063d0:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc02063d4:	01174463          	blt	a4,a7,ffffffffc02063dc <vprintfmt+0x256>
    else if (lflag) {
ffffffffc02063d8:	08088d63          	beqz	a7,ffffffffc0206472 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc02063dc:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc02063e0:	0a044d63          	bltz	s0,ffffffffc020649a <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc02063e4:	8622                	mv	a2,s0
ffffffffc02063e6:	8a66                	mv	s4,s9
ffffffffc02063e8:	46a9                	li	a3,10
ffffffffc02063ea:	bdcd                	j	ffffffffc02062dc <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc02063ec:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02063f0:	4761                	li	a4,24
            err = va_arg(ap, int);
ffffffffc02063f2:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc02063f4:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc02063f8:	8fb5                	xor	a5,a5,a3
ffffffffc02063fa:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02063fe:	02d74163          	blt	a4,a3,ffffffffc0206420 <vprintfmt+0x29a>
ffffffffc0206402:	00369793          	slli	a5,a3,0x3
ffffffffc0206406:	97de                	add	a5,a5,s7
ffffffffc0206408:	639c                	ld	a5,0(a5)
ffffffffc020640a:	cb99                	beqz	a5,ffffffffc0206420 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc020640c:	86be                	mv	a3,a5
ffffffffc020640e:	00000617          	auipc	a2,0x0
ffffffffc0206412:	1ca60613          	addi	a2,a2,458 # ffffffffc02065d8 <etext+0x2a>
ffffffffc0206416:	85a6                	mv	a1,s1
ffffffffc0206418:	854a                	mv	a0,s2
ffffffffc020641a:	0ce000ef          	jal	ra,ffffffffc02064e8 <printfmt>
ffffffffc020641e:	b34d                	j	ffffffffc02061c0 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0206420:	00002617          	auipc	a2,0x2
ffffffffc0206424:	55860613          	addi	a2,a2,1368 # ffffffffc0208978 <syscalls+0x120>
ffffffffc0206428:	85a6                	mv	a1,s1
ffffffffc020642a:	854a                	mv	a0,s2
ffffffffc020642c:	0bc000ef          	jal	ra,ffffffffc02064e8 <printfmt>
ffffffffc0206430:	bb41                	j	ffffffffc02061c0 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0206432:	00002417          	auipc	s0,0x2
ffffffffc0206436:	53e40413          	addi	s0,s0,1342 # ffffffffc0208970 <syscalls+0x118>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020643a:	85e2                	mv	a1,s8
ffffffffc020643c:	8522                	mv	a0,s0
ffffffffc020643e:	e43e                	sd	a5,8(sp)
ffffffffc0206440:	0e2000ef          	jal	ra,ffffffffc0206522 <strnlen>
ffffffffc0206444:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0206448:	01b05b63          	blez	s11,ffffffffc020645e <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc020644c:	67a2                	ld	a5,8(sp)
ffffffffc020644e:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206452:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0206454:	85a6                	mv	a1,s1
ffffffffc0206456:	8552                	mv	a0,s4
ffffffffc0206458:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020645a:	fe0d9ce3          	bnez	s11,ffffffffc0206452 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020645e:	00044783          	lbu	a5,0(s0)
ffffffffc0206462:	00140a13          	addi	s4,s0,1
ffffffffc0206466:	0007851b          	sext.w	a0,a5
ffffffffc020646a:	d3a5                	beqz	a5,ffffffffc02063ca <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020646c:	05e00413          	li	s0,94
ffffffffc0206470:	bf39                	j	ffffffffc020638e <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0206472:	000a2403          	lw	s0,0(s4)
ffffffffc0206476:	b7ad                	j	ffffffffc02063e0 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0206478:	000a6603          	lwu	a2,0(s4)
ffffffffc020647c:	46a1                	li	a3,8
ffffffffc020647e:	8a2e                	mv	s4,a1
ffffffffc0206480:	bdb1                	j	ffffffffc02062dc <vprintfmt+0x156>
ffffffffc0206482:	000a6603          	lwu	a2,0(s4)
ffffffffc0206486:	46a9                	li	a3,10
ffffffffc0206488:	8a2e                	mv	s4,a1
ffffffffc020648a:	bd89                	j	ffffffffc02062dc <vprintfmt+0x156>
ffffffffc020648c:	000a6603          	lwu	a2,0(s4)
ffffffffc0206490:	46c1                	li	a3,16
ffffffffc0206492:	8a2e                	mv	s4,a1
ffffffffc0206494:	b5a1                	j	ffffffffc02062dc <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0206496:	9902                	jalr	s2
ffffffffc0206498:	bf09                	j	ffffffffc02063aa <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc020649a:	85a6                	mv	a1,s1
ffffffffc020649c:	02d00513          	li	a0,45
ffffffffc02064a0:	e03e                	sd	a5,0(sp)
ffffffffc02064a2:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02064a4:	6782                	ld	a5,0(sp)
ffffffffc02064a6:	8a66                	mv	s4,s9
ffffffffc02064a8:	40800633          	neg	a2,s0
ffffffffc02064ac:	46a9                	li	a3,10
ffffffffc02064ae:	b53d                	j	ffffffffc02062dc <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc02064b0:	03b05163          	blez	s11,ffffffffc02064d2 <vprintfmt+0x34c>
ffffffffc02064b4:	02d00693          	li	a3,45
ffffffffc02064b8:	f6d79de3          	bne	a5,a3,ffffffffc0206432 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc02064bc:	00002417          	auipc	s0,0x2
ffffffffc02064c0:	4b440413          	addi	s0,s0,1204 # ffffffffc0208970 <syscalls+0x118>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02064c4:	02800793          	li	a5,40
ffffffffc02064c8:	02800513          	li	a0,40
ffffffffc02064cc:	00140a13          	addi	s4,s0,1
ffffffffc02064d0:	bd6d                	j	ffffffffc020638a <vprintfmt+0x204>
ffffffffc02064d2:	00002a17          	auipc	s4,0x2
ffffffffc02064d6:	49fa0a13          	addi	s4,s4,1183 # ffffffffc0208971 <syscalls+0x119>
ffffffffc02064da:	02800513          	li	a0,40
ffffffffc02064de:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02064e2:	05e00413          	li	s0,94
ffffffffc02064e6:	b565                	j	ffffffffc020638e <vprintfmt+0x208>

ffffffffc02064e8 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02064e8:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc02064ea:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02064ee:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02064f0:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02064f2:	ec06                	sd	ra,24(sp)
ffffffffc02064f4:	f83a                	sd	a4,48(sp)
ffffffffc02064f6:	fc3e                	sd	a5,56(sp)
ffffffffc02064f8:	e0c2                	sd	a6,64(sp)
ffffffffc02064fa:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc02064fc:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02064fe:	c89ff0ef          	jal	ra,ffffffffc0206186 <vprintfmt>
}
ffffffffc0206502:	60e2                	ld	ra,24(sp)
ffffffffc0206504:	6161                	addi	sp,sp,80
ffffffffc0206506:	8082                	ret

ffffffffc0206508 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0206508:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc020650c:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc020650e:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0206510:	cb81                	beqz	a5,ffffffffc0206520 <strlen+0x18>
        cnt ++;
ffffffffc0206512:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0206514:	00a707b3          	add	a5,a4,a0
ffffffffc0206518:	0007c783          	lbu	a5,0(a5)
ffffffffc020651c:	fbfd                	bnez	a5,ffffffffc0206512 <strlen+0xa>
...
ffffffffc0206522:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0206524:	e589                	bnez	a1,ffffffffc020652e <strnlen+0xc>
ffffffffc0206526:	a811                	j	ffffffffc020653a <strnlen+0x18>
        cnt ++;
ffffffffc0206528:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc020652a:	00f58863          	beq	a1,a5,ffffffffc020653a <strnlen+0x18>
ffffffffc020652e:	00f50733          	add	a4,a0,a5
ffffffffc0206532:	00074703          	lbu	a4,0(a4)
ffffffffc0206536:	fb6d                	bnez	a4,ffffffffc0206528 <strnlen+0x6>
ffffffffc0206538:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc020653a:	852e                	mv	a0,a1
ffffffffc020653c:	8082                	ret

ffffffffc020653e <strcpy>:
char *
...
ffffffffc0206546:	0585                	addi	a1,a1,1
ffffffffc0206548:	fee78fa3          	sb	a4,-1(a5)
ffffffffc020654c:	fb75                	bnez	a4,ffffffffc0206540 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0206554:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0206558:	cb89                	beqz	a5,ffffffffc020656a <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc020655a:	0505                	addi	a0,a0,1
ffffffffc020655c:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020655e:	fee789e3          	beq	a5,a4,ffffffffc0206550 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0206562:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0206566:	9d19                	subw	a0,a0,a4
ffffffffc0206568:	8082                	ret
ffffffffc020656a:	4501                	li	a0,0
ffffffffc020656c:	bfed                	j	ffffffffc0206566 <strcmp+0x16>

ffffffffc020656e <strchr>:
...
ffffffffc0206572:	c799                	beqz	a5,ffffffffc0206580 <strchr+0x12>
        if (*s == c) {
ffffffffc0206574:	00f58763          	beq	a1,a5,ffffffffc0206582 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0206578:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc020657c:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc020657e:	fbfd                	bnez	a5,ffffffffc0206574 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0206584:	ca01                	beqz	a2,ffffffffc0206594 <memset+0x10>
ffffffffc0206586:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0206588:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc020658a:	0785                	addi	a5,a5,1
ffffffffc020658c:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0206590:	fec79de3          	bne	a5,a2,ffffffffc020658a <memset+0x6>
    }
    return s;
...
ffffffffc0206596 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0206596:	ca19                	beqz	a2,ffffffffc02065ac <memcpy+0x16>
ffffffffc0206598:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc020659a:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc020659c:	0005c703          	lbu	a4,0(a1)
ffffffffc02065a0:	0585                	addi	a1,a1,1
ffffffffc02065a2:	0785                	addi	a5,a5,1
ffffffffc02065a4:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02065a8:	fec59ae3          	bne	a1,a2,ffffffffc020659c <memcpy+0x6>
    }
    return dst;
