...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	362040ef          	jal	ra,ffffffffc02043ac <memset>
...
ffffffffc020006e:	60e030ef          	jal	ra,ffffffffc020367c <vmm_init>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	64d030ef          	jal	ra,ffffffffc0203efa <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	617030ef          	jal	ra,ffffffffc0203efa <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	2fc50513          	addi	a0,a0,764 # ffffffffc0204400 <etext+0x2a>
void print_kerninfo(void) {
...
ffffffffc020011e:	30650513          	addi	a0,a0,774 # ffffffffc0204420 <etext+0x4a>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	2b058593          	addi	a1,a1,688 # ffffffffc02043d6 <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	31250513          	addi	a0,a0,786 # ffffffffc0204440 <etext+0x6a>
...
ffffffffc0200146:	31e50513          	addi	a0,a0,798 # ffffffffc0204460 <etext+0x8a>
...
ffffffffc020015a:	32a50513          	addi	a0,a0,810 # ffffffffc0204480 <etext+0xaa>
...
ffffffffc0200188:	31c50513          	addi	a0,a0,796 # ffffffffc02044a0 <etext+0xca>
}
...
ffffffffc0200196:	33e60613          	addi	a2,a2,830 # ffffffffc02044d0 <etext+0xfa>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	34a50513          	addi	a0,a0,842 # ffffffffc02044e8 <etext+0x112>
void print_stackframe(void) {
...
ffffffffc02001b2:	35260613          	addi	a2,a2,850 # ffffffffc0204500 <etext+0x12a>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	36a58593          	addi	a1,a1,874 # ffffffffc0204520 <etext+0x14a>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	36a50513          	addi	a0,a0,874 # ffffffffc0204528 <etext+0x152>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	36c60613          	addi	a2,a2,876 # ffffffffc0204538 <etext+0x162>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	38c58593          	addi	a1,a1,908 # ffffffffc0204560 <etext+0x18a>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	34c50513          	addi	a0,a0,844 # ffffffffc0204528 <etext+0x152>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	38860613          	addi	a2,a2,904 # ffffffffc0204570 <etext+0x19a>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	3a058593          	addi	a1,a1,928 # ffffffffc0204590 <etext+0x1ba>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	33050513          	addi	a0,a0,816 # ffffffffc0204528 <etext+0x152>
...
ffffffffc0200236:	36e50513          	addi	a0,a0,878 # ffffffffc02045a0 <etext+0x1ca>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	37450513          	addi	a0,a0,884 # ffffffffc02045c8 <etext+0x1f2>
...
ffffffffc020027e:	37648493          	addi	s1,s1,886 # ffffffffc02045f0 <etext+0x21a>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	374b0b13          	addi	s6,s6,884 # ffffffffc02045f8 <etext+0x222>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	294a0a13          	addi	s4,s4,660 # ffffffffc0204520 <etext+0x14a>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	7e5030ef          	jal	ra,ffffffffc020427c <readline>
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	0bc040ef          	jal	ra,ffffffffc0204378 <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	0a8040ef          	jal	ra,ffffffffc0204378 <strcmp>
...
ffffffffc020030e:	088040ef          	jal	ra,ffffffffc0204396 <strchr>
...
ffffffffc020034c:	04a040ef          	jal	ra,ffffffffc0204396 <strchr>
...
ffffffffc020036a:	2b250513          	addi	a0,a0,690 # ffffffffc0204618 <etext+0x242>
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);//从ide数组中的iobase位置开始的数据复制到目的地址dst，nsecs * SECTSIZE 表示要复制的总字节数
ffffffffc02004b8:	707030ef          	jal	ra,ffffffffc02043be <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	6e3030ef          	jal	ra,ffffffffc02043be <memcpy>
    return 0;
}
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	70c0306f          	j	ffffffffc0203c54 <do_pgfault>
    panic("unhandled page fault.\n");
...
ffffffffc0201760:	44d020ef          	jal	ra,ffffffffc02043ac <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201802:	3ab020ef          	jal	ra,ffffffffc02043ac <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201f60:	406020ef          	jal	ra,ffffffffc0204366 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	40c020ef          	jal	ra,ffffffffc0204378 <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb94>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	38a020ef          	jal	ra,ffffffffc0204330 <strlen>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	3ec010ef          	jal	ra,ffffffffc0203d22 <swapfs_init>
...
ffffffffc02029ec:	2d5000ef          	jal	ra,ffffffffc02034c0 <mm_create>
...
ffffffffc0202a20:	2e9000ef          	jal	ra,ffffffffc0203508 <vma_create>
...
ffffffffc0202a2c:	34b000ef          	jal	ra,ffffffffc0203576 <insert_vma_struct>
...
ffffffffc0202c36:	211000ef          	jal	ra,ffffffffc0203646 <mm_destroy>
...
ffffffffc0203040:	5b5000ef          	jal	ra,ffffffffc0203df4 <swapfs_write>
...
ffffffffc02030de:	47d000ef          	jal	ra,ffffffffc0203d5a <swapfs_read>
...
ffffffffc020321c:	09100593          	li	a1,145
...
ffffffffc020323c:	0a800593          	li	a1,168
...
ffffffffc020327c:	0a500593          	li	a1,165
...
ffffffffc02033b0:	e406                	sd	ra,8(sp)
        assert(head != NULL);
ffffffffc02033b2:	c2d1                	beqz	a3,ffffffffc0203436 <_clock_swap_out_victim+0x8a>
    assert(in_tick==0);
ffffffffc02033b4:	e22d                	bnez	a2,ffffffffc0203416 <_clock_swap_out_victim+0x6a>
    return listelm->next;
...
ffffffffc02033e8:	fd058693          	addi	a3,a1,-48
            *ptr_page = page;
ffffffffc02033ec:	e114                	sd	a3,0(a0)
    prev->next = next;
ffffffffc02033ee:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02033f0:	e398                	sd	a4,0(a5)
            cprintf("curr_ptr %p\n",curr_ptr);
ffffffffc02033f2:	00002517          	auipc	a0,0x2
ffffffffc02033f6:	7c650513          	addi	a0,a0,1990 # ffffffffc0205bb8 <default_pmm_manager+0xaa0>
...
ffffffffc020340e:	e214                	sd	a3,0(a2)
}
...
ffffffffc020341a:	79268693          	addi	a3,a3,1938 # ffffffffc0205ba8 <default_pmm_manager+0xa90>
ffffffffc020341e:	00002617          	auipc	a2,0x2
ffffffffc0203422:	94a60613          	addi	a2,a2,-1718 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203426:	04c00593          	li	a1,76
ffffffffc020342a:	00002517          	auipc	a0,0x2
ffffffffc020342e:	70e50513          	addi	a0,a0,1806 # ffffffffc0205b38 <default_pmm_manager+0xa20>
ffffffffc0203432:	f43fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(head != NULL);
ffffffffc0203436:	00002697          	auipc	a3,0x2
ffffffffc020343a:	76268693          	addi	a3,a3,1890 # ffffffffc0205b98 <default_pmm_manager+0xa80>
ffffffffc020343e:	00002617          	auipc	a2,0x2
ffffffffc0203442:	92a60613          	addi	a2,a2,-1750 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203446:	04b00593          	li	a1,75
ffffffffc020344a:	00002517          	auipc	a0,0x2
ffffffffc020344e:	6ee50513          	addi	a0,a0,1774 # ffffffffc0205b38 <default_pmm_manager+0xa20>
...
ffffffffc020345e:	cf89                	beqz	a5,ffffffffc0203478 <_clock_map_swappable+0x22>
    list_add_before((list_entry_t*) mm->sm_priv,entry);
ffffffffc0203460:	751c                	ld	a5,40(a0)
ffffffffc0203462:	03060713          	addi	a4,a2,48
}
ffffffffc0203466:	4501                	li	a0,0
    __list_add(elm, listelm->prev, listelm);
ffffffffc0203468:	6394                	ld	a3,0(a5)
    prev->next = next->prev = elm;
ffffffffc020346a:	e398                	sd	a4,0(a5)
ffffffffc020346c:	e698                	sd	a4,8(a3)
    elm->next = next;
ffffffffc020346e:	fe1c                	sd	a5,56(a2)
    page->visited = 1;
ffffffffc0203470:	4785                	li	a5,1
    elm->prev = prev;
ffffffffc0203472:	fa14                	sd	a3,48(a2)
ffffffffc0203474:	ea1c                	sd	a5,16(a2)
}
...
ffffffffc020347e:	74e68693          	addi	a3,a3,1870 # ffffffffc0205bc8 <default_pmm_manager+0xab0>
ffffffffc0203482:	00002617          	auipc	a2,0x2
ffffffffc0203486:	8e660613          	addi	a2,a2,-1818 # ffffffffc0204d68 <commands+0x738>
ffffffffc020348a:	03800593          	li	a1,56
ffffffffc020348e:	00002517          	auipc	a0,0x2
ffffffffc0203492:	6aa50513          	addi	a0,a0,1706 # ffffffffc0205b38 <default_pmm_manager+0xa20>
{
ffffffffc0203496:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc0203498:	eddfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020349c <check_vma_overlap.part.0>:
}
...
ffffffffc02034a2:	76a68693          	addi	a3,a3,1898 # ffffffffc0205c08 <default_pmm_manager+0xaf0>
ffffffffc02034a6:	00002617          	auipc	a2,0x2
ffffffffc02034aa:	8c260613          	addi	a2,a2,-1854 # ffffffffc0204d68 <commands+0x738>
ffffffffc02034ae:	07f00593          	li	a1,127
ffffffffc02034b2:	00002517          	auipc	a0,0x2
ffffffffc02034b6:	77650513          	addi	a0,a0,1910 # ffffffffc0205c28 <default_pmm_manager+0xb10>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc02034ba:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);//next 是我们想插入的区间， 这里顺便检验了start < end
ffffffffc02034bc:	eb9fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034c0 <mm_create>:
mm_create(void) {
ffffffffc02034c0:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02034c2:	03000513          	li	a0,48
mm_create(void) {
ffffffffc02034c6:	e022                	sd	s0,0(sp)
ffffffffc02034c8:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02034ca:	aaeff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02034ce:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc02034d0:	c105                	beqz	a0,ffffffffc02034f0 <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc02034d2:	e408                	sd	a0,8(s0)
ffffffffc02034d4:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc02034d6:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02034da:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02034de:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);//页面置换的初始化
ffffffffc02034e2:	0000e797          	auipc	a5,0xe
ffffffffc02034e6:	06e7a783          	lw	a5,110(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02034ea:	eb81                	bnez	a5,ffffffffc02034fa <mm_create+0x3a>
        else mm->sm_priv = NULL;
ffffffffc02034ec:	02053423          	sd	zero,40(a0)
}
...
ffffffffc02034f8:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);//页面置换的初始化
ffffffffc02034fa:	a8bff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
}
...
ffffffffc0203508 <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc0203508:	1101                	addi	sp,sp,-32
ffffffffc020350a:	e04a                	sd	s2,0(sp)
ffffffffc020350c:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020350e:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc0203512:	e822                	sd	s0,16(sp)
ffffffffc0203514:	e426                	sd	s1,8(sp)
ffffffffc0203516:	ec06                	sd	ra,24(sp)
ffffffffc0203518:	84ae                	mv	s1,a1
ffffffffc020351a:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020351c:	a5cff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL) {
ffffffffc0203520:	c509                	beqz	a0,ffffffffc020352a <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc0203522:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203526:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203528:	ed00                	sd	s0,24(a0)
}
...
ffffffffc0203536 <find_vma>:
find_vma(struct mm_struct *mm, uintptr_t addr) {
ffffffffc0203536:	86aa                	mv	a3,a0
    if (mm != NULL) {
ffffffffc0203538:	c505                	beqz	a0,ffffffffc0203560 <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc020353a:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc020353c:	c501                	beqz	a0,ffffffffc0203544 <find_vma+0xe>
ffffffffc020353e:	651c                	ld	a5,8(a0)
ffffffffc0203540:	02f5f263          	bgeu	a1,a5,ffffffffc0203564 <find_vma+0x2e>
    return listelm->next;
ffffffffc0203544:	669c                	ld	a5,8(a3)
                while ((le = list_next(le)) != list) {
ffffffffc0203546:	00f68d63          	beq	a3,a5,ffffffffc0203560 <find_vma+0x2a>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc020354a:	fe87b703          	ld	a4,-24(a5)
ffffffffc020354e:	00e5e663          	bltu	a1,a4,ffffffffc020355a <find_vma+0x24>
ffffffffc0203552:	ff07b703          	ld	a4,-16(a5)
ffffffffc0203556:	00e5ec63          	bltu	a1,a4,ffffffffc020356e <find_vma+0x38>
ffffffffc020355a:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc020355c:	fef697e3          	bne	a3,a5,ffffffffc020354a <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc0203560:	4501                	li	a0,0
}
ffffffffc0203562:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203564:	691c                	ld	a5,16(a0)
ffffffffc0203566:	fcf5ffe3          	bgeu	a1,a5,ffffffffc0203544 <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc020356a:	ea88                	sd	a0,16(a3)
ffffffffc020356c:	8082                	ret
                    vma = le2vma(le, list_link);
ffffffffc020356e:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc0203572:	ea88                	sd	a0,16(a3)
ffffffffc0203574:	8082                	ret

ffffffffc0203576 <insert_vma_struct>:
...
ffffffffc0203576:	6590                	ld	a2,8(a1)
ffffffffc0203578:	0105b803          	ld	a6,16(a1)
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc020357c:	1141                	addi	sp,sp,-16
ffffffffc020357e:	e406                	sd	ra,8(sp)
ffffffffc0203580:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203582:	01066763          	bltu	a2,a6,ffffffffc0203590 <insert_vma_struct+0x1a>
ffffffffc0203586:	a085                	j	ffffffffc02035e6 <insert_vma_struct+0x70>
...
ffffffffc0203588:	fe87b703          	ld	a4,-24(a5)
ffffffffc020358c:	04e66863          	bltu	a2,a4,ffffffffc02035dc <insert_vma_struct+0x66>
ffffffffc0203590:	86be                	mv	a3,a5
ffffffffc0203592:	679c                	ld	a5,8(a5)
    while ((le = list_next(le)) != list) {
ffffffffc0203594:	fef51ae3          	bne	a0,a5,ffffffffc0203588 <insert_vma_struct+0x12>
    }
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc0203598:	02a68463          	beq	a3,a0,ffffffffc02035c0 <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc020359c:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc02035a0:	fe86b883          	ld	a7,-24(a3)
ffffffffc02035a4:	08e8f163          	bgeu	a7,a4,ffffffffc0203626 <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035a8:	04e66f63          	bltu	a2,a4,ffffffffc0203606 <insert_vma_struct+0x90>
    }
    if (le_next != list) {
ffffffffc02035ac:	00f50a63          	beq	a0,a5,ffffffffc02035c0 <insert_vma_struct+0x4a>
        if (mmap_prev->vm_start > vma->vm_start) {
ffffffffc02035b0:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035b4:	05076963          	bltu	a4,a6,ffffffffc0203606 <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);//next 是我们想插入的区间， 这里顺便检验了start < end
ffffffffc02035b8:	ff07b603          	ld	a2,-16(a5)
ffffffffc02035bc:	02c77363          	bgeu	a4,a2,ffffffffc02035e2 <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count ++;
ffffffffc02035c0:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc02035c2:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc02035c4:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc02035c8:	e390                	sd	a2,0(a5)
ffffffffc02035ca:	e690                	sd	a2,8(a3)
}
ffffffffc02035cc:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc02035ce:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc02035d0:	f194                	sd	a3,32(a1)
    mm->map_count ++;
ffffffffc02035d2:	0017079b          	addiw	a5,a4,1
ffffffffc02035d6:	d11c                	sw	a5,32(a0)
}
ffffffffc02035d8:	0141                	addi	sp,sp,16
ffffffffc02035da:	8082                	ret
    if (le_prev != list) {
ffffffffc02035dc:	fca690e3          	bne	a3,a0,ffffffffc020359c <insert_vma_struct+0x26>
ffffffffc02035e0:	bfd1                	j	ffffffffc02035b4 <insert_vma_struct+0x3e>
ffffffffc02035e2:	ebbff0ef          	jal	ra,ffffffffc020349c <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc02035e6:	00002697          	auipc	a3,0x2
ffffffffc02035ea:	65268693          	addi	a3,a3,1618 # ffffffffc0205c38 <default_pmm_manager+0xb20>
ffffffffc02035ee:	00001617          	auipc	a2,0x1
ffffffffc02035f2:	77a60613          	addi	a2,a2,1914 # ffffffffc0204d68 <commands+0x738>
ffffffffc02035f6:	08600593          	li	a1,134
ffffffffc02035fa:	00002517          	auipc	a0,0x2
ffffffffc02035fe:	62e50513          	addi	a0,a0,1582 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203602:	d73fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203606:	00002697          	auipc	a3,0x2
ffffffffc020360a:	67268693          	addi	a3,a3,1650 # ffffffffc0205c78 <default_pmm_manager+0xb60>
ffffffffc020360e:	00001617          	auipc	a2,0x1
ffffffffc0203612:	75a60613          	addi	a2,a2,1882 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203616:	07e00593          	li	a1,126
ffffffffc020361a:	00002517          	auipc	a0,0x2
ffffffffc020361e:	60e50513          	addi	a0,a0,1550 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203622:	d53fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203626:	00002697          	auipc	a3,0x2
ffffffffc020362a:	63268693          	addi	a3,a3,1586 # ffffffffc0205c58 <default_pmm_manager+0xb40>
ffffffffc020362e:	00001617          	auipc	a2,0x1
ffffffffc0203632:	73a60613          	addi	a2,a2,1850 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203636:	07d00593          	li	a1,125
ffffffffc020363a:	00002517          	auipc	a0,0x2
ffffffffc020363e:	5ee50513          	addi	a0,a0,1518 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203642:	d33fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203646 <mm_destroy>:

// mm_destroy - free mm and mm internal fields
void
mm_destroy(struct mm_struct *mm) {
ffffffffc0203646:	1141                	addi	sp,sp,-16
ffffffffc0203648:	e022                	sd	s0,0(sp)
ffffffffc020364a:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc020364c:	6508                	ld	a0,8(a0)
ffffffffc020364e:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc0203650:	00a40e63          	beq	s0,a0,ffffffffc020366c <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203654:	6118                	ld	a4,0(a0)
ffffffffc0203656:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203658:	03000593          	li	a1,48
ffffffffc020365c:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc020365e:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203660:	e398                	sd	a4,0(a5)
ffffffffc0203662:	9d0ff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203666:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203668:	fea416e3          	bne	s0,a0,ffffffffc0203654 <mm_destroy+0xe>
    }
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020366c:	8522                	mv	a0,s0
    mm=NULL;
}
ffffffffc020366e:	6402                	ld	s0,0(sp)
...
ffffffffc0203676:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203678:	9baff06f          	j	ffffffffc0202832 <kfree>

ffffffffc020367c <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc020367c:	715d                	addi	sp,sp,-80
ffffffffc020367e:	e486                	sd	ra,72(sp)
ffffffffc0203680:	f44e                	sd	s3,40(sp)
ffffffffc0203682:	f052                	sd	s4,32(sp)
ffffffffc0203684:	e0a2                	sd	s0,64(sp)
ffffffffc0203686:	fc26                	sd	s1,56(sp)
ffffffffc0203688:	f84a                	sd	s2,48(sp)
...
ffffffffc0203694:	89aa                	mv	s3,a0
...
ffffffffc020369a:	8a2a                	mv	s4,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc020369c:	03000513          	li	a0,48
ffffffffc02036a0:	8d8ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL) {
ffffffffc02036a4:	56050863          	beqz	a0,ffffffffc0203c14 <vmm_init+0x598>
    elm->prev = elm->next = elm;
ffffffffc02036a8:	e508                	sd	a0,8(a0)
ffffffffc02036aa:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc02036ac:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02036b0:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02036b4:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);//页面置换的初始化
ffffffffc02036b8:	0000e797          	auipc	a5,0xe
ffffffffc02036bc:	e987a783          	lw	a5,-360(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02036c0:	84aa                	mv	s1,a0
ffffffffc02036c2:	e7b9                	bnez	a5,ffffffffc0203710 <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc02036c4:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc02036c8:	03200413          	li	s0,50
ffffffffc02036cc:	a811                	j	ffffffffc02036e0 <vmm_init+0x64>
        vma->vm_start = vm_start;
ffffffffc02036ce:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc02036d0:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02036d2:	00053c23          	sd	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc02036d6:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02036d8:	8526                	mv	a0,s1
ffffffffc02036da:	e9dff0ef          	jal	ra,ffffffffc0203576 <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc02036de:	cc05                	beqz	s0,ffffffffc0203716 <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
...
ffffffffc02036ea:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc02036ee:	f165                	bnez	a0,ffffffffc02036ce <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc02036f0:	00002697          	auipc	a3,0x2
ffffffffc02036f4:	15868693          	addi	a3,a3,344 # ffffffffc0205848 <default_pmm_manager+0x730>
ffffffffc02036f8:	00001617          	auipc	a2,0x1
ffffffffc02036fc:	67060613          	addi	a2,a2,1648 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203700:	0d000593          	li	a1,208
ffffffffc0203704:	00002517          	auipc	a0,0x2
ffffffffc0203708:	52450513          	addi	a0,a0,1316 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc020370c:	c69fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);//页面置换的初始化
ffffffffc0203710:	875ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc0203714:	bf55                	j	ffffffffc02036c8 <vmm_init+0x4c>
ffffffffc0203716:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc020371a:	1f900913          	li	s2,505
ffffffffc020371e:	a819                	j	ffffffffc0203734 <vmm_init+0xb8>
        vma->vm_start = vm_start;
ffffffffc0203720:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203722:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203724:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203728:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc020372a:	8526                	mv	a0,s1
ffffffffc020372c:	e4bff0ef          	jal	ra,ffffffffc0203576 <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203730:	03240a63          	beq	s0,s2,ffffffffc0203764 <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203734:	03000513          	li	a0,48
ffffffffc0203738:	840ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc020373c:	85aa                	mv	a1,a0
ffffffffc020373e:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203742:	fd79                	bnez	a0,ffffffffc0203720 <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc0203744:	00002697          	auipc	a3,0x2
ffffffffc0203748:	10468693          	addi	a3,a3,260 # ffffffffc0205848 <default_pmm_manager+0x730>
ffffffffc020374c:	00001617          	auipc	a2,0x1
ffffffffc0203750:	61c60613          	addi	a2,a2,1564 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203754:	0d600593          	li	a1,214
ffffffffc0203758:	00002517          	auipc	a0,0x2
ffffffffc020375c:	4d050513          	addi	a0,a0,1232 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203760:	c15fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc0203764:	649c                	ld	a5,8(s1)
ffffffffc0203766:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc0203768:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc020376c:	2ef48463          	beq	s1,a5,ffffffffc0203a54 <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203770:	fe87b603          	ld	a2,-24(a5)
ffffffffc0203774:	ffe70693          	addi	a3,a4,-2
ffffffffc0203778:	26d61e63          	bne	a2,a3,ffffffffc02039f4 <vmm_init+0x378>
ffffffffc020377c:	ff07b683          	ld	a3,-16(a5)
ffffffffc0203780:	26e69a63          	bne	a3,a4,ffffffffc02039f4 <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc0203784:	0715                	addi	a4,a4,5
ffffffffc0203786:	679c                	ld	a5,8(a5)
ffffffffc0203788:	feb712e3          	bne	a4,a1,ffffffffc020376c <vmm_init+0xf0>
ffffffffc020378c:	4b1d                	li	s6,7
ffffffffc020378e:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203790:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc0203794:	85a2                	mv	a1,s0
ffffffffc0203796:	8526                	mv	a0,s1
ffffffffc0203798:	d9fff0ef          	jal	ra,ffffffffc0203536 <find_vma>
ffffffffc020379c:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc020379e:	2c050b63          	beqz	a0,ffffffffc0203a74 <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc02037a2:	00140593          	addi	a1,s0,1
ffffffffc02037a6:	8526                	mv	a0,s1
ffffffffc02037a8:	d8fff0ef          	jal	ra,ffffffffc0203536 <find_vma>
ffffffffc02037ac:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc02037ae:	2e050363          	beqz	a0,ffffffffc0203a94 <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc02037b2:	85da                	mv	a1,s6
ffffffffc02037b4:	8526                	mv	a0,s1
ffffffffc02037b6:	d81ff0ef          	jal	ra,ffffffffc0203536 <find_vma>
        assert(vma3 == NULL);
ffffffffc02037ba:	2e051d63          	bnez	a0,ffffffffc0203ab4 <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc02037be:	00340593          	addi	a1,s0,3
ffffffffc02037c2:	8526                	mv	a0,s1
ffffffffc02037c4:	d73ff0ef          	jal	ra,ffffffffc0203536 <find_vma>
        assert(vma4 == NULL);
ffffffffc02037c8:	30051663          	bnez	a0,ffffffffc0203ad4 <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc02037cc:	00440593          	addi	a1,s0,4
ffffffffc02037d0:	8526                	mv	a0,s1
ffffffffc02037d2:	d65ff0ef          	jal	ra,ffffffffc0203536 <find_vma>
        assert(vma5 == NULL);
ffffffffc02037d6:	30051f63          	bnez	a0,ffffffffc0203af4 <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02037da:	00893783          	ld	a5,8(s2)
ffffffffc02037de:	24879b63          	bne	a5,s0,ffffffffc0203a34 <vmm_init+0x3b8>
ffffffffc02037e2:	01093783          	ld	a5,16(s2)
ffffffffc02037e6:	25679763          	bne	a5,s6,ffffffffc0203a34 <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02037ea:	008ab783          	ld	a5,8(s5)
ffffffffc02037ee:	22879363          	bne	a5,s0,ffffffffc0203a14 <vmm_init+0x398>
ffffffffc02037f2:	010ab783          	ld	a5,16(s5)
ffffffffc02037f6:	21679f63          	bne	a5,s6,ffffffffc0203a14 <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc02037fa:	0415                	addi	s0,s0,5
ffffffffc02037fc:	0b15                	addi	s6,s6,5
ffffffffc02037fe:	f9741be3          	bne	s0,s7,ffffffffc0203794 <vmm_init+0x118>
ffffffffc0203802:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc0203804:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc0203806:	85a2                	mv	a1,s0
ffffffffc0203808:	8526                	mv	a0,s1
ffffffffc020380a:	d2dff0ef          	jal	ra,ffffffffc0203536 <find_vma>
ffffffffc020380e:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc0203812:	c90d                	beqz	a0,ffffffffc0203844 <vmm_init+0x1c8>
            cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc0203814:	6914                	ld	a3,16(a0)
ffffffffc0203816:	6510                	ld	a2,8(a0)
ffffffffc0203818:	00002517          	auipc	a0,0x2
ffffffffc020381c:	58050513          	addi	a0,a0,1408 # ffffffffc0205d98 <default_pmm_manager+0xc80>
ffffffffc0203820:	89bfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203824:	00002697          	auipc	a3,0x2
ffffffffc0203828:	59c68693          	addi	a3,a3,1436 # ffffffffc0205dc0 <default_pmm_manager+0xca8>
ffffffffc020382c:	00001617          	auipc	a2,0x1
ffffffffc0203830:	53c60613          	addi	a2,a2,1340 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203834:	0f800593          	li	a1,248
ffffffffc0203838:	00002517          	auipc	a0,0x2
ffffffffc020383c:	3f050513          	addi	a0,a0,1008 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203840:	b35fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc0203844:	147d                	addi	s0,s0,-1
ffffffffc0203846:	fd2410e3          	bne	s0,s2,ffffffffc0203806 <vmm_init+0x18a>
ffffffffc020384a:	a811                	j	ffffffffc020385e <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
ffffffffc020384c:	6118                	ld	a4,0(a0)
ffffffffc020384e:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203850:	03000593          	li	a1,48
ffffffffc0203854:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203856:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203858:	e398                	sd	a4,0(a5)
ffffffffc020385a:	fd9fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc020385e:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc0203860:	fea496e3          	bne	s1,a0,ffffffffc020384c <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203864:	03000593          	li	a1,48
ffffffffc0203868:	8526                	mv	a0,s1
...
ffffffffc0203872:	3caa1163          	bne	s4,a0,ffffffffc0203c34 <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc0203876:	00002517          	auipc	a0,0x2
ffffffffc020387a:	58a50513          	addi	a0,a0,1418 # ffffffffc0205e00 <default_pmm_manager+0xce8>
ffffffffc020387e:	83dfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
...
ffffffffc020388c:	eedfe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203890:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203892:	2a050163          	beqz	a0,ffffffffc0203b34 <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);//页面置换的初始化
ffffffffc0203896:	0000e797          	auipc	a5,0xe
ffffffffc020389a:	cba7a783          	lw	a5,-838(a5) # ffffffffc0211550 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc020389e:	e508                	sd	a0,8(a0)
ffffffffc02038a0:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc02038a2:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02038a6:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02038aa:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);//页面置换的初始化
ffffffffc02038ae:	14079063          	bnez	a5,ffffffffc02039ee <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc02038b2:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02038b6:	0000e917          	auipc	s2,0xe
ffffffffc02038ba:	c6293903          	ld	s2,-926(s2) # ffffffffc0211518 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc02038be:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc02038c2:	0000e717          	auipc	a4,0xe
ffffffffc02038c6:	c8873f23          	sd	s0,-866(a4) # ffffffffc0211560 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02038ca:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc02038ce:	24079363          	bnez	a5,ffffffffc0203b14 <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02038d2:	03000513          	li	a0,48
ffffffffc02038d6:	ea3fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02038da:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc02038dc:	28050063          	beqz	a0,ffffffffc0203b5c <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc02038e0:	002007b7          	lui	a5,0x200
ffffffffc02038e4:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc02038e8:	4789                	li	a5,2
    ...
    insert_vma_struct(mm, vma);
ffffffffc02038ea:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc02038ec:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc02038f0:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc02038f2:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc02038f6:	c81ff0ef          	jal	ra,ffffffffc0203576 <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc02038fa:	10000593          	li	a1,256
ffffffffc02038fe:	8522                	mv	a0,s0
ffffffffc0203900:	c37ff0ef          	jal	ra,ffffffffc0203536 <find_vma>
ffffffffc0203904:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc0203908:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc020390c:	26aa1863          	bne	s4,a0,ffffffffc0203b7c <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc0203910:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc0203914:	0785                	addi	a5,a5,1
ffffffffc0203916:	fee79de3          	bne	a5,a4,ffffffffc0203910 <vmm_init+0x294>
        sum += i;
ffffffffc020391a:	6705                	lui	a4,0x1
ffffffffc020391c:	10000793          	li	a5,256
ffffffffc0203920:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc0203924:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc0203928:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc020392c:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc020392e:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc0203930:	fec79ce3          	bne	a5,a2,ffffffffc0203928 <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc0203934:	26071463          	bnez	a4,ffffffffc0203b9c <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc0203938:	4581                	li	a1,0
ffffffffc020393a:	854a                	mv	a0,s2
ffffffffc020393c:	fe1fd0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203940:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc0203944:	0000e717          	auipc	a4,0xe
ffffffffc0203948:	bdc73703          	ld	a4,-1060(a4) # ffffffffc0211520 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc020394c:	078a                	slli	a5,a5,0x2
ffffffffc020394e:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203950:	26e7f663          	bgeu	a5,a4,ffffffffc0203bbc <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc0203954:	00003717          	auipc	a4,0x3
ffffffffc0203958:	87473703          	ld	a4,-1932(a4) # ffffffffc02061c8 <nbase>
ffffffffc020395c:	8f99                	sub	a5,a5,a4
ffffffffc020395e:	00379713          	slli	a4,a5,0x3
ffffffffc0203962:	97ba                	add	a5,a5,a4
ffffffffc0203964:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc0203966:	0000e517          	auipc	a0,0xe
ffffffffc020396a:	bc253503          	ld	a0,-1086(a0) # ffffffffc0211528 <pages>
ffffffffc020396e:	953e                	add	a0,a0,a5
ffffffffc0203970:	4585                	li	a1,1
ffffffffc0203972:	ce1fd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc0203976:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc0203978:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc020397c:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203980:	00a40e63          	beq	s0,a0,ffffffffc020399c <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203984:	6118                	ld	a4,0(a0)
ffffffffc0203986:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203988:	03000593          	li	a1,48
ffffffffc020398c:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc020398e:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203990:	e398                	sd	a4,0(a5)
ffffffffc0203992:	ea1fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203996:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203998:	fea416e3          	bne	s0,a0,ffffffffc0203984 <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
...
ffffffffc02039a6:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc02039a8:	0000e797          	auipc	a5,0xe
ffffffffc02039ac:	ba07bc23          	sd	zero,-1096(a5) # ffffffffc0211560 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039b0:	ce3fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02039b4:	22a49063          	bne	s1,a0,ffffffffc0203bd4 <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc02039b8:	00002517          	auipc	a0,0x2
ffffffffc02039bc:	49850513          	addi	a0,a0,1176 # ffffffffc0205e50 <default_pmm_manager+0xd38>
ffffffffc02039c0:	efafc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039c4:	ccffd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc02039c8:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039ca:	22a99563          	bne	s3,a0,ffffffffc0203bf4 <vmm_init+0x578>
}
ffffffffc02039ce:	6406                	ld	s0,64(sp)
ffffffffc02039d0:	60a6                	ld	ra,72(sp)
ffffffffc02039d2:	74e2                	ld	s1,56(sp)
ffffffffc02039d4:	7942                	ld	s2,48(sp)
ffffffffc02039d6:	79a2                	ld	s3,40(sp)
ffffffffc02039d8:	7a02                	ld	s4,32(sp)
ffffffffc02039da:	6ae2                	ld	s5,24(sp)
ffffffffc02039dc:	6b42                	ld	s6,16(sp)
ffffffffc02039de:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc02039e0:	00002517          	auipc	a0,0x2
ffffffffc02039e4:	49050513          	addi	a0,a0,1168 # ffffffffc0205e70 <default_pmm_manager+0xd58>
}
ffffffffc02039e8:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc02039ea:	ed0fc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);//页面置换的初始化
ffffffffc02039ee:	d96ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc02039f2:	b5d1                	j	ffffffffc02038b6 <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc02039f4:	00002697          	auipc	a3,0x2
ffffffffc02039f8:	2bc68693          	addi	a3,a3,700 # ffffffffc0205cb0 <default_pmm_manager+0xb98>
ffffffffc02039fc:	00001617          	auipc	a2,0x1
ffffffffc0203a00:	36c60613          	addi	a2,a2,876 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203a04:	0df00593          	li	a1,223
ffffffffc0203a08:	00002517          	auipc	a0,0x2
ffffffffc0203a0c:	22050513          	addi	a0,a0,544 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203a10:	965fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203a14:	00002697          	auipc	a3,0x2
ffffffffc0203a18:	35468693          	addi	a3,a3,852 # ffffffffc0205d68 <default_pmm_manager+0xc50>
ffffffffc0203a1c:	00001617          	auipc	a2,0x1
ffffffffc0203a20:	34c60613          	addi	a2,a2,844 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203a24:	0f000593          	li	a1,240
ffffffffc0203a28:	00002517          	auipc	a0,0x2
ffffffffc0203a2c:	20050513          	addi	a0,a0,512 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203a30:	945fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203a34:	00002697          	auipc	a3,0x2
ffffffffc0203a38:	30468693          	addi	a3,a3,772 # ffffffffc0205d38 <default_pmm_manager+0xc20>
ffffffffc0203a3c:	00001617          	auipc	a2,0x1
ffffffffc0203a40:	32c60613          	addi	a2,a2,812 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203a44:	0ef00593          	li	a1,239
ffffffffc0203a48:	00002517          	auipc	a0,0x2
ffffffffc0203a4c:	1e050513          	addi	a0,a0,480 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203a50:	925fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203a54:	00002697          	auipc	a3,0x2
ffffffffc0203a58:	24468693          	addi	a3,a3,580 # ffffffffc0205c98 <default_pmm_manager+0xb80>
ffffffffc0203a5c:	00001617          	auipc	a2,0x1
ffffffffc0203a60:	30c60613          	addi	a2,a2,780 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203a64:	0dd00593          	li	a1,221
ffffffffc0203a68:	00002517          	auipc	a0,0x2
ffffffffc0203a6c:	1c050513          	addi	a0,a0,448 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203a70:	905fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203a74:	00002697          	auipc	a3,0x2
ffffffffc0203a78:	27468693          	addi	a3,a3,628 # ffffffffc0205ce8 <default_pmm_manager+0xbd0>
ffffffffc0203a7c:	00001617          	auipc	a2,0x1
ffffffffc0203a80:	2ec60613          	addi	a2,a2,748 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203a84:	0e500593          	li	a1,229
ffffffffc0203a88:	00002517          	auipc	a0,0x2
ffffffffc0203a8c:	1a050513          	addi	a0,a0,416 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203a90:	8e5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203a94:	00002697          	auipc	a3,0x2
ffffffffc0203a98:	26468693          	addi	a3,a3,612 # ffffffffc0205cf8 <default_pmm_manager+0xbe0>
ffffffffc0203a9c:	00001617          	auipc	a2,0x1
ffffffffc0203aa0:	2cc60613          	addi	a2,a2,716 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203aa4:	0e700593          	li	a1,231
ffffffffc0203aa8:	00002517          	auipc	a0,0x2
ffffffffc0203aac:	18050513          	addi	a0,a0,384 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203ab0:	8c5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203ab4:	00002697          	auipc	a3,0x2
ffffffffc0203ab8:	25468693          	addi	a3,a3,596 # ffffffffc0205d08 <default_pmm_manager+0xbf0>
ffffffffc0203abc:	00001617          	auipc	a2,0x1
ffffffffc0203ac0:	2ac60613          	addi	a2,a2,684 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203ac4:	0e900593          	li	a1,233
ffffffffc0203ac8:	00002517          	auipc	a0,0x2
ffffffffc0203acc:	16050513          	addi	a0,a0,352 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203ad0:	8a5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203ad4:	00002697          	auipc	a3,0x2
ffffffffc0203ad8:	24468693          	addi	a3,a3,580 # ffffffffc0205d18 <default_pmm_manager+0xc00>
ffffffffc0203adc:	00001617          	auipc	a2,0x1
ffffffffc0203ae0:	28c60613          	addi	a2,a2,652 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203ae4:	0eb00593          	li	a1,235
ffffffffc0203ae8:	00002517          	auipc	a0,0x2
ffffffffc0203aec:	14050513          	addi	a0,a0,320 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203af0:	885fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203af4:	00002697          	auipc	a3,0x2
ffffffffc0203af8:	23468693          	addi	a3,a3,564 # ffffffffc0205d28 <default_pmm_manager+0xc10>
ffffffffc0203afc:	00001617          	auipc	a2,0x1
ffffffffc0203b00:	26c60613          	addi	a2,a2,620 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203b04:	0ed00593          	li	a1,237
ffffffffc0203b08:	00002517          	auipc	a0,0x2
ffffffffc0203b0c:	12050513          	addi	a0,a0,288 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203b10:	865fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203b14:	00002697          	auipc	a3,0x2
ffffffffc0203b18:	d2468693          	addi	a3,a3,-732 # ffffffffc0205838 <default_pmm_manager+0x720>
ffffffffc0203b1c:	00001617          	auipc	a2,0x1
ffffffffc0203b20:	24c60613          	addi	a2,a2,588 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203b24:	10f00593          	li	a1,271
ffffffffc0203b28:	00002517          	auipc	a0,0x2
ffffffffc0203b2c:	10050513          	addi	a0,a0,256 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203b30:	845fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203b34:	00002697          	auipc	a3,0x2
ffffffffc0203b38:	35468693          	addi	a3,a3,852 # ffffffffc0205e88 <default_pmm_manager+0xd70>
ffffffffc0203b3c:	00001617          	auipc	a2,0x1
ffffffffc0203b40:	22c60613          	addi	a2,a2,556 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203b44:	10c00593          	li	a1,268
ffffffffc0203b48:	00002517          	auipc	a0,0x2
ffffffffc0203b4c:	0e050513          	addi	a0,a0,224 # ffffffffc0205c28 <default_pmm_manager+0xb10>
    check_mm_struct = mm_create();
ffffffffc0203b50:	0000e797          	auipc	a5,0xe
ffffffffc0203b54:	a007b823          	sd	zero,-1520(a5) # ffffffffc0211560 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203b58:	81dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203b5c:	00002697          	auipc	a3,0x2
ffffffffc0203b60:	cec68693          	addi	a3,a3,-788 # ffffffffc0205848 <default_pmm_manager+0x730>
ffffffffc0203b64:	00001617          	auipc	a2,0x1
ffffffffc0203b68:	20460613          	addi	a2,a2,516 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203b6c:	11300593          	li	a1,275
ffffffffc0203b70:	00002517          	auipc	a0,0x2
ffffffffc0203b74:	0b850513          	addi	a0,a0,184 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203b78:	ffcfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203b7c:	00002697          	auipc	a3,0x2
ffffffffc0203b80:	2a468693          	addi	a3,a3,676 # ffffffffc0205e20 <default_pmm_manager+0xd08>
ffffffffc0203b84:	00001617          	auipc	a2,0x1
ffffffffc0203b88:	1e460613          	addi	a2,a2,484 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203b8c:	11800593          	li	a1,280
ffffffffc0203b90:	00002517          	auipc	a0,0x2
ffffffffc0203b94:	09850513          	addi	a0,a0,152 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203b98:	fdcfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203b9c:	00002697          	auipc	a3,0x2
ffffffffc0203ba0:	2a468693          	addi	a3,a3,676 # ffffffffc0205e40 <default_pmm_manager+0xd28>
ffffffffc0203ba4:	00001617          	auipc	a2,0x1
ffffffffc0203ba8:	1c460613          	addi	a2,a2,452 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203bac:	12200593          	li	a1,290
ffffffffc0203bb0:	00002517          	auipc	a0,0x2
ffffffffc0203bb4:	07850513          	addi	a0,a0,120 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203bb8:	fbcfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203bbc:	00001617          	auipc	a2,0x1
ffffffffc0203bc0:	59460613          	addi	a2,a2,1428 # ffffffffc0205150 <default_pmm_manager+0x38>
ffffffffc0203bc4:	06c00593          	li	a1,108
ffffffffc0203bc8:	00001517          	auipc	a0,0x1
ffffffffc0203bcc:	5a850513          	addi	a0,a0,1448 # ffffffffc0205170 <default_pmm_manager+0x58>
ffffffffc0203bd0:	fa4fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203bd4:	00002697          	auipc	a3,0x2
ffffffffc0203bd8:	20468693          	addi	a3,a3,516 # ffffffffc0205dd8 <default_pmm_manager+0xcc0>
ffffffffc0203bdc:	00001617          	auipc	a2,0x1
ffffffffc0203be0:	18c60613          	addi	a2,a2,396 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203be4:	13000593          	li	a1,304
ffffffffc0203be8:	00002517          	auipc	a0,0x2
ffffffffc0203bec:	04050513          	addi	a0,a0,64 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203bf0:	f84fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203bf4:	00002697          	auipc	a3,0x2
ffffffffc0203bf8:	1e468693          	addi	a3,a3,484 # ffffffffc0205dd8 <default_pmm_manager+0xcc0>
ffffffffc0203bfc:	00001617          	auipc	a2,0x1
ffffffffc0203c00:	16c60613          	addi	a2,a2,364 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203c04:	0bf00593          	li	a1,191
ffffffffc0203c08:	00002517          	auipc	a0,0x2
ffffffffc0203c0c:	02050513          	addi	a0,a0,32 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203c10:	f64fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203c14:	00002697          	auipc	a3,0x2
ffffffffc0203c18:	bfc68693          	addi	a3,a3,-1028 # ffffffffc0205810 <default_pmm_manager+0x6f8>
ffffffffc0203c1c:	00001617          	auipc	a2,0x1
ffffffffc0203c20:	14c60613          	addi	a2,a2,332 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203c24:	0c900593          	li	a1,201
ffffffffc0203c28:	00002517          	auipc	a0,0x2
ffffffffc0203c2c:	00050513          	mv	a0,a0
ffffffffc0203c30:	f44fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c34:	00002697          	auipc	a3,0x2
ffffffffc0203c38:	1a468693          	addi	a3,a3,420 # ffffffffc0205dd8 <default_pmm_manager+0xcc0>
ffffffffc0203c3c:	00001617          	auipc	a2,0x1
ffffffffc0203c40:	12c60613          	addi	a2,a2,300 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203c44:	0fd00593          	li	a1,253
ffffffffc0203c48:	00002517          	auipc	a0,0x2
ffffffffc0203c4c:	fe050513          	addi	a0,a0,-32 # ffffffffc0205c28 <default_pmm_manager+0xb10>
ffffffffc0203c50:	f24fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203c54 <do_pgfault>:
...
ffffffffc0203c56:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203c58:	f022                	sd	s0,32(sp)
ffffffffc0203c5a:	ec26                	sd	s1,24(sp)
ffffffffc0203c5c:	f406                	sd	ra,40(sp)
ffffffffc0203c5e:	e84a                	sd	s2,16(sp)
ffffffffc0203c60:	8432                	mv	s0,a2
ffffffffc0203c62:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c64:	8d3ff0ef          	jal	ra,ffffffffc0203536 <find_vma>
    //在mm_struct里判断这个虚拟地址是否可用
    pgfault_num++;
ffffffffc0203c68:	0000e797          	auipc	a5,0xe
ffffffffc0203c6c:	9007a783          	lw	a5,-1792(a5) # ffffffffc0211568 <pgfault_num>
ffffffffc0203c70:	2785                	addiw	a5,a5,1
ffffffffc0203c72:	0000e717          	auipc	a4,0xe
ffffffffc0203c76:	8ef72b23          	sw	a5,-1802(a4) # ffffffffc0211568 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203c7a:	c159                	beqz	a0,ffffffffc0203d00 <do_pgfault+0xac>
ffffffffc0203c7c:	651c                	ld	a5,8(a0)
ffffffffc0203c7e:	08f46163          	bltu	s0,a5,ffffffffc0203d00 <do_pgfault+0xac>
...
ffffffffc0203c82:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203c84:	4941                	li	s2,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203c86:	8b89                	andi	a5,a5,2
ffffffffc0203c88:	ebb1                	bnez	a5,ffffffffc0203cdc <do_pgfault+0x88>
        perm |= (PTE_R | PTE_W);
    }
    // perm &= ~PTE_R;

    addr = ROUNDDOWN(addr, PGSIZE);//按照页面大小把地址对齐
ffffffffc0203c8a:	75fd                	lui	a1,0xfffff
...
ffffffffc0203c8c:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);//按照页面大小把地址对齐
ffffffffc0203c8e:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203c90:	85a2                	mv	a1,s0
ffffffffc0203c92:	4605                	li	a2,1
ffffffffc0203c94:	a39fd0ef          	jal	ra,ffffffffc02016cc <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203c98:	610c                	ld	a1,0(a0)
ffffffffc0203c9a:	c1b9                	beqz	a1,ffffffffc0203ce0 <do_pgfault+0x8c>
...
ffffffffc0203ca0:	8b47a783          	lw	a5,-1868(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203ca4:	c7bd                	beqz	a5,ffffffffc0203d12 <do_pgfault+0xbe>
...
ffffffffc0203ca8:	0030                	addi	a2,sp,8
ffffffffc0203caa:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203cac:	e402                	sd	zero,8(sp)
            swap_in(mm,addr,&page);
ffffffffc0203cae:	c02ff0ef          	jal	ra,ffffffffc02030b0 <swap_in>
            page_insert(mm->pgdir,page,addr,perm);
ffffffffc0203cb2:	65a2                	ld	a1,8(sp)
ffffffffc0203cb4:	6c88                	ld	a0,24(s1)
ffffffffc0203cb6:	86ca                	mv	a3,s2
...
ffffffffc0203ccc:	4501                	li	a0,0
            page->pra_vaddr = addr;
ffffffffc0203cce:	e3a0                	sd	s0,64(a5)
failed:
    return ret;
}
ffffffffc0203cd0:	70a2                	ld	ra,40(sp)
ffffffffc0203cd2:	7402                	ld	s0,32(sp)
ffffffffc0203cd4:	64e2                	ld	s1,24(sp)
ffffffffc0203cd6:	6942                	ld	s2,16(sp)
ffffffffc0203cd8:	6145                	addi	sp,sp,48
ffffffffc0203cda:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203cdc:	4959                	li	s2,22
ffffffffc0203cde:	b775                	j	ffffffffc0203c8a <do_pgfault+0x36>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203ce0:	6c88                	ld	a0,24(s1)
ffffffffc0203ce2:	864a                	mv	a2,s2
ffffffffc0203ce4:	85a2                	mv	a1,s0
ffffffffc0203ce6:	9dbfe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
ffffffffc0203cea:	87aa                	mv	a5,a0
   ret = 0;
ffffffffc0203cec:	4501                	li	a0,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203cee:	f3ed                	bnez	a5,ffffffffc0203cd0 <do_pgfault+0x7c>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203cf0:	00002517          	auipc	a0,0x2
ffffffffc0203cf4:	1e050513          	addi	a0,a0,480 # ffffffffc0205ed0 <default_pmm_manager+0xdb8>
ffffffffc0203cf8:	bc2fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203cfc:	5571                	li	a0,-4
            goto failed;
ffffffffc0203cfe:	bfc9                	j	ffffffffc0203cd0 <do_pgfault+0x7c>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203d00:	85a2                	mv	a1,s0
ffffffffc0203d02:	00002517          	auipc	a0,0x2
ffffffffc0203d06:	19e50513          	addi	a0,a0,414 # ffffffffc0205ea0 <default_pmm_manager+0xd88>
ffffffffc0203d0a:	bb0fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203d0e:	5575                	li	a0,-3
        goto failed;
ffffffffc0203d10:	b7c1                	j	ffffffffc0203cd0 <do_pgfault+0x7c>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203d12:	00002517          	auipc	a0,0x2
ffffffffc0203d16:	1e650513          	addi	a0,a0,486 # ffffffffc0205ef8 <default_pmm_manager+0xde0>
ffffffffc0203d1a:	ba0fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d1e:	5571                	li	a0,-4
            goto failed;
ffffffffc0203d20:	bf45                	j	ffffffffc0203cd0 <do_pgfault+0x7c>
...
ffffffffc0203d26:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {//是否有可用的IDE设备作为交换文件系统的后备存储设备
ffffffffc0203d28:	f6cfc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
...
ffffffffc0203d30:	f6afc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
ffffffffc0203d34:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);//可以使用的最大交换偏移量
ffffffffc0203d36:	810d                	srli	a0,a0,0x3
ffffffffc0203d38:	0000e797          	auipc	a5,0xe
ffffffffc0203d3c:	80a7b423          	sd	a0,-2040(a5) # ffffffffc0211540 <max_swap_offset>
}
ffffffffc0203d40:	0141                	addi	sp,sp,16
ffffffffc0203d42:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0203d44:	00002617          	auipc	a2,0x2
ffffffffc0203d48:	1dc60613          	addi	a2,a2,476 # ffffffffc0205f20 <default_pmm_manager+0xe08>
ffffffffc0203d4c:	45b5                	li	a1,13
ffffffffc0203d4e:	00002517          	auipc	a0,0x2
ffffffffc0203d52:	1f250513          	addi	a0,a0,498 # ffffffffc0205f40 <default_pmm_manager+0xe28>
...
ffffffffc0203d68:	7dc73703          	ld	a4,2012(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203d6c:	04e7fb63          	bgeu	a5,a4,ffffffffc0203dc2 <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203d70:	0000d617          	auipc	a2,0xd
ffffffffc0203d74:	7b863603          	ld	a2,1976(a2) # ffffffffc0211528 <pages>
...
ffffffffc0203d9a:	78a73703          	ld	a4,1930(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0203db2:	78a7b783          	ld	a5,1930(a5) # ffffffffc0211538 <va_pa_offset>
...
ffffffffc0203dbc:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203dbe:	ee2fc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203dc2:	86aa                	mv	a3,a0
ffffffffc0203dc4:	00002617          	auipc	a2,0x2
ffffffffc0203dc8:	19460613          	addi	a2,a2,404 # ffffffffc0205f58 <default_pmm_manager+0xe40>
ffffffffc0203dcc:	45d1                	li	a1,20
ffffffffc0203dce:	00002517          	auipc	a0,0x2
ffffffffc0203dd2:	17250513          	addi	a0,a0,370 # ffffffffc0205f40 <default_pmm_manager+0xe28>
ffffffffc0203dd6:	d9efc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203dda:	86b2                	mv	a3,a2
ffffffffc0203ddc:	07100593          	li	a1,113
ffffffffc0203de0:	00001617          	auipc	a2,0x1
ffffffffc0203de4:	3c860613          	addi	a2,a2,968 # ffffffffc02051a8 <default_pmm_manager+0x90>
ffffffffc0203de8:	00001517          	auipc	a0,0x1
ffffffffc0203dec:	38850513          	addi	a0,a0,904 # ffffffffc0205170 <default_pmm_manager+0x58>
...
ffffffffc0203e02:	74273703          	ld	a4,1858(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203e06:	04e7fb63          	bgeu	a5,a4,ffffffffc0203e5c <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e0a:	0000d617          	auipc	a2,0xd
ffffffffc0203e0e:	71e63603          	ld	a2,1822(a2) # ffffffffc0211528 <pages>
...
ffffffffc0203e34:	6f073703          	ld	a4,1776(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0203e4c:	6f07b783          	ld	a5,1776(a5) # ffffffffc0211538 <va_pa_offset>
...
ffffffffc0203e56:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e58:	e6cfc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203e5c:	86aa                	mv	a3,a0
ffffffffc0203e5e:	00002617          	auipc	a2,0x2
ffffffffc0203e62:	0fa60613          	addi	a2,a2,250 # ffffffffc0205f58 <default_pmm_manager+0xe40>
ffffffffc0203e66:	45e5                	li	a1,25
ffffffffc0203e68:	00002517          	auipc	a0,0x2
ffffffffc0203e6c:	0d850513          	addi	a0,a0,216 # ffffffffc0205f40 <default_pmm_manager+0xe28>
ffffffffc0203e70:	d04fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203e74:	86b2                	mv	a3,a2
ffffffffc0203e76:	07100593          	li	a1,113
ffffffffc0203e7a:	00001617          	auipc	a2,0x1
ffffffffc0203e7e:	32e60613          	addi	a2,a2,814 # ffffffffc02051a8 <default_pmm_manager+0x90>
ffffffffc0203e82:	00001517          	auipc	a0,0x1
ffffffffc0203e86:	2ee50513          	addi	a0,a0,750 # ffffffffc0205170 <default_pmm_manager+0x58>
ffffffffc0203e8a:	ceafc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e8e <printnum>:
 * */
static void
...
ffffffffc0203e8e:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e92:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203e94:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e98:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203e9a:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e9e:	f022                	sd	s0,32(sp)
ffffffffc0203ea0:	ec26                	sd	s1,24(sp)
ffffffffc0203ea2:	e84a                	sd	s2,16(sp)
ffffffffc0203ea4:	f406                	sd	ra,40(sp)
ffffffffc0203ea6:	e44e                	sd	s3,8(sp)
ffffffffc0203ea8:	84aa                	mv	s1,a0
ffffffffc0203eaa:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203eac:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203eb0:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203eb2:	03067e63          	bgeu	a2,a6,ffffffffc0203eee <printnum+0x60>
ffffffffc0203eb6:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203eb8:	00805763          	blez	s0,ffffffffc0203ec6 <printnum+0x38>
ffffffffc0203ebc:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203ebe:	85ca                	mv	a1,s2
ffffffffc0203ec0:	854e                	mv	a0,s3
ffffffffc0203ec2:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203ec4:	fc65                	bnez	s0,ffffffffc0203ebc <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ec6:	1a02                	slli	s4,s4,0x20
ffffffffc0203ec8:	00002797          	auipc	a5,0x2
ffffffffc0203ecc:	0b078793          	addi	a5,a5,176 # ffffffffc0205f78 <default_pmm_manager+0xe60>
ffffffffc0203ed0:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203ed4:	9a3e                	add	s4,s4,a5
}
ffffffffc0203ed6:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ed8:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203edc:	70a2                	ld	ra,40(sp)
ffffffffc0203ede:	69a2                	ld	s3,8(sp)
ffffffffc0203ee0:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ee2:	85ca                	mv	a1,s2
ffffffffc0203ee4:	87a6                	mv	a5,s1
}
ffffffffc0203ee6:	6942                	ld	s2,16(sp)
ffffffffc0203ee8:	64e2                	ld	s1,24(sp)
ffffffffc0203eea:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203eec:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203eee:	03065633          	divu	a2,a2,a6
ffffffffc0203ef2:	8722                	mv	a4,s0
ffffffffc0203ef4:	f9bff0ef          	jal	ra,ffffffffc0203e8e <printnum>
ffffffffc0203ef8:	b7f9                	j	ffffffffc0203ec6 <printnum+0x38>

ffffffffc0203efa <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203efa:	7119                	addi	sp,sp,-128
ffffffffc0203efc:	f4a6                	sd	s1,104(sp)
ffffffffc0203efe:	f0ca                	sd	s2,96(sp)
ffffffffc0203f00:	ecce                	sd	s3,88(sp)
ffffffffc0203f02:	e8d2                	sd	s4,80(sp)
ffffffffc0203f04:	e4d6                	sd	s5,72(sp)
ffffffffc0203f06:	e0da                	sd	s6,64(sp)
ffffffffc0203f08:	fc5e                	sd	s7,56(sp)
ffffffffc0203f0a:	f06a                	sd	s10,32(sp)
ffffffffc0203f0c:	fc86                	sd	ra,120(sp)
ffffffffc0203f0e:	f8a2                	sd	s0,112(sp)
ffffffffc0203f10:	f862                	sd	s8,48(sp)
ffffffffc0203f12:	f466                	sd	s9,40(sp)
ffffffffc0203f14:	ec6e                	sd	s11,24(sp)
ffffffffc0203f16:	892a                	mv	s2,a0
ffffffffc0203f18:	84ae                	mv	s1,a1
ffffffffc0203f1a:	8d32                	mv	s10,a2
ffffffffc0203f1c:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203f1e:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203f22:	5b7d                	li	s6,-1
ffffffffc0203f24:	00002a97          	auipc	s5,0x2
ffffffffc0203f28:	088a8a93          	addi	s5,s5,136 # ffffffffc0205fac <default_pmm_manager+0xe94>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203f2c:	00002b97          	auipc	s7,0x2
ffffffffc0203f30:	25cb8b93          	addi	s7,s7,604 # ffffffffc0206188 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f34:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0203f38:	001d0413          	addi	s0,s10,1
ffffffffc0203f3c:	01350a63          	beq	a0,s3,ffffffffc0203f50 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203f40:	c121                	beqz	a0,ffffffffc0203f80 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0203f42:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f44:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203f46:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f48:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203f4c:	ff351ae3          	bne	a0,s3,ffffffffc0203f40 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f50:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203f54:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203f58:	4c81                	li	s9,0
ffffffffc0203f5a:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203f5c:	5c7d                	li	s8,-1
ffffffffc0203f5e:	5dfd                	li	s11,-1
ffffffffc0203f60:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203f64:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f66:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203f6a:	0ff5f593          	andi	a1,a1,255
ffffffffc0203f6e:	00140d13          	addi	s10,s0,1
ffffffffc0203f72:	04b56263          	bltu	a0,a1,ffffffffc0203fb6 <vprintfmt+0xbc>
ffffffffc0203f76:	058a                	slli	a1,a1,0x2
ffffffffc0203f78:	95d6                	add	a1,a1,s5
ffffffffc0203f7a:	4194                	lw	a3,0(a1)
ffffffffc0203f7c:	96d6                	add	a3,a3,s5
ffffffffc0203f7e:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203f80:	70e6                	ld	ra,120(sp)
ffffffffc0203f82:	7446                	ld	s0,112(sp)
ffffffffc0203f84:	74a6                	ld	s1,104(sp)
ffffffffc0203f86:	7906                	ld	s2,96(sp)
ffffffffc0203f88:	69e6                	ld	s3,88(sp)
ffffffffc0203f8a:	6a46                	ld	s4,80(sp)
ffffffffc0203f8c:	6aa6                	ld	s5,72(sp)
ffffffffc0203f8e:	6b06                	ld	s6,64(sp)
ffffffffc0203f90:	7be2                	ld	s7,56(sp)
ffffffffc0203f92:	7c42                	ld	s8,48(sp)
ffffffffc0203f94:	7ca2                	ld	s9,40(sp)
ffffffffc0203f96:	7d02                	ld	s10,32(sp)
ffffffffc0203f98:	6de2                	ld	s11,24(sp)
ffffffffc0203f9a:	6109                	addi	sp,sp,128
ffffffffc0203f9c:	8082                	ret
            padc = '0';
ffffffffc0203f9e:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203fa0:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fa4:	846a                	mv	s0,s10
ffffffffc0203fa6:	00140d13          	addi	s10,s0,1
ffffffffc0203faa:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203fae:	0ff5f593          	andi	a1,a1,255
ffffffffc0203fb2:	fcb572e3          	bgeu	a0,a1,ffffffffc0203f76 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0203fb6:	85a6                	mv	a1,s1
ffffffffc0203fb8:	02500513          	li	a0,37
ffffffffc0203fbc:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0203fbe:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203fc2:	8d22                	mv	s10,s0
ffffffffc0203fc4:	f73788e3          	beq	a5,s3,ffffffffc0203f34 <vprintfmt+0x3a>
ffffffffc0203fc8:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203fcc:	1d7d                	addi	s10,s10,-1
ffffffffc0203fce:	ff379de3          	bne	a5,s3,ffffffffc0203fc8 <vprintfmt+0xce>
ffffffffc0203fd2:	b78d                	j	ffffffffc0203f34 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203fd4:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0203fd8:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fdc:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0203fde:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203fe2:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203fe6:	02d86463          	bltu	a6,a3,ffffffffc020400e <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0203fea:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203fee:	002c169b          	slliw	a3,s8,0x2
ffffffffc0203ff2:	0186873b          	addw	a4,a3,s8
ffffffffc0203ff6:	0017171b          	slliw	a4,a4,0x1
ffffffffc0203ffa:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0203ffc:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204000:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204002:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204006:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc020400a:	fed870e3          	bgeu	a6,a3,ffffffffc0203fea <vprintfmt+0xf0>
            if (width < 0)
ffffffffc020400e:	f40ddce3          	bgez	s11,ffffffffc0203f66 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204012:	8de2                	mv	s11,s8
ffffffffc0204014:	5c7d                	li	s8,-1
ffffffffc0204016:	bf81                	j	ffffffffc0203f66 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204018:	fffdc693          	not	a3,s11
ffffffffc020401c:	96fd                	srai	a3,a3,0x3f
ffffffffc020401e:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204022:	00144603          	lbu	a2,1(s0)
ffffffffc0204026:	2d81                	sext.w	s11,s11
ffffffffc0204028:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020402a:	bf35                	j	ffffffffc0203f66 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc020402c:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204030:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204034:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204036:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204038:	bfd9                	j	ffffffffc020400e <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc020403a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020403c:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204040:	01174463          	blt	a4,a7,ffffffffc0204048 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204044:	1a088e63          	beqz	a7,ffffffffc0204200 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204048:	000a3603          	ld	a2,0(s4)
ffffffffc020404c:	46c1                	li	a3,16
ffffffffc020404e:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204050:	2781                	sext.w	a5,a5
ffffffffc0204052:	876e                	mv	a4,s11
ffffffffc0204054:	85a6                	mv	a1,s1
ffffffffc0204056:	854a                	mv	a0,s2
ffffffffc0204058:	e37ff0ef          	jal	ra,ffffffffc0203e8e <printnum>
            break;
ffffffffc020405c:	bde1                	j	ffffffffc0203f34 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc020405e:	000a2503          	lw	a0,0(s4)
ffffffffc0204062:	85a6                	mv	a1,s1
ffffffffc0204064:	0a21                	addi	s4,s4,8
ffffffffc0204066:	9902                	jalr	s2
            break;
ffffffffc0204068:	b5f1                	j	ffffffffc0203f34 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc020406a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020406c:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204070:	01174463          	blt	a4,a7,ffffffffc0204078 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204074:	18088163          	beqz	a7,ffffffffc02041f6 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204078:	000a3603          	ld	a2,0(s4)
ffffffffc020407c:	46a9                	li	a3,10
ffffffffc020407e:	8a2e                	mv	s4,a1
ffffffffc0204080:	bfc1                	j	ffffffffc0204050 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204082:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204086:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204088:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020408a:	bdf1                	j	ffffffffc0203f66 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc020408c:	85a6                	mv	a1,s1
ffffffffc020408e:	02500513          	li	a0,37
ffffffffc0204092:	9902                	jalr	s2
            break;
ffffffffc0204094:	b545                	j	ffffffffc0203f34 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204096:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc020409a:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020409c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020409e:	b5e1                	j	ffffffffc0203f66 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc02040a0:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02040a2:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02040a6:	01174463          	blt	a4,a7,ffffffffc02040ae <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc02040aa:	14088163          	beqz	a7,ffffffffc02041ec <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc02040ae:	000a3603          	ld	a2,0(s4)
ffffffffc02040b2:	46a1                	li	a3,8
ffffffffc02040b4:	8a2e                	mv	s4,a1
ffffffffc02040b6:	bf69                	j	ffffffffc0204050 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc02040b8:	03000513          	li	a0,48
ffffffffc02040bc:	85a6                	mv	a1,s1
ffffffffc02040be:	e03e                	sd	a5,0(sp)
ffffffffc02040c0:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc02040c2:	85a6                	mv	a1,s1
ffffffffc02040c4:	07800513          	li	a0,120
ffffffffc02040c8:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040ca:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc02040cc:	6782                	ld	a5,0(sp)
ffffffffc02040ce:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040d0:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc02040d4:	bfb5                	j	ffffffffc0204050 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02040d6:	000a3403          	ld	s0,0(s4)
ffffffffc02040da:	008a0713          	addi	a4,s4,8
ffffffffc02040de:	e03a                	sd	a4,0(sp)
ffffffffc02040e0:	14040263          	beqz	s0,ffffffffc0204224 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc02040e4:	0fb05763          	blez	s11,ffffffffc02041d2 <vprintfmt+0x2d8>
ffffffffc02040e8:	02d00693          	li	a3,45
ffffffffc02040ec:	0cd79163          	bne	a5,a3,ffffffffc02041ae <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02040f0:	00044783          	lbu	a5,0(s0)
ffffffffc02040f4:	0007851b          	sext.w	a0,a5
ffffffffc02040f8:	cf85                	beqz	a5,ffffffffc0204130 <vprintfmt+0x236>
ffffffffc02040fa:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02040fe:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204102:	000c4563          	bltz	s8,ffffffffc020410c <vprintfmt+0x212>
ffffffffc0204106:	3c7d                	addiw	s8,s8,-1
ffffffffc0204108:	036c0263          	beq	s8,s6,ffffffffc020412c <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc020410c:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020410e:	0e0c8e63          	beqz	s9,ffffffffc020420a <vprintfmt+0x310>
ffffffffc0204112:	3781                	addiw	a5,a5,-32
ffffffffc0204114:	0ef47b63          	bgeu	s0,a5,ffffffffc020420a <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204118:	03f00513          	li	a0,63
ffffffffc020411c:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020411e:	000a4783          	lbu	a5,0(s4)
ffffffffc0204122:	3dfd                	addiw	s11,s11,-1
ffffffffc0204124:	0a05                	addi	s4,s4,1
ffffffffc0204126:	0007851b          	sext.w	a0,a5
ffffffffc020412a:	ffe1                	bnez	a5,ffffffffc0204102 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc020412c:	01b05963          	blez	s11,ffffffffc020413e <vprintfmt+0x244>
...
ffffffffc0204138:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc020413a:	fe0d9be3          	bnez	s11,ffffffffc0204130 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc020413e:	6a02                	ld	s4,0(sp)
ffffffffc0204140:	bbd5                	j	ffffffffc0203f34 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204142:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204144:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204148:	01174463          	blt	a4,a7,ffffffffc0204150 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc020414c:	08088d63          	beqz	a7,ffffffffc02041e6 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204150:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204154:	0a044d63          	bltz	s0,ffffffffc020420e <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204158:	8622                	mv	a2,s0
ffffffffc020415a:	8a66                	mv	s4,s9
ffffffffc020415c:	46a9                	li	a3,10
ffffffffc020415e:	bdcd                	j	ffffffffc0204050 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204160:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204164:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204166:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204168:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc020416c:	8fb5                	xor	a5,a5,a3
ffffffffc020416e:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204172:	02d74163          	blt	a4,a3,ffffffffc0204194 <vprintfmt+0x29a>
ffffffffc0204176:	00369793          	slli	a5,a3,0x3
ffffffffc020417a:	97de                	add	a5,a5,s7
ffffffffc020417c:	639c                	ld	a5,0(a5)
ffffffffc020417e:	cb99                	beqz	a5,ffffffffc0204194 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204180:	86be                	mv	a3,a5
ffffffffc0204182:	00002617          	auipc	a2,0x2
ffffffffc0204186:	e2660613          	addi	a2,a2,-474 # ffffffffc0205fa8 <default_pmm_manager+0xe90>
ffffffffc020418a:	85a6                	mv	a1,s1
ffffffffc020418c:	854a                	mv	a0,s2
ffffffffc020418e:	0ce000ef          	jal	ra,ffffffffc020425c <printfmt>
ffffffffc0204192:	b34d                	j	ffffffffc0203f34 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204194:	00002617          	auipc	a2,0x2
ffffffffc0204198:	e0460613          	addi	a2,a2,-508 # ffffffffc0205f98 <default_pmm_manager+0xe80>
ffffffffc020419c:	85a6                	mv	a1,s1
ffffffffc020419e:	854a                	mv	a0,s2
ffffffffc02041a0:	0bc000ef          	jal	ra,ffffffffc020425c <printfmt>
ffffffffc02041a4:	bb41                	j	ffffffffc0203f34 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc02041a6:	00002417          	auipc	s0,0x2
ffffffffc02041aa:	dea40413          	addi	s0,s0,-534 # ffffffffc0205f90 <default_pmm_manager+0xe78>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041ae:	85e2                	mv	a1,s8
ffffffffc02041b0:	8522                	mv	a0,s0
ffffffffc02041b2:	e43e                	sd	a5,8(sp)
ffffffffc02041b4:	196000ef          	jal	ra,ffffffffc020434a <strnlen>
ffffffffc02041b8:	40ad8dbb          	subw	s11,s11,a0
ffffffffc02041bc:	01b05b63          	blez	s11,ffffffffc02041d2 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc02041c0:	67a2                	ld	a5,8(sp)
ffffffffc02041c2:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041c6:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc02041c8:	85a6                	mv	a1,s1
ffffffffc02041ca:	8552                	mv	a0,s4
ffffffffc02041cc:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041ce:	fe0d9ce3          	bnez	s11,ffffffffc02041c6 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041d2:	00044783          	lbu	a5,0(s0)
ffffffffc02041d6:	00140a13          	addi	s4,s0,1
ffffffffc02041da:	0007851b          	sext.w	a0,a5
ffffffffc02041de:	d3a5                	beqz	a5,ffffffffc020413e <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02041e0:	05e00413          	li	s0,94
ffffffffc02041e4:	bf39                	j	ffffffffc0204102 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc02041e6:	000a2403          	lw	s0,0(s4)
ffffffffc02041ea:	b7ad                	j	ffffffffc0204154 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc02041ec:	000a6603          	lwu	a2,0(s4)
ffffffffc02041f0:	46a1                	li	a3,8
ffffffffc02041f2:	8a2e                	mv	s4,a1
ffffffffc02041f4:	bdb1                	j	ffffffffc0204050 <vprintfmt+0x156>
ffffffffc02041f6:	000a6603          	lwu	a2,0(s4)
ffffffffc02041fa:	46a9                	li	a3,10
ffffffffc02041fc:	8a2e                	mv	s4,a1
ffffffffc02041fe:	bd89                	j	ffffffffc0204050 <vprintfmt+0x156>
ffffffffc0204200:	000a6603          	lwu	a2,0(s4)
ffffffffc0204204:	46c1                	li	a3,16
ffffffffc0204206:	8a2e                	mv	s4,a1
ffffffffc0204208:	b5a1                	j	ffffffffc0204050 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc020420a:	9902                	jalr	s2
ffffffffc020420c:	bf09                	j	ffffffffc020411e <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc020420e:	85a6                	mv	a1,s1
ffffffffc0204210:	02d00513          	li	a0,45
ffffffffc0204214:	e03e                	sd	a5,0(sp)
ffffffffc0204216:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204218:	6782                	ld	a5,0(sp)
ffffffffc020421a:	8a66                	mv	s4,s9
ffffffffc020421c:	40800633          	neg	a2,s0
ffffffffc0204220:	46a9                	li	a3,10
ffffffffc0204222:	b53d                	j	ffffffffc0204050 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204224:	03b05163          	blez	s11,ffffffffc0204246 <vprintfmt+0x34c>
ffffffffc0204228:	02d00693          	li	a3,45
ffffffffc020422c:	f6d79de3          	bne	a5,a3,ffffffffc02041a6 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204230:	00002417          	auipc	s0,0x2
ffffffffc0204234:	d6040413          	addi	s0,s0,-672 # ffffffffc0205f90 <default_pmm_manager+0xe78>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204238:	02800793          	li	a5,40
ffffffffc020423c:	02800513          	li	a0,40
ffffffffc0204240:	00140a13          	addi	s4,s0,1
ffffffffc0204244:	bd6d                	j	ffffffffc02040fe <vprintfmt+0x204>
ffffffffc0204246:	00002a17          	auipc	s4,0x2
ffffffffc020424a:	d4ba0a13          	addi	s4,s4,-693 # ffffffffc0205f91 <default_pmm_manager+0xe79>
ffffffffc020424e:	02800513          	li	a0,40
ffffffffc0204252:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204256:	05e00413          	li	s0,94
ffffffffc020425a:	b565                	j	ffffffffc0204102 <vprintfmt+0x208>

ffffffffc020425c <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020425c:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc020425e:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204262:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204264:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204266:	ec06                	sd	ra,24(sp)
ffffffffc0204268:	f83a                	sd	a4,48(sp)
ffffffffc020426a:	fc3e                	sd	a5,56(sp)
ffffffffc020426c:	e0c2                	sd	a6,64(sp)
ffffffffc020426e:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204270:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204272:	c89ff0ef          	jal	ra,ffffffffc0203efa <vprintfmt>
}
ffffffffc0204276:	60e2                	ld	ra,24(sp)
ffffffffc0204278:	6161                	addi	sp,sp,80
ffffffffc020427a:	8082                	ret

ffffffffc020427c <readline>:
...
ffffffffc020427e:	e486                	sd	ra,72(sp)
ffffffffc0204280:	e0a6                	sd	s1,64(sp)
ffffffffc0204282:	fc4a                	sd	s2,56(sp)
ffffffffc0204284:	f84e                	sd	s3,48(sp)
ffffffffc0204286:	f452                	sd	s4,40(sp)
ffffffffc0204288:	f056                	sd	s5,32(sp)
ffffffffc020428a:	ec5a                	sd	s6,24(sp)
ffffffffc020428c:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc020428e:	c901                	beqz	a0,ffffffffc020429e <readline+0x22>
ffffffffc0204290:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc0204292:	00002517          	auipc	a0,0x2
ffffffffc0204296:	d1650513          	addi	a0,a0,-746 # ffffffffc0205fa8 <default_pmm_manager+0xe90>
ffffffffc020429a:	e21fb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
...
ffffffffc02042a0:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc02042a2:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc02042a4:	4aa9                	li	s5,10
ffffffffc02042a6:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc02042a8:	0000db97          	auipc	s7,0xd
ffffffffc02042ac:	e50b8b93          	addi	s7,s7,-432 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042b0:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc02042b4:	e3ffb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042b8:	00054a63          	bltz	a0,ffffffffc02042cc <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042bc:	00a95a63          	bge	s2,a0,ffffffffc02042d0 <readline+0x54>
ffffffffc02042c0:	029a5263          	bge	s4,s1,ffffffffc02042e4 <readline+0x68>
        c = getchar();
ffffffffc02042c4:	e2ffb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042c8:	fe055ae3          	bgez	a0,ffffffffc02042bc <readline+0x40>
            return NULL;
ffffffffc02042cc:	4501                	li	a0,0
ffffffffc02042ce:	a091                	j	ffffffffc0204312 <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc02042d0:	03351463          	bne	a0,s3,ffffffffc02042f8 <readline+0x7c>
ffffffffc02042d4:	e8a9                	bnez	s1,ffffffffc0204326 <readline+0xaa>
        c = getchar();
ffffffffc02042d6:	e1dfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042da:	fe0549e3          	bltz	a0,ffffffffc02042cc <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042de:	fea959e3          	bge	s2,a0,ffffffffc02042d0 <readline+0x54>
ffffffffc02042e2:	4481                	li	s1,0
            cputchar(c);
ffffffffc02042e4:	e42a                	sd	a0,8(sp)
ffffffffc02042e6:	e0bfb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i ++] = c;
ffffffffc02042ea:	6522                	ld	a0,8(sp)
ffffffffc02042ec:	009b87b3          	add	a5,s7,s1
ffffffffc02042f0:	2485                	addiw	s1,s1,1
ffffffffc02042f2:	00a78023          	sb	a0,0(a5)
ffffffffc02042f6:	bf7d                	j	ffffffffc02042b4 <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc02042f8:	01550463          	beq	a0,s5,ffffffffc0204300 <readline+0x84>
ffffffffc02042fc:	fb651ce3          	bne	a0,s6,ffffffffc02042b4 <readline+0x38>
            cputchar(c);
ffffffffc0204300:	df1fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc0204304:	0000d517          	auipc	a0,0xd
ffffffffc0204308:	df450513          	addi	a0,a0,-524 # ffffffffc02110f8 <buf>
ffffffffc020430c:	94aa                	add	s1,s1,a0
ffffffffc020430e:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc0204312:	60a6                	ld	ra,72(sp)
ffffffffc0204314:	6486                	ld	s1,64(sp)
ffffffffc0204316:	7962                	ld	s2,56(sp)
ffffffffc0204318:	79c2                	ld	s3,48(sp)
ffffffffc020431a:	7a22                	ld	s4,40(sp)
ffffffffc020431c:	7a82                	ld	s5,32(sp)
ffffffffc020431e:	6b62                	ld	s6,24(sp)
ffffffffc0204320:	6bc2                	ld	s7,16(sp)
...
ffffffffc020432e:	b759                	j	ffffffffc02042b4 <readline+0x38>
...
strlen(const char *s) {
ffffffffc0204334:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204336:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204338:	cb81                	beqz	a5,ffffffffc0204348 <strlen+0x18>
        cnt ++;
ffffffffc020433a:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc020433c:	00a707b3          	add	a5,a4,a0
ffffffffc0204340:	0007c783          	lbu	a5,0(a5)
ffffffffc0204344:	fbfd                	bnez	a5,ffffffffc020433a <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc020434a:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc020434c:	e589                	bnez	a1,ffffffffc0204356 <strnlen+0xc>
ffffffffc020434e:	a811                	j	ffffffffc0204362 <strnlen+0x18>
        cnt ++;
ffffffffc0204350:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204352:	00f58863          	beq	a1,a5,ffffffffc0204362 <strnlen+0x18>
ffffffffc0204356:	00f50733          	add	a4,a0,a5
ffffffffc020435a:	00074703          	lbu	a4,0(a4)
ffffffffc020435e:	fb6d                	bnez	a4,ffffffffc0204350 <strnlen+0x6>
ffffffffc0204360:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204362:	852e                	mv	a0,a1
ffffffffc0204364:	8082                	ret

ffffffffc0204366 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0204366:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204368:	0005c703          	lbu	a4,0(a1)
ffffffffc020436c:	0785                	addi	a5,a5,1
ffffffffc020436e:	0585                	addi	a1,a1,1
ffffffffc0204370:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204374:	fb75                	bnez	a4,ffffffffc0204368 <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204378:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc020437c:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204380:	cb89                	beqz	a5,ffffffffc0204392 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204382:	0505                	addi	a0,a0,1
ffffffffc0204384:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204386:	fee789e3          	beq	a5,a4,ffffffffc0204378 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc020438a:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc020438e:	9d19                	subw	a0,a0,a4
ffffffffc0204390:	8082                	ret
ffffffffc0204392:	4501                	li	a0,0
ffffffffc0204394:	bfed                	j	ffffffffc020438e <strcmp+0x16>

ffffffffc0204396 <strchr>:
...
ffffffffc020439a:	c799                	beqz	a5,ffffffffc02043a8 <strchr+0x12>
        if (*s == c) {
ffffffffc020439c:	00f58763          	beq	a1,a5,ffffffffc02043aa <strchr+0x14>
    while (*s != '\0') {
ffffffffc02043a0:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc02043a4:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc02043a6:	fbfd                	bnez	a5,ffffffffc020439c <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc02043ac:	ca01                	beqz	a2,ffffffffc02043bc <memset+0x10>
ffffffffc02043ae:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc02043b0:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc02043b2:	0785                	addi	a5,a5,1
ffffffffc02043b4:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02043b8:	fec79de3          	bne	a5,a2,ffffffffc02043b2 <memset+0x6>
    }
    return s;
...
ffffffffc02043be <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02043be:	ca19                	beqz	a2,ffffffffc02043d4 <memcpy+0x16>
ffffffffc02043c0:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02043c2:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02043c4:	0005c703          	lbu	a4,0(a1)
ffffffffc02043c8:	0585                	addi	a1,a1,1
ffffffffc02043ca:	0785                	addi	a5,a5,1
ffffffffc02043cc:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02043d0:	fec59ae3          	bne	a1,a2,ffffffffc02043c4 <memcpy+0x6>
    }
    return dst;
